...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Mutasi | Mutasi Saldo</title>
...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--active" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-coins"></i><span class="kt-menu__link-text">Saldo</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="{{ route('mutasi_saldo') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Mutasi Saldo</span></a></li>
                            ...
                            <div class="col-xl-12 col-lg-12 col-sm-12 order-lg-2 order-xl-1">
                                <div class="important_radius kt-portlet kt-portlet--height-fluid animate">
                                    <div class="kt-widget14">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="success_box">
                                                    <h4 class="kt-widget14__title" style="padding-left: 40px;"><br />
                                                        Transaksi Berhasil <i class="flaticon2-check-mark"></i>
                                                    </h4><br />
                                                    <ul class="ul_pesan">
                                                        ...
                                                        <li style="margin-left: 10px;">Transaksi</li>
                                                    </ul>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="warning_box">
                                                    <h4 class="kt-widget14__title" style="padding-left: 40px;"><br />
                                                        Transaksi Berjalan <i class="flaticon2-refresh-arrow"></i>
                                                    </h4><br />
                                                    <ul class="ul_pesan">
                                                        <li style="color:black;">
                                                            <h2>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="failed_box">
                                                    <h4 class="kt-widget14__title" style="padding-left: 40px;"><br />
                                                        Transaksi Gagal <i class="flaticon2-delete"></i>
                                                    </h4><br />
                                                    <ul class="ul_pesan">
                                                        <li style="color:black;">
                                                            <h2>
                                        ...
                                        <table class="table table-bordered table-striped " id="saldo_datatables">
                                            <thead>
                                                <tr class="tb_cen">
                                                    <th>No</th>
                                                    <th>Tanggal</th>
    ...
    <!-- end:: Page -->
    <script>
        var success = "{{$output[3]}}";
        var process = "{{$output[4]}}";
        var failed = "{{$output[5]}}";
        ...
        $("#box_percent_warning").append(
            '<div class="box_percent" style="background: linear-gradient(to right, rgb(245, 165, 16) 0%, rgb(245, 165, 16) ' + process + '%, rgb(255, 195, 85) ' + process + '%, rgb(255, 195, 85) 100%);"></div>'
        );
