...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Mutasi | Tambah Masa Aktif</title>
    ...
    <script src="js/perpanjang_paket.js" type="text/javascript"></script>
</head>
                                            ...
                                            <form method="post" action="javascript:void(0);" class="form-horizontal" enctype="multipart/form-data">
                                                <div class="form-group">
                                                        ...
                                                        <div class="col-lg-12 col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="number" value="{{$bank->no_rekening}}" class="form-control" placeholder="Nomor Rekening" disabled>
                                                                </div>
                                                            </div><br>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" value="{{$company_id}}" class="form-control" placeholder="Company ID" name="add_company" id="add_company" required>
                                                                </div>
                                                            </div><br>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-6 col-sm-6 ">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" value="{{$bank->username_ibank}}" class="form-control" placeholder="Username Ibank" name="add_username" minlength="6" id="add_username" required>
                                                                </div>
                                                            </div><br>
                                                        </div>
                                                        <div class="col-lg-6 col-sm-6 ">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" value="{{$bank->password_ibank}}" placeholder="Password Ibank" class="form-control" name="add_password" minlength="6" id="add_password" required>
                                                                </div>
                                                            </div><br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <center>
                                                            <br>
                                                            <input id="bank_id" type="hidden" value="{{$bank->id}}">
