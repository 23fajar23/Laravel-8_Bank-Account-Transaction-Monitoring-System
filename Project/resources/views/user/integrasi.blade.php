...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Mutasi | API Request</title>
...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu  kt-menu__item--active" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon2-group"></i><span class="kt-menu__link-text">Integrasi</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{ route('integrasi') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">API Request</span></a></li>
                                    ...
                                    <div class="kt-widget14">
                                        <div class="kt-widget14__header kt-margin-b -30">
                                            ...
                                            <span class="kt-widget14__desc">
                                                Gunakan menu ini untuk mendapatkan info kredensial API dan membatasi url / IP penerima API.
                                            </span>

                                        </div>
                                        <div class="notice_key">
                                            <h5> <span class="kt-menu__link-icon flaticon2-warning"></span>
                                                Jagalah Kerahasiaan API KEY Anda</h5>
                                        </div>
                                        <div class="kt-widget14__chart" style="min-height:120px;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="api_key" id="api_key" placeholder="API Key" value="{{Auth::user()->api_key}}" disabled>
                                                        ...
                                                        <div class="col-lg-6 form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="api_signature" id="api_signature" placeholder="API Signature" value="{{Auth::user()->api_signature}}" disabled>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="password_akun" id="password_akun" placeholder="Kata Sandi Akun" value="" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 form-group"></div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <center>
                                                            <div class="flex-equal text-end ms-1">
                                                                <button type="submit" onclick={change_api()} class="btn btn-label btn-label-brand">Simpan</button>
                                                            </div>
                                                        </center>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content paper">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div id="event_deskripsi" class="font_pengumuman desc_modal_user">
                                deskripsi
                            </div>
                        </div>
    ...
    <script src="js/integrasi.js" type="text/javascript"></script>
</body>
