...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Mutasi | Riwayat Deposit User</title>
...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
                            ...
                            <li class="kt-menu__item kt-menu__item--submenu kt-menu__item--active" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon fas fa-wallet"></i><span class="kt-menu__link-text ">Top up Saldo</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="{{ route('data_deposit') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Riwayat Deposit User</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1">
                                ...
                                <div class="important_radius kt-portlet kt-portlet--height-fluid animate">
                                    <div class="kt-widget14">
                                        <table class="table table-bordered table-striped " id="riwayat_deposit_datatables">
                                            <thead>
                                                <tr class="tb_cen">
                                                    <th>No</th>
                                                    <th>Pemilik</th>
    ...
    <script type="text/javascript">
        $('#riwayat_deposit_datatables').DataTable({
            language: {
                'paginate': {
            ...
            scrollX: true,
            serverSide: true,
            ajax: "{{ url('ajax_riwayat_deposit_datatables') }}",
            columns: [{
                    data: 'no',
                    name: 'no',
                    className: 'no_size',
