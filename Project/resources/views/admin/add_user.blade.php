...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
                                                ...
                                                <form method="post" action="javascript:void();">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="name" id="name" placeholder="Nama Pengguna" value="" minlength="5" maxlength="11" required>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-sm-6 form-group">
                                                            ...
                                                            <span class="form-text text-muted" id="alert_add_jenis_kelamin"></span>
                                                        </div>
                                                        <div class="col-lg-6 col-sm-6 form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 form-group">
                                                            ...
                                                            <span class="form-text text-muted" id="alert_add_alamat"></span>
                                                        </div>
                                                        <div class="col-lg-6 form-group">
                                                            <label><b>No HP : </b></label>
                                                            <div class="input-group">
                                                                <div class="input-group-prepend"><span class="input-group-text"><i class="flaticon2-phone"></i></span></div>
                                                                <input type="number" class="form-control" name="no_hp" id="no_hp" placeholder="Nomor HP" value="" required>
                                                            </div>
                                                            <span class="form-text text-muted" id="alert_add_no_hp"></span>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-6 form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <div class="input-group-prepend"><span class="input-group-text"><i class="flaticon2-mail"></i></span></div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" minlength="8" name="password" id="password" placeholder="Password" value="" required>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <center>
                                                            <div class="flex-equal text-end ms-1" id="btn_send">
                                                                <button type="submit" onclick={kirim()} class="btn btn-primary">Simpan</button>
                                                            </div>
                                                        </center>
                                                    </div>
                                                </form>
    ...
    <script>
        function clear() {
            $("#alert_add_name").html("");
            $("#alert_add_fullname").html("");
            $("#alert_add_jenis_kelamin").html("");
            $("#alert_add_kota").html("");
            $("#alert_add_alamat").html("");
            $("#alert_add_no_hp").html("");
            $("#alert_add_password").html("");
            $("#alert_add_email").html("");
        }
        ...
        function kirim() {
            ...
            if (name.length < 5) {
                $("#alert_add_name").html("Minimal 5 Karakter");
            } else {
                $("#alert_add_name").html("");
            }

            if (fullname.length < 8) {
                $("#alert_add_fullname").html("Minimal 8 Karakter");
            } else {
                $("#alert_add_fullname").html("");
            }
        ...
        function output_alert($value) {
            if ($value == "berhasil") {
                fast_notif("Data Berhasil Disimpan");
                clear();
            } else if ($value == "null_name") {
                $('#alert_add_name').html('Nama tidak boleh kosong');
            } else if ($value == "null_fullname") {
                $('#alert_add_fullname').html('Nama Lengkap tidak boleh kosong');
            } else if ($value == "null_jk") {
                $('#alert_add_jenis_kelamin').html('Jenis kelamin tidak boleh kosong');
            } else if ($value == "null_kota") {
                $('#alert_add_kota').html('Kota tidak boleh kosong');
            } else if ($value == "null_alamat") {
                $('#alert_add_alamat').html('Alamat tidak boleh kosong');
            } else if ($value == "null_no_hp") {
                $('#alert_add_no_hp').html('Nomor telepon tidak boleh kosong');
            } else if ($value == "numeric_no_hp") {
                $('#alert_add_no_hp').html('Nomor telepon tidak boleh selain angka');
            } else if ($value == "null_password") {
                $('#alert_add_password').html('Kata sandi tidak boleh kosong');
            } else if ($value == "null_email") {
                $('#alert_add_email').html('Email telah digunakan');
            }
        }
    </script>
