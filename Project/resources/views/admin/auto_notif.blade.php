...
<head>
    ...
    <script src="js/admin/data_autonotif.js" type="text/javascript"></script>
</head>
...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
                ...
                <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item kt-menu__item--submenu kt-menu__item--active" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-layer"></i><span class="kt-menu__link-text ">Data User</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="{{ route('autonotif') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Autonotif</span></a></li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1">
                                ...
                                <div class="important_radius kt-portlet kt-portlet--height-fluid animate">
                                    <div class="kt-widget14">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="success_box">
                                                    <h4 class="kt-widget14__title" style="padding-left: 40px;"><br />
                                                        Autonotif Aktif <i class="flaticon2-check-mark"></i>
                                                    </h4><br />
                                                    <ul class="ul_pesan">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="failed_box">
                                                    <h4 class="kt-widget14__title" style="padding-left: 40px;"><br />
                                                        Autonotif Tidak Aktif <i class="flaticon2-delete"></i>
                                                    </h4><br />
                                                    <ul class="ul_pesan">
                                                        <li style="color:black;">
                                                            <h2>
                                        ...
                                        <table class="table table-bordered table-striped " id="autonotif_datatables">
                                            <thead>
                                                <tr class="tb_cen">
                                                    <th>No</th>
                                                    <th>Email</th>
    ...
    <script type="text/javascript">
        ...
        $('#autonotif_datatables').DataTable({
            language: {
                'paginate': {
            ...
            scrollX: true,
            serverSide: true,
            ajax: "{{ url('ajax_autonotif_datatables') }}",
            columns: [{
                    data: 'no',
                    name: 'no',
                    className: 'no_size2',
