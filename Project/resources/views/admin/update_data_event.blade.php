...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Mutasi | Update Event & Pengumuman</title>
...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
                                            ...
                                            <div class="form-group" style="width: 100%;">
                                                <form method="post" action="javascript:void();">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" style="min-height: 150px;" name="deskripsi" id="deskripsi" placeholder="Isi Pengumuman" required></textarea>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <center>
                                                            <div class="flex-equal text-end ms-1" id="btn_send">
                                                                ...
                                                                <button type="submit" onclick={save_pengumuman()} class="btn btn-primary">Simpan</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            document.getElementById("status").value = "{{$pengumuman->status}}";
            document.getElementById("notif_user").value = "{{$event->status}}";
            document.getElementById("deskripsi").value = `{{$pengumuman->deskripsi}}`.substring(1);
