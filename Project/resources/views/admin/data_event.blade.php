...
<head>
    <base href="">
    <meta charset="utf-8" />
    <title>Mutasi | Event & Pengumuman</title>
    ...
    <script src="js/admin/data_event.js" type="text/javascript"></script>
</head>
...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
                            ...
                            <li class="kt-menu__item kt-menu__item--submenu kt-menu__item--active" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-layer"></i><span class="kt-menu__link-text ">Data User</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                    <ul class="kt-menu__subnav">
                                        ...
                                        <li class="kt-menu__item kt-menu__item--active" aria-haspopup="true"><a href="{{ route('data_event') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Event & Pengumuman</span></a></li>
                            ...
                            <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1">
                                ...
                                <div class="important_radius kt-portlet kt-portlet--height-fluid animate">
                                    <div class="kt-widget14">
                                        ...
                                        <table class="table table-bordered table-striped " id="event_datatables">
                                            <thead>
                                                <tr class="tb_cen">
                                                    <th>No</th>
                                                    <th>Judul</th>
    ...
    <script type="text/javascript">
        $('#event_datatables').DataTable({
            ...
            scrollX: true,
            serverSide: true,
            ajax: "{{ url('ajax_event_datatables') }}",
            columns: [{
                    data: 'no',
                    name: 'no',
                    className: 'no_size2',
