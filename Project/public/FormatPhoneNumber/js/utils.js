        ...
        va = {
            ...
            GF: [
                ...
                [
                    ,
                    ,
                    "594(?:[023]\\d|1[0-2]|4[03-9]|5[6-9]|6[0-3]|80|9[0-8])\\d{4}",
                    ,
                    ,
                    ,
                    "594101234",
    ...
    function Pa(a, b, c, d, e, g) {
        ...
        if (
            ...
            0 == l.lastIndexOf(h, 0) &&
                ...
                Qa(h, c, null),
                (h = h.toString()),
                (!O(l, b.toString()) && O(l, h)) ||
                    3 == Y(a, b.toString(), c, -1)))
        )
    ...
    function Ra(a, b, c, d) {
        ...
        try {
            ...
            if ("Invalid country calling code" == M.message && L.test(l)) {
                if (
                    ((l = l.replace(L, "")), (h = Pa(a, l, f, b, d, g)), 0 == h)
                )
                    throw M;
            } else throw M;
        }
        ...
        null != f &&
            ...
            2 != a &&
                ...
                5 != a &&
                ((b = e),
                d && 0 < c.toString().length && q(g, 7, c.toString())));
        d = b.toString();
        a = d.length;
        if (2 > a)
            throw Error(
