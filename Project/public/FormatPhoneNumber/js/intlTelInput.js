                ...
                _createClass(Iti, [
                    ...
                    },
                    {
                        ...
                        value: function _addCountryCode(
                            ...
                            if (
                                !this.countryCodes.hasOwnProperty(countryCode)
                            ) {
                    ...
                    },
                    {
                        ...
                        value: function _isRegionlessNanp(number) {
                            ...
                            if (numeric.charAt(0) === "1") {
                                ...
                                return (
                                    regionlessNanpNumbers.indexOf(areaCode) !==
                                    -1
                                );
                            }
                            return false;
                        ...
                        value: function _updatePlaceholder() {
                            ...
                            if (
                                ...
                                var placeholder = this.selectedCountryData.iso2
                                    ...
                                    : "";
                                placeholder =
                                    this._beforeSetNumber(placeholder);
                                if (
                            ...
                            if (number.charAt(0) === "+") {
                                ...
                                for (var i = 0; i < number.length; i++) {
                                    ...
                                    if (!isNaN(parseInt(c, 10))) {
                                        ...
                                        if (includeAreaCode) {
                                            if (
                                                this.countryCodes[numericChars]
                                            ) {
