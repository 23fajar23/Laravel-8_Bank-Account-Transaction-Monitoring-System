...
var KTChartsWidget1 = {
    init: function () {
        !(function () {
            ...
            if (e) {
                var t = e.hasAttribute("data-kt-negative-color")
                        ? e.getAttribute("data-kt-negative-color")
                        : KTUtil.getCssVariableValue("--bs-success"),
                    a = parseInt(KTUtil.css(e, "height")),
                    r = KTUtil.getCssVariableValue("--bs-gray-500"),
            ...
            if ("undefined" != typeof am5) {
                ...
                e &&
                    am5.ready(function () {
                        ...
                        var o = am5radar.AxisRendererCircular.new(t, {});
                        o.labels.template.setAll({ radius: 10 }),
                            o.grid.template.setAll({ forceHidden: !0 });
                        var i = a.xAxes.push(
                                am5xy.ValueAxis.new(t, {
                                    renderer: o,
                                    min: 0,
                        ...
                        s.labels.template.setAll({
                            ...
                            s.grid.template.setAll({ forceHidden: !0 });
                        var l = a.yAxes.push(
                            am5xy.CategoryAxis.new(t, {
                        ...
                        series: [
                            {
                                ...
                                data: [
                                    ...
                                    34.5, 34.5, 34.5, 34.5, 35, 35, 34.5, 35.5,
                                    35.5, 35.5, 35,
                                ],
                            },
                        ],
    ...
    var e = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")),
                ...
                i = new ApexCharts(t, o),
                s = !1,
                l = document.querySelector(tabSelector);
            !0 === initByDefault && (i.render(), (s = !0)),
                l.addEventListener("shown.bs.tab", function (e) {
                    0 == s && (i.render(), (s = !0));
                }),
                (i = new ApexCharts(t, o)).render();
        }
    };
    return {
        init: function () {
    ...
    var e = function (e, t, a, r) {
        ...
        if (o) {
            var i = parseInt(KTUtil.css(o, "height")),
                ...
                l = {
                    series: [
                        { name: "Social Campaigns", data: a[0] },
                        { name: "Email Newsletter", data: a[1] },
                        { name: "TV Campaign", data: a[2] },
                        { name: "Google Ads", data: a[3] },
                        { name: "Courses", data: a[4] },
                        { name: "Radio", data: a[5] },
                    ],
                    chart: {
                        fontFamily: "inherit",
                        ...
                        (() => {
                            ...
                            var t = Date.now(),
                                ...
                                i = {
                                    ...
                                    selectable: !1,
                                    margin: {
                                        item: { horizontal: 10, vertical: 35 },
                                    },
                                    showCurrentTime: !1,
                                    xss: {
                                        disabled: !1,
                                    ...
                                    template: function (e) {
                                        ...
                                        return (
                                            t.forEach((e) => {
                                                r += `<div class="symbol symbol-circle symbol-25px"><img src="${
                                                    a + e
                                                }" alt="" /></div>`;
                                            }),
    ...
    const r = () => {
                ...
                e.addEventListener("click", (r) => {
                    ...
                    if (i.classList.contains("isOpen")) {
                        for (
                            ...
                            i.nextSibling &&
                            "subtable_template" ===
                                i.nextSibling.getAttribute(
                                    "data-kt-table-widget-4"
                                );

                        )
                            i.nextSibling.parentNode.removeChild(i.nextSibling);
        ...
        s = (t, r) => {
            t.forEach((o, i) => {
                ...
                l.setAttribute("src", g + o.image + ".gif"),
                    (n.innerText = o.name),
                    (d.innerText = o.description),
                    (c.innerText = o.cost),
                    (u.innerText = o.qty),
                    (p.innerText = o.total),
                    o.stock > 10
                ...
                ((() => {
                    e.querySelectorAll("tbody tr").forEach((e) => {
                        ...
                        e.closest(
                            ...
                            (t[1].setAttribute("data-order", a),
                            (t[1].innerText = moment(a).fromNow()));
                    });
                    const r = document.querySelector(
                        '[data-kt-table-widget-4="subtable_template"]'
                    );
                    (a = r.cloneNode(!0)).classList.remove("d-none"),
