        ...
        !(function () {
            ...
            [].slice.call(t).map(function (e) {
                ...
                if (e) {
                    ...
                    new ApexCharts(e, {
                        series: [
                            { name: "Net Profit", data: [30, 45, 32, 70, 40] },
                        ],
                        chart: {
                            fontFamily: "inherit",
                            type: "area",
                        ...
                        series: [
                            {
                                name: "Inflation",
                                data: [
                                    1, 2.1, 1, 2.1, 4.1, 6.1, 4.1, 4.1, 2.1,
                                    4.1, 2.1, 3.1, 1, 1, 2.1,
                                ],
                            },
                        ],
            ...
            (function () {
                var e = document.getElementById(
                        "kt_charts_mixed_widget_16_chart"
                    ),
                    t = parseInt(KTUtil.css(e, "height"));
                if (e) {
                    var a = {
            ...
            (function () {
                var e = document.getElementById(
                        "kt_charts_mixed_widget_18_chart"
                    ),
                    t = parseInt(KTUtil.css(e, "height"));
                if (e) {
                    var a = KTUtil.getCssVariableValue("--bs-gray-800"),
            ...
            (function () {
                var e = document.getElementById(
                        "kt_charts_mixed_widget_19_chart"
                    ),
                    t = parseInt(KTUtil.css(e, "height"));
                if (e) {
                    var a = KTUtil.getCssVariableValue("--bs-gray-800"),
                    ...
                    new FullCalendar.Calendar(r, {
                        ...
                        events: [
                            ...
                            },
                            {
                                ...
                                start: t + "-14T13:30:00",
                                description:
                                    "Lorem ipsum dolor incid idunt ut labore",
                                end: t + "-14",
                            ...
                            },
                            {
                                ...
                                start: t + "-02",
                                description:
                                    "Lorem ipsum dolor sit tempor incid",
                                end: t + "-03",
                            ...
                            },
                            {
                                ...
                                start: t + "-03",
                                description:
                                    "Lorem ipsum dolor sit tempor inci",
                                end: t + "-05",
                                className:
