...
var KTCropperDemo = {
    init: function () {
        ...
        (e = document.getElementById("image")),
            (t = {
                crop: function (e) {
                    (document.getElementById("dataX").value = Math.round(
                        e.detail.x
                    )),
                        (document.getElementById("dataY").value = Math.round(
                            e.detail.y
                        )),
                    ...
                    (t.innerHTML = ""),
                        t.appendChild(
                            n.getCroppedCanvas({ width: 256, height: 160 })
                        );
                    var a = document.getElementById("cropper-preview-md");
                    (a.innerHTML = ""),
                        a.appendChild(
                            n.getCroppedCanvas({ width: 128, height: 80 })
                        );
                    var d = document.getElementById("cropper-preview-sm");
                    (d.innerHTML = ""),
                        d.appendChild(
                            n.getCroppedCanvas({ width: 64, height: 40 })
                        );
                    var o = document.getElementById("cropper-preview-xs");
                    (o.innerHTML = ""),
                        o.appendChild(
                            n.getCroppedCanvas({ width: 32, height: 20 })
                        );
                },
            }),
            (n = new Cropper(e, t)),
            ...
            document
                ...
                .forEach(function (e) {
                    e.addEventListener("click", function (e) {
                        n.setAspectRatio(e.target.value);
                    });
                }),
            document
            ...
            document
                ...
                .forEach(function (a) {
                    a.addEventListener("click", function (a) {
                        var d = {};
                        (d[a.target.getAttribute("name")] = a.target.checked),
                            (t = Object.assign({}, t, d)),
                            n.destroy(),
                            (n = new Cropper(e, t));
                    });
