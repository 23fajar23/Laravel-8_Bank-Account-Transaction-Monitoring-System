"use strict";
var KTGeneralFullCalendarSelectDemos = {
    init: function () {
        var t, e;
        (t = document.getElementById("kt_docs_fullcalendar_selectable")),
                    ...
                    Swal.fire({
                        ...
                        if (n.value) {
                            ...
                            a &&
                                ...
                                e.unselect();
                        } else "cancel" === n.dismiss && Swal.fire({ text: "Event creation was declined!.", icon: "error", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } });
                    });
                },
