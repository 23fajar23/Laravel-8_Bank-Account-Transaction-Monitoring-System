"use strict";
var KTGeneralFullCalendarLocalesDemos = {
    init: function () {
        var e, t, n;
        (e = document.getElementById("kt_docs_fullcalendar_locale_selector")),
            (t = document.getElementById("kt_docs_fullcalendar_locales")),
            (n = new FullCalendar.Calendar(t, {
                headerToolbar: {
            ...
            n.getAvailableLocaleCodes().forEach(function (t) {
            ...
            $(e).on("change", function () {
                this.value && n.setOption("locale", this.value);
            }),
            n.render();
    },
};
