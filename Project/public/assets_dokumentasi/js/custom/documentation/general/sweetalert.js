...
var KTGeneralSweetAlertDemos = {
    init: function () {
        document
            .getElementById("kt_docs_sweetalert_basic")
            ...
            document
                .getElementById("kt_docs_sweetalert_html")
                .addEventListener("click", (t) => {
                    t.preventDefault(),
                        Swal.fire({
            ...
            (() => {
                const t = document.getElementById(
                        "kt_docs_sweetalert_state_info"
                    ),
                    e = document.getElementById(
                        "kt_docs_sweetalert_state_warning"
                    ),
                    n = document.getElementById(
                        "kt_docs_sweetalert_state_error"
                    ),
                    o = document.getElementById(
                        "kt_docs_sweetalert_state_success"
                    ),
                    s = document.getElementById(
                        "kt_docs_sweetalert_state_question"
                    );
