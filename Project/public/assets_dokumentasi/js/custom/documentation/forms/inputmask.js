...
var KTFormsInputmaskDemos = {
    init: function (a) {
        Inputmask({ mask: "99/99/9999" }).mask("#kt_inputmask_1"),
            ...
            Inputmask({ mask: "9", repeat: 10, greedy: !1 }).mask(
                "#kt_inputmask_4"
            ),
            Inputmask("decimal", { rightAlignNumerics: !1 }).mask(
                "#kt_inputmask_5"
            ),
            Inputmask("€ 999.999.999,99", { numericInput: !0 }).mask(
                "#kt_inputmask_6"
            ),
            Inputmask({ mask: "999.999.999.999" }).mask("#kt_inputmask_7"),
            Inputmask({
