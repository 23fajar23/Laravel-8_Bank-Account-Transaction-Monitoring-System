    ...
    init: function () {
        $("#kt_multiselectsplitter_example_1").multiselectsplitter(),
            ...
            $("#kt_multiselectsplitter_example_5").multiselectsplitter({
                ...
                groupCounter: !0,
                maximumSelected: 2,
                maximumAlert: function (t) {
                    alert(
                        "You choose " + (t + 1) + " options. Are you crazy ?"
                    );
                },
                createFirstSelect: function (t, e) {
                    return (
                        '<option class="text-success">prefix - ' +
                        t +
                        "</option>"
                    );
                },
                createSecondSelect: function (t, e) {
