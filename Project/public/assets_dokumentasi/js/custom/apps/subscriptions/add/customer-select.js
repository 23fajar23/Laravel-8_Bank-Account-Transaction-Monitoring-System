...
var KTModalCustomerSelect = (function () {
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_modal_customer_search_handler")),
                (a = new bootstrap.Modal(
                    document.querySelector("#kt_modal_customer_search")
                )),
                e &&
                    ...
                    (o = e.querySelector('[data-kt-search-element="empty"]')),
                    (s = new KTSearch(e)).on("kt.search.process", c),
                    s.on("kt.search.clear", r),
                    KTUtil.on(
                        e,
