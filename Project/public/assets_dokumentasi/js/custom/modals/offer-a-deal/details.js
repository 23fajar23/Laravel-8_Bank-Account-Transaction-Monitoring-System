    ...
    return {
        init: function () {
            (i = KTModalOfferADeal.getForm()),
                ...
                $(
                    i.querySelector('[name="details_activation_date"]')
                ).flatpickr({ enableTime: !0, dateFormat: "d, M Y, H:i" }),
                $(i.querySelector('[name="details_customer"]')).on(
                    "change",
                    function () {
...
"undefined" != typeof module &&
    ...
    (window.KTModalOfferADealDetails = module.exports =
        KTModalOfferADealDetails);
