...
var KTModalCreateApiKey = (function () {
    ...
    return {
        init: function () {
            (r = document.querySelector("#kt_modal_create_api_key")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_modal_create_api_key_form")),
                (t = document.getElementById("kt_modal_create_api_key_submit")),
                (e = document.getElementById("kt_modal_create_api_key_cancel")),
