        ...
        var i = {
            ...
            r = function () {
                (n.options = KTUtil.deepExtend({}, i, t)),
                    ...
                    d("decimals") &&
                        (n.options.decimals = parseInt(d("decimals"))),
...
var KTLayoutAside = {
    init: function () {
        document
            .querySelector("#kt_aside_categories_toggle")
            .addEventListener("click", function (e) {
                e.preventDefault(),
                    "More Categories" === this.innerHTML
...
var KTLayoutSidebar = {
    init: function () {
        var e;
        (e = document.querySelector("#kt_sidebar_search_form"))
            .querySelector(".form-control")
            .addEventListener("keyup", function (t) {
                "Enter" === t.code &&
                    (t.preventDefault(),
                    (window.location.href = e.getAttribute("action")));
            });
    },
};
KTUtil.onDOMContentLoaded(function () {
