!(function (a) {
    ...
    (String.format = function () {
        for (var a = arguments[0], b = 1; b < arguments.length; b++)
            a = a.replace(RegExp("\\{" + (b - 1) + "\\}", "gm"), arguments[b]);
        return a;
    }),
        a.extend(b.prototype, {
                    ...
                    (this.notify = {
                        ...
                        update: function (b, c) {
                            ...
                            for (var b in d)
                                switch (b) {
                                    ...
                                    case "icon":
                                        ...
                                        "class" ==
                                        a.settings.icon_type.toLowerCase()
                                            ? e
                                                  .removeClass(
                                                      a.settings.content.icon
                                                  )
                                                  .addClass(d[b])
                                            : (e.is("img") || e.find("img"),
                                              e.attr("src", d[b]));
                            ...
                            var g =
                                ...
                                parseInt(a.settings.spacing) +
                                parseInt(a.settings.offset.y);
                            a.reposition(g);
                        },
                        close: function () {
                            a.close();
            ...
            placement: function () {
                ...
                switch (
                    (a(
                        ...
                        return (c = Math.max(
                            c,
                            parseInt(a(this).css(f.placement.from)) +
                                parseInt(a(this).outerHeight()) +
                                parseInt(f.spacing)
                        ));
                    }),
                    1 == this.settings.newest_on_top &&
                        (c = this.settings.offset.y),
                    (d[this.settings.placement.from] = c + "px"),
                    this.settings.placement.align)
                ) {
                    case "left":
                    case "right":
                        d[this.settings.placement.align] =
                ...
                this.$ele.css(d).addClass(this.settings.animate.enter),
                    ...
                    1 == this.settings.newest_on_top &&
                        ((c =
                            ...
                            this.$ele.outerHeight()),
                        this.reposition(c)),
                    a.isFunction(b.settings.onShow) &&
                        b.settings.onShow.call(this.$ele),
                    this.$ele
                        .one(this.animations.start, function (a) {
                            e = !0;
                        })
                        .one(this.animations.end, function (c) {
                            a.isFunction(b.settings.onShown) &&
                                b.settings.onShown.call(this);
                        }),
                    setTimeout(function () {
                        e ||
                            (a.isFunction(b.settings.onShown) &&
            ...
            bind: function () {
                ...
                if (
                    ...
                    var c = setInterval(function () {
                        var a =
                            parseInt(b.$ele.data("notify-delay")) -
                            b.settings.timer;
                        if (
                            ("false" === b.$ele.data("data-hover") &&
                                "pause" == b.settings.mouse_over) ||
                            "pause" != b.settings.mouse_over
                        ) {
                            var d =
                                ((b.settings.delay - a) / b.settings.delay) *
                                100;
                            b.$ele.data("notify-delay", a),
                                b.$ele
                                    .find('[data-notify="progressbar"] > div')
                                    .attr("aria-valuenow", d)
                                    .css("width", d + "%");
                        }
            ...
            close: function () {
                ...
                this.$ele
                    ...
                    b.reposition(c),
                    a.isFunction(b.settings.onClose) &&
                        b.settings.onClose.call(this.$ele),
                    this.$ele
                        .one(this.animations.start, function (a) {
                            d = !0;
                        })
                        .one(this.animations.end, function (c) {
                            a(this).remove(),
                                a.isFunction(b.settings.onClosed) &&
                                    b.settings.onClosed.call(this);
                        }),
                    setTimeout(function () {
                        d ||
                            (b.$ele.remove(),
            ...
            reposition: function (b) {
                ...
                1 == this.settings.newest_on_top && (e = this.$ele.prevAll(d)),
                    e.each(function () {
                        a(this).css(c.settings.placement.from, b),
                            (b =
                                parseInt(b) +
                                parseInt(c.settings.spacing) +
                                a(this).outerHeight());
                    });
            },
        }),
        ...
        (a.notifyClose = function (b) {
            "undefined" == typeof b || "all" == b
                ? a("[data-notify]")
                      .find('[data-notify="dismiss"]')
                      .trigger("click")
                : a('[data-notify-position="' + b + '"]')
                      .find('[data-notify="dismiss"]')
                      .trigger("click");
        });
});
