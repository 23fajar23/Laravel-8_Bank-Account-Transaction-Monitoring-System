  ...
  compute it */
    ...
    Color.prototype = {
        ...
        percentString: function () {
            return colorString.percentString(
                this.values.rgb,
                this.values.alpha
            );
        },
        ...
        descriptors: function (chart) {
            ...
            this._plugins
                ...
                .forEach(function (plugin) {
                    ...
                    if (opts === true) {
                        opts = helpers$1.clone(
                            core_defaults.global.plugins[id]
                        );
                    }
    ...
    var core_scale = core_element.extend({
        ...
        beforeCalculateTickRotation: function () {
            helpers$1.callback(this.options.beforeCalculateTickRotation, [
                this,
            ]);
        },
        ...
        draw: function (chartArea) {
            ...
            helpers$1.each(ticks, function (tick, index) {
                ...
                if (
                    ...
                    borderDashOffset =
                        gridLines.zeroLineBorderDashOffset || 0.0;
                } else {
    ...
    var scale_time = core_scale.extend({
        ...
        determineDataLimits: function () {
            ...
            min =
                min === MAX_INTEGER ? +adapter.startOf(Date.now(), unit) : min;
            max =
                max === MIN_INTEGER
