        ...
        (function (factory) {
            ...
            Inputmask.prototype = {
                ...
                defaults: {
                    ...
                    ignorables: [
                        8, 9, 13, 19, 27, 33, 34, 35, 36, 37, 38, 39, 40, 45,
                        46, 93, 112, 113, 114, 115, 116, 117, 118, 119, 120,
                        121, 122, 123, 0, 229,
                    ],
                    isComplete: null,
                    preValidation: null,
                    ...
                    function importAttributeOptions(
                        ...
                        if (opts.importDataAttributes === true) {
                            var attrOptions = npt.getAttribute(dataAttribute),
                                ...
                                optionData,
                                p;
                            var importOption = function importOption(
                                option,
                                optionData
                            ) {
                                optionData =
                        ...
                        if (openenings.length > 0) {
                            ...
                            if (currentOpeningToken.isAlternator) {
                                ...
                                if (openenings.length > 0) {
                                    currentOpeningToken =
                                        openenings[openenings.length - 1];
                                    currentOpeningToken.matches.push(
                                        alternator
                                    );
                                } else {
                    ...
                    function reverseTokens(maskToken) {
                        ...
                        for (var match in maskToken.matches) {
                            if (maskToken.matches.hasOwnProperty(match)) {
                                ...
                                if (
                                    maskToken.matches[match].matches !==
                                    undefined
                                ) {
                    ...
                    while (
                        ...
                        switch (m.charAt(0)) {
                            ...
                            case opts.alternatormarker:
                                var groupQuantifier = function groupQuantifier(
                                    matches
                                ) {
                                ...
                                if (openenings.length > 0) {
                                    ...
                                    var subToken =
                                        currentOpeningToken.matches[
                                            currentOpeningToken.matches.length -
                                                1
                                        ];
                                    if (
                                        currentOpeningToken.openGroup &&
                                        (subToken.matches === undefined ||
                                            (subToken.isGroup === false &&
                                                subToken.isAlternator ===
                                                    false))
                                    ) {
                                        lastMatch = openenings.pop();
                                    } else {
                                        lastMatch = groupQuantifier(
                                            currentOpeningToken.matches
                                        );
                                    }
                                } else {
                                ...
                                if (lastMatch.isAlternator) {
                                    ...
                                    if (lastMatch.openGroup) {
                                        ...
                                        var alternatorGroup = new MaskToken(
                                            true
                                        );
                    ...
                    if (opts.mask.length > 1) {
                        if (opts.keepStatic === null) {
                            ...
                            for (var i = 0; i < opts.mask.length; i++) {
                                if (
                                    opts.mask[i].charAt(0) !==
                                    opts.mask[0].charAt(0)
                                ) {
            ...
            function maskScope(actionObj, maskset, opts) {
                ...
                var inputmask = this,
                    ...
                    colorMask,
                    originalPlaceholder;
                var getMaskTemplate = function getMaskTemplate(
                    baseOnInput,
                    minimalPos,
                    includeMode,
                    noJit,
                ...
                function getDecisionTaker(tst) {
                    ...
                    if (
                        typeof decisionTaker == "string" &&
                        decisionTaker.length > 0
                    ) {
                        decisionTaker = decisionTaker.split(",")[0];
                    }
                    return decisionTaker !== undefined
                        ? decisionTaker.toString()
                        : "";
                }
                    ...
                    function resolveTestFromToken(
                        ...
                        function handleMatch(
                            ...
                            function isSubsetOf(source, target) {
                                ...
                                if (
                                    opts.regex &&
                                    source.match.fn !== null &&
                                    target.match.fn !== null
                                ) {
                                    return (
                                        expand(
                                            target.match.def.replace(
                                                /[\[\]]/g,
                                                ""
                                            )
                                        ).indexOf(
                                            expand(
                                                source.match.def.replace(
                                                    /[\[\]]/g,
                                                    ""
                                                )
                                            )
                            ...
                            function staticCanMatchDefinition(source, target) {
                                var sloc = source.locator
                                        .slice(source.alternation)
                                        .join(""),
                                    tloc = target.locator
                                        .slice(target.alternation)
                                        .join(""),
                                    canMatch = sloc == tloc;
                                canMatch =
                                    canMatch &&
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        if (
                                            opts.keepStatic === true ||
                                            (isFinite(
                                                parseInt(opts.keepStatic)
                                            ) &&
                                                currentPos >= opts.keepStatic)
                                        )
                                            altIndexArr = altIndexArr.slice(
                                                0,
                                                1
                                            );
                                        ...
                                        for (
                                            ...
                                            for (
                                                ...
                                                for (
                                                    var ndx2 = 0;
                                                    ndx2 <
                                                    malternateMatches.length;
                                                    ndx2++
                                                ) {
                                                    var altMatch2 =
                                                        malternateMatches[ndx2];
                                                    if (
                                                        typeof altIndex !==
                                                            "string" ||
                                                        (altMatch.alternation !==
                ...
                function alternate(pos, c, strict, fromSetValid, rAltPos) {
                    ...
                    if (lAltPos === -1 && rAltPos === undefined) {
                        ...
                        for (; lAltPos >= 0; lAltPos--) {
                            ...
                            if (altPos && altPos.alternation !== undefined) {
                                ...
                                lastAlt = lAltPos;
                                alternation =
                                    getMaskSet().validPositions[lastAlt]
                                        .alternation;
                                prevAltPos = altPos;
                            }
                        }
                    ...
                    if (alternation !== undefined) {
                        ...
                        for (
                            i = decisionPos;
                            i < getLastValidPosition(undefined, true) + 1;
                            i++
                        ) {
                        ...
                        while (
                            ...
                            while (validInputs.length > 0) {
                                ...
                                if (
                                    !(isValidRslt = isValid(
                                        getLastValidPosition(undefined, true) +
                                            1,
                                        input,
                                        false,
                                        fromSetValid,
                            ...
                            if (!isValidRslt) {
                                ...
                                if (getMaskSet().excludes[decisionPos]) {
                                    ...
                                    if (
                                        getMaskSet().excludes[
                                            decisionPos
                                        ].indexOf(decisionTaker) !== -1
                                    ) {
                                        isValidRslt = alternate(
                                            pos,
                                            c,
                                            strict,
                                            fromSetValid,
                    ...
                    if (result === true) {
                        ...
                        if (maxLength === undefined || maskPos < maxLength) {
                            ...
                            if (
                                ...
                                var currentPosValid =
                                    getMaskSet().validPositions[maskPos];
                                if (
                                    currentPosValid &&
                                    currentPosValid.match.fn === null &&
                        ...
                        if (
                            ...
                            (opts.regex == null || isComplete(getBuffer())) &&
                            !strict &&
                            fromAlternate !== true
                        ) {
                            result = alternate(
                        ...
                        if (
                            ...
                            if (vp) {
                                ...
                                if (tests[tests.length - 1].match.def === "")
                                    tests.pop();
                                var bestMatch = determineTestTemplate(
                                    ps,
                                    tests
                                );
                ...
                function revalidateMask(
                    ...
                    validatedPos =
                        validatedPos !== undefined ? validatedPos : begin;
                    if (
                        begin !== end ||
                        (opts.insertMode &&
                            getMaskSet().validPositions[validatedPos] !==
                                undefined &&
                            fromSetValid === undefined)
                    ) {
                        var positionsClone = $.extend(
                                true,
                                {},
                                getMaskSet().validPositions
                            ),
                        ...
                        for (i = lvp; i >= begin; i--) {
                            if (
                                ...
                                getMaskSet().validPositions[i].match
                                    .nativeDef === "+"
                            ) {
                            ...
                            if (
                                ...
                                while (getTest(posMatch).match.def !== "") {
                                    if (
                                        ...
                                        positionsClone[posMatch].match
                                            .nativeDef === t.match.nativeDef
                                    ) {
                        ...
                        getMaskSet().validPositions[validatedPos] = $.extend(
                            true,
                            {},
                            validTest
                        );
                            ...
                            if (
                                ...
                                for (var i = 0; i < tests.length; i++) {
                                    if (
                                        ...
                                        tests[i].match.optionalQuantifier !==
                                            true &&
                    ...
                    on: function on(input, eventName, eventHandler) {
                        var ev = function ev(e) {
                            ...
                            if (
                                ...
                                var returnVal = eventHandler.apply(
                                    that,
                                    arguments
                                );
                                if (returnVal === false) {
                ...
                var EventHandlers = {
                    keydownEvent: function keydownEvent(e) {
                        ...
                        if (
                            ...
                            (iphone &&
                                k === Inputmask.keyCode.BACKSPACE_SAFARI) ||
                            (e.ctrlKey &&
                            ...
                            k === Inputmask.keyCode.INSERT &&
                            !(e.shiftKey || e.ctrlKey)
                        ) {
                            opts.insertMode = !opts.insertMode;
                            input.setAttribute("im-insert", opts.insertMode);
                        } else if (
                            opts.tabThrough === true &&
                            k === Inputmask.keyCode.TAB
                        ) {
                            if (e.shiftKey === true) {
                    ...
                    pasteEvent: function pasteEvent(e) {
                        ...
                        var valueBeforeCaret = inputValue.substr(
                                0,
                                caretPos.begin
                            ),
                        ...
                        if (getBuffer().join("") !== inputValue) {
                            ...
                            if (getBuffer().join("") !== inputValue) {
                                var buffer = getBuffer().join(""),
                                    offset =
                                        !opts.numericInput &&
                                        inputValue.length > buffer.length
                                            ? -1
                                            : 0,
                                    frontPart = inputValue.substr(
                                        0,
                                        caretPos.begin
                                    ),
                                    backPart = inputValue.substr(
                                        caretPos.begin
                                    ),
                                ...
                                if (entries.length > 0) {
                                    ...
                                    EventHandlers.keydownEvent.call(
                                        input,
                                        keydown
                                    );
                                }
                    ...
                    cutEvent: function cutEvent(e) {
                        var input = this,
                            ...
                            ev = e.originalEvent || e;
                        var clipboardData =
                                window.clipboardData || ev.clipboardData,
                            clipData = isRTL
                ...
                function checkVal(
                    ...
                    if (!strict && opts.autoUnmask !== true) {
                        var staticInput = getBufferTemplate()
                            ...
                            matches = inputValue
                                ...
                                .match(
                                    new RegExp(
                                        "^" +
                                            Inputmask.escapeRegex(staticInput),
                                        "g"
                                    )
                                );
                        if (matches && matches.length > 0) {
                            inputValue.splice(
                                0,
                                matches.length * staticInput.length
                            );
                    ...
                    if (writeOut)
                        writeBuffer(
                            input,
                            getBuffer(),
                            result ? result.forwardPosition : undefined,
                            initiatingEvent || new $.Event("checkval"),
                            initiatingEvent && initiatingEvent.type === "input"
                        );
                }
                        ...
                        for (var i = 0; i <= aml; i++) {
                            ...
                            if (
                                (test.fn !== null &&
                                    getMaskSet().validPositions[i] ===
                                        undefined &&
                                    test.optionality !== true &&
                                    test.optionalQuantifier !== true) ||
                                (test.fn === null &&
                ...
                function handleRemove(input, k, pos, strict, fromIsValid) {
                    ...
                    if (
                        ...
                        if (
                            getMaskSet().validPositions[pos.begin] !==
                                undefined &&
                        ...
                        pos.end =
                            ...
                            getMaskSet().validPositions[pos.end].input !==
                                opts.radixPoint
                                ? pos.end + 1
                                : seekNext(pos.end) + 1;
                        if (
                    ...
                    if (lvp < pos.begin || pos.begin === -1) {
                        ...
                        if (fromIsValid !== true) {
                            while (
                                getMaskSet().p < lvp &&
                                getMaskSet().validPositions[getMaskSet().p] ===
                                    undefined
                            ) {
                                getMaskSet().p++;
                            }
                    ...
                    if (isSupported !== false) {
                        ...
                        if (isSupported === true) {
                            ...
                            EventRuler.on(
                                el,
                                "submit",
                                EventHandlers.submitEvent
                            );
                            EventRuler.on(
                                el,
                                "reset",
                                EventHandlers.resetEvent
                            );
                    ...
                    switch (actionObj.action) {
                        ...
                        case "remove":
                            if (el && el.inputmask) {
                                ...
                                if (el.inputmask.colorMask) {
                                    ...
                                    colorMask.parentNode.insertBefore(
                                        el,
                                        colorMask
                                    );
                        ...
                        case "getmetadata":
                            if ($.isArray(maskset.metadata)) {
                                var maskTarget = getMaskTemplate(
                                    true,
                                    0,
                                    false
                                ).join("");
        ...
        (function (factory) {
            ...
            var formatCode = {
                    ...
                    mm: [
                        ...
                        function () {
                            return pad(
                                Date.prototype.getMonth.call(this) + 1,
                                2
                            );
                        },
                    ],
            ...
            function isDateInRange(dateParts, opts) {
                ...
                if (opts.min) {
                    if (dateParts["rawyear"]) {
                        var rawYear = dateParts["rawyear"].replace(
                                /[^0-9]/g,
                                ""
                            ),
                ...
                if (
                    ...
                    result =
                        opts.max.date.getTime() >= dateParts.date.getTime();
                }
                return result;
            }
                ...
                function extendProperty(value) {
                    ...
                    if (correctedValue != value) {
                        var enteredPart = value.replace(/[^0-9]/g, ""),
                            min = (
                                (opts.min && opts.min[targetProp]) ||
                                value
                            ).toString(),
                            max = (
                                (opts.max && opts.max[targetProp]) ||
                                value
                            ).toString();
                        correctedValue =
                            enteredPart +
                            (enteredPart < min.slice(0, enteredPart.length)
                                ? min.slice(enteredPart.length)
                                : enteredPart > max.slice(0, enteredPart.length)
                                ? max.slice(enteredPart.length)
                                : correctedValue
                                      .toString()
            ...
            Inputmask.extendAliases({
                datetime: {
                    ...
                    postValidation: function postValidation(
                        ...
                        opts.min = analyseMask(
                            opts.min,
                            opts.inputFormat,
                            opts
                        );
                        opts.max = analyseMask(
                            opts.max,
                            opts.inputFormat,
                            opts
                        );
                    ...
                    onKeyDown: function onKeyDown(e, buffer, caretPos, opts) {
                        ...
                        if (
                            e.ctrlKey &&
                            e.keyCode === Inputmask.keyCode.RIGHT
                        ) {
                            var today = new Date(),
                                match,
                                date = "";
                            while (
                                (match = getTokenizer(opts).exec(
                                    opts.inputFormat
                                ))
                            ) {
                ...
                numeric: {
                    mask: function mask(opts) {
                        ...
                        if (opts.digits !== undefined) {
                            var radixDef = opts.decimalProtect
                                ? ":"
                                : opts.radixPoint;
                    ...
                    preValidation: function preValidation(
                        ...
                        if (c === "-" || c === opts.negationSymbol.front) {
                            ...
                            return {
                                caret: maskset.validPositions[pos]
                                    ? pos
                                    : undefined,
                                dopost: true,
                            };
                    ...
                    postValidation: function postValidation(
                        ...
                        if (
                            caretPos ===
                                maskedValue.length - opts.suffix.length - 1 &&
                        ...
                        if (processValue !== "") {
                            ...
                            if (
                                ...
                                processValue = Inputmask(
                                    buildPostMask(processValue, opts),
                                    {
                                        numericInput: true,
                                        jitMasking: true,
                                        definitions: {
                    ...
                    onBeforeWrite: function onBeforeWrite(
                        e,
                        buffer,
                        caretPos,
                        opts
                                ...
                                if (isValid === true) {
                                    if (
                                        ...
                                        maskset.validPositions[pos] !==
                                            undefined &&
                                        maskset.validPositions[pos].match
                                            .def === "~" &&
                                        !isSelection
                                    ) {
                                        var processValue =
                                        ...
                                        var pvRadixSplit = processValue.split(
                                            opts.radixPoint
                                        );
                                        if (pvRadixSplit.length > 1) {
                                            pvRadixSplit[1] =
                                                pvRadixSplit[1].replace(
                                                    /0/g,
                                                    opts.placeholder.charAt(0)
                                                );
                                        }
                    ...
                    onBeforeMask: function onBeforeMask(initialValue, opts) {
                        ...
                        var valueParts = initialValue.split(radixPoint),
                            integerPart = valueParts[0].replace(
                                /[^\-0-9]/g,
                                ""
                            ),
                            decimalPart =
