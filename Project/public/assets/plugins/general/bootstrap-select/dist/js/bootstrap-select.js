...
(function (root, factory) {
    ...
    (function ($) {
        ...
        function allowedAttribute(attr, allowedAttributeList) {
            ...
            var regExp = $(allowedAttributeList).filter(function (
                index,
                value
            ) {
        ...
        function sanitizeHtml(unsafeElements, whiteList, sanitizeFn) {
            ...
            for (var i = 0, len = unsafeElements.length; i < len; i++) {
                ...
                for (var j = 0, len2 = elements.length; j < len2; j++) {
                    ...
                    for (
                        var k = 0, len3 = attributeList.length;
                        k < len3;
                        k++
                    ) {
        ...
        var generateOption = {
            ...
            text: function (options, useFragment) {
                ...
                if (options.content) {
                    ...
                    if (options.subtext) {
                        subtextElement =
                            elementTemplates.subtext.cloneNode(false);
        ...
        Selectpicker.prototype = {
                    ...
                    this.$element.on("hide" + EVENT_KEY, function () {
                        if (that.isVirtual()) {
                            ...
                            var menuInner = that.$menuInner[0],
                                emptyMenu =
                                    menuInner.firstChild.cloneNode(false);

                            // replace the existing UL with an empty one - this is faster than $.empty() or innerHTML = ''
                            menuInner.replaceChild(
                                emptyMenu,
                                menuInner.firstChild
                            );
                        ...
                        that.$element
                            ...
                            .on("rendered" + EVENT_KEY, function () {
                                ...
                                if (this.validity.valid)
                                    that.$button[0].classList.remove(
                                        "bs-invalid"
                                    );
                ...
                function scroll(scrollTop, init) {
                    ...
                    if (isVirtual === true) {
                        ...
                        if (
                            ...
                            that.$menu[0].offsetWidth >
                                that.sizeInfo.totalMenuWidth
                        ) {
                            that.sizeInfo.menuWidth = that.$menu[0].offsetWidth;
                            that.sizeInfo.totalMenuWidth =
                                that.sizeInfo.menuWidth +
                                that.sizeInfo.scrollBarWidth;
                            that.$menu.css(
                                "min-width",
                                that.sizeInfo.menuWidth
                            );
                    ...
                    if (that.activeIndex !== undefined) {
                        prevActive =
                            that.selectpicker.main.elements[
                                that.prevActiveIndex
                            ];
                        active =
                            that.selectpicker.main.elements[that.activeIndex];
                        selected =
                    ...
                    if (init || positionIsDifferent) {
                        previousElements = that.selectpicker.view
                            .visibleElements
                    ...
                    if (!that.options.liveSearch) {
                        ...
                        newActive =
                            that.selectpicker.view.visibleElements[index];
            ...
            createLi: function () {
                ...
                function addOption(option, config) {
                    ...
                    config.divider =
                        option.getAttribute("data-divider") === "true";
            ...
            render: function () {
                ...
                if (this.options.selectedTextFormat === "static") {
                    ...
                    showCount =
                        this.multiple &&
                        this.options.selectedTextFormat.indexOf("count") !==
                            -1 &&
                        selectedCount > 1;
                        ...
                        for (
                            ...
                            if (selectedIndex < 50) {
                                var option = selectedOptions[selectedIndex],
                                    ...
                                    thisData = {
                                        content:
                                            option.getAttribute("data-content"),
                                        subtext:
                                            option.getAttribute("data-subtext"),
            ...
            setStyle: function (newStyle, status) {
                ...
                if (version.major < 4) {
                    ...
                    if (
                        newElement.parentNode.classList.contains(
                            "input-group"
                        ) &&
            ...
            liHeight: function (refresh) {
                ...
                var newElement = document.createElement("div"),
                    ...
                    header =
                        this.options.header &&
                        this.$menu.find("." + classNames.POPOVERHEADER).length >
                            0
                            ? this.$menu
                ...
                a.className =
                    "dropdown-item " +
                    (firstOption ? firstOption.className : "");
            ...
            getSelectPosition: function () {
                ...
                if (
                    ...
                    containerPos.top += parseInt(
                        $container.css("borderTopWidth")
                    );
            ...
            setMenuSize: function (isAuto) {
                ...
                if (this.options.size === "auto") {
                    ...
                    minHeight =
                        ...
                        actionsHeight +
                        doneButtonHeight;
                    menuInnerMinHeight = Math.max(
                        _minHeight - menuPadding.vert,
                        0
                    );
                    ...
                    for (var i = 0; i < this.options.size; i++) {
                        if (
                            this.selectpicker.current.data[i].type === "divider"
                        )
                            divLength++;
                    }
            ...
            checkDisabled: function () {
                ...
                if (this.isDisabled()) {
                    ...
                    if (
                        this.$button[0].classList.contains(classNames.DISABLED)
                    ) {
                ...
                this.$menuInner.on("click", "li a", function (e, retainActive) {
                    ...
                    if (
                        ...
                        var $options = that.$element.find("option"),
                            ...
                            maxOptionsGrp =
                                $optgroup.data("maxOptions") || false;
                ...
                this.$searchbox.on("input propertychange", function () {
                    ...
                    if (searchValue) {
                        ...
                        if (!searchMatch.length) {
                            ...
                            that.$menuInner[0].firstChild.appendChild(
                                noResults
                            );
                        }
                    } else {
            ...
            keydown: function (e) {
                ...
                if (isArrowKey) {
                    ...
                    liActive =
                        that.selectpicker.current.elements[liActiveIndex];
                    ...
                    for (
                        ...
                        if (
                            hasMatch &&
                            that.selectpicker.view.canHighlight[i]
                        ) {
                ...
                if (
                    ...
                    if (
                        ...
                        that.$menuInner
                            .find(".active a")
                            .trigger("click", true); // retain active class
                        $this.trigger("focus");
                    ...
                    if (!data) {
                        ...
                        for (var dataAttr in dataAttributes) {
                            if (
                                ...
                                $.inArray(dataAttr, DISALLOWED_ATTRIBUTES) !==
                                    -1
                            ) {
