...
(function (global, factory) {
    ...
    function prvwidth() {
        ...
        this.$container.width(
            this.privateHandleWidth * 2 + this.privateLabelWidth
        );
        return this.$wrapper.width(
            this.privateHandleWidth + this.privateLabelWidth
        );
    }
    ...
    function prvinit() {
        ...
        var init = function init() {
            ...
            setTimeout(function () {
                return (
                    _this3.options.animate &&
                    _this3.$wrapper.addClass(
                        prvgetClass.call(_this3, "animate")
                    )
                );
            }, 50);
        };
    ...
    function prvelementHandlers() {
        ...
        return this.$element.on({
            "setPreviousOptions.bootstrapSwitch":
                function setPreviousOptionsBootstrapSwitch() {
            ...
            "previousState.bootstrapSwitch":
                function previousStateBootstrapSwitch() {
                    ...
                    if (_this4.options.indeterminate) {
                        _this4.$wrapper.addClass(
                            prvgetClass.call(_this4, "indeterminate")
                        );
                    }
                    _this4.$element
                        .prop("checked", _this4.options.state)
            ...
            "change.bootstrapSwitch": function changeBootstrapSwitch(
                ...
                _this4.$wrapper
                    .toggleClass(prvgetClass.call(_this4, "off"))
                    .toggleClass(prvgetClass.call(_this4, "on"));
                if (!skip) {
                    if (_this4.$element.is(":radio")) {
                        $('[name="' + _this4.$element.attr("name") + '"]')
                            .not(_this4.$element)
                            .prop("checked", false)
                            .trigger("change.bootstrapSwitch", true);
                    }
                    _this4.$element.trigger("switchChange.bootstrapSwitch", [
                        state,
                    ]);
                }
            },
            ...
            "blur.bootstrapSwitch": function blurBootstrapSwitch(event) {
                event.preventDefault();
                _this4.$wrapper.removeClass(
                    prvgetClass.call(_this4, "focused")
                );
            },
            ...
            "keydown.bootstrapSwitch": function keydownBootstrapSwitch(event) {
                if (
                    !event.which ||
                    _this4.options.disabled ||
                    _this4.options.readonly
                ) {
                    return;
                }
        ...
        var handlers = {
            ...
            "mousedown.bootstrapSwitch touchstart.bootstrapSwitch":
                function mousedownBootstrapSwitchTouchstartBootstrapSwitch(
                    ...
                    if (
                        dragStart ||
                        _this6.options.disabled ||
                        _this6.options.readonly
                    ) {
                        return;
                    }
                    event.preventDefault();
                    ...
                    dragStart =
                        ...
                        parseInt(_this6.$container.css("margin-left"), 10);
                    if (_this6.options.animate) {
                        _this6.$wrapper.removeClass(
                            prvgetClass.call(_this6, "animate")
                        );
                    }
            ...
            "mousemove.bootstrapSwitch touchmove.bootstrapSwitch":
                function mousemoveBootstrapSwitchTouchmoveBootstrapSwitch(
                    event
                ) {
                    if (dragStart == null) {
                        return;
                    ...
                    event.preventDefault();
                    if (
                        difference < -_this6.privateHandleWidth ||
                        difference > 0
                    ) {
                        return;
                    }
        ...
        function BootstrapSwitch(element) {
            ...
            this.$wrapper = $("<div>", {
                class: function _class() {
                    return getClasses(
                        _this9.options,
                        _this9.$element.attr("id")
                    )
                        .map(function (v) {
                            return prvgetClass.call(_this9, v);
                        })
                        .concat(
                            [_this9.options.baseClass],
                            prvgetClasses.call(
                                _this9,
                                _this9.options.wrapperClass
                            )
                        )
                        .join(" ");
                },
            ...
            this.$on = $("<span>", {
                ...
                class:
                    prvgetClass.call(this, "handle-on") +
                    " " +
                    prvgetClass.call(this, this.options.onColor),
            });
            this.$off = $("<span>", {
                html: this.options.offText,
                class:
                    prvgetClass.call(this, "handle-off") +
                    " " +
                    prvgetClass.call(this, this.options.offColor),
            });
            this.$label = $("<span>", {
            ...
            this.$element.on("switchChange.bootstrapSwitch", function () {
                ...
                var changeState = _this9.options.onSwitchChange.apply(
                    element,
                    args
                );
                if (changeState === false) {
                    if (_this9.$element.is(":radio")) {
                        $(
                            '[name="' + _this9.$element.attr("name") + '"]'
                        ).trigger("previousState.bootstrapSwitch", true);
                    } else {
                        _this9.$element.trigger(
                            "previousState.bootstrapSwitch",
                            true
                        );
                    }
        ...
        _createClass(BootstrapSwitch, [
                ...
                value: function size(value) {
                    ...
                    if (this.options.size != null) {
                        this.$wrapper.removeClass(
                            prvgetClass.call(this, this.options.size)
                        );
                    }
                    if (value) {
            ...
            },
            {
                ...
                value: function toggleDisabled() {
                    ...
                    this.$wrapper.toggleClass(
                        prvgetClass.call(this, "disabled")
                    );
                    return this.$element;
                },
            },
            ...
            },
            {
                ...
                value: function toggleReadonly() {
                    ...
                    this.$wrapper.toggleClass(
                        prvgetClass.call(this, "readonly")
                    );
                    return this.$element;
                },
            },
            ...
            },
            {
                ...
                value: function toggleIndeterminate() {
                    ...
                    this.$wrapper.toggleClass(
                        prvgetClass.call(this, "indeterminate")
                    );
                    prvcontainerPosition.call(this);
                    return this.$element;
                },
            ...
            },
            {
                ...
                value: function wrapperClass(value) {
                    ...
                    this.$wrapper.removeClass(
                        prvgetClasses
                            .call(this, this.options.wrapperClass)
                            .join(" ")
                    );
                    this.$wrapper.addClass(
                        prvgetClasses.call(this, wrapperClass).join(" ")
                    );
