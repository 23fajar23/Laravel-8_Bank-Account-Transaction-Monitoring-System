    ...
    (b.DEFAULTS = {
        ...
        (b.prototype.init = function (c, d, e) {
            ...
            if (0 != f.$element.find("optgroup").length) {
                ...
                (i = Math.min(i, 10)),
                    ...
                    f.$firstSelect.on(
                        "change",
                        a.proxy(f.updateParentCategory, f)
                    ),
                    f.$secondSelect.on(
                        "click change",
                        a.proxy(f.updateChildCategory, f)
                    ),
                    (f.update = function () {
                ...
                a.each(
                    ...
                    function (c, d) {
                        var e = a(this).val(),
                            f = a(this).text(),
                            g = a(
                                b.options.createSecondSelect(f, b.$firstSelect)
                            );
                        g.val(e),
                            a.each(
                                b.$element.find("option:selected"),
                                function (b, c) {
        ...
        (b.prototype.checkSelected = function () {
            ...
            if (b.$element.attr("multiple") && b.options.maximumSelected) {
                ...
                if (
                    ((c =
                        "function" == typeof b.options.maximumSelected
        ...
        (b.prototype.basicUpdateChildCategory = function (b, c) {
            ...
            d.$element.attr("multiple")
                ? d.options.onlySameGroup
                    ? a.each(
                          d.$element.find("option:selected"),
                          function (b, c) {
                              if (a(c).parent().attr("label") != f)
                                  return (g = !0), !1;
                          }
                      )
                    : c || (g = !0)
