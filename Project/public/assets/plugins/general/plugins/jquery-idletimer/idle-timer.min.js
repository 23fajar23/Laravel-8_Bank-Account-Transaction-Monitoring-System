...
!(function (a) {
    (a.idleTimer = function (b, c) {
        ...
        "object" == typeof b
            ? ((d = b), (b = null))
            : "number" == typeof b && ((d = { timeout: b }), (b = null)),
            (c = c || document),
            (d = a.extend(
                {
                    idle: !1,
        ...
        var e = a(c),
            ...
            h = function (b) {
                ...
                if (
                    ("storage" !== b.type ||
                        b.originalEvent.key === d.timerSyncId) &&
                    null == d.remaining
                ) {
                    if ("mousemove" === b.type) {
                        if (b.pageX === d.pageX && b.pageY === d.pageY) return;
                        if (
                            "undefined" == typeof b.pageX &&
                            "undefined" == typeof b.pageY
                        )
                            return;
        ...
        return (
            e.on(
                a.trim((d.events + " ").split(" ").join("._idleTimer ")),
                function (a) {
                    h(a);
                }
            ),
