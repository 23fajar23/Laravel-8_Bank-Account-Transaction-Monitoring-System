...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    return /******/ (function (modules) {
        ...
        /******/ return __webpack_require__(
            (__webpack_require__.s = "./dev/raphael.amd.js")
        );
        /******/
    })(
        /************************************************************************/
  ...
  \****************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    !((__WEBPACK_AMD_DEFINE_ARRAY__ = [
                        __webpack_require__(
                            /*! ./raphael.core */ "./dev/raphael.core.js"
                        ),
                        __webpack_require__(
  ...
  \*****************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    !((__WEBPACK_AMD_DEFINE_ARRAY__ = [
                        __webpack_require__(
                            /*! eve */ "./node_modules/eve-raphael/eve.js"
                        ),
                    ]),
                        ...
                        function R(first) {
                            if (R.is(first, "function")) {
                                ...
                                if (R.is(args[args.length - 1], "function")) {
                                    ...
                                    return loaded
                                        ? f.call(
                                              R._engine.create[apply](R, args)
                                          )
                                        : eve.on(
                                              "raphael.DOMload",
                                              function () {
                                                  f.call(
                                                      R._engine.create[apply](
                                                          R,
                                                          args
                                                      )
                                                  );
    ...
    \*/
                        R.deg = function (rad) {
                            return (
                                Math.round((((rad * 180) / PI) % 360) * 1000) /
                                1000
                            );
                        };
                        /*\
    ...
    \*/
                        R.snapTo = function (values, value, tolerance) {
                            tolerance = R.is(tolerance, "finite")
                                ? tolerance
                                : 10;
    ...
    \*/
                        R.getRGB = cacher(function (colour) {
                            ...
                            !(
                                hsrg[has](
                                    colour.toLowerCase().substring(0, 2)
                                ) || colour.charAt() == "#"
                            ) && (colour = toHex(colour));
                            var res,
                                red,
    ...
    \*/
                        R.getColor = function (value) {
                            var start = (this.getColor.start = this.getColor
                                    .start || { h: 0, s: 1, b: value || 0.75 }),
    ...
    \*/
                        ...
                        function bezlen(x1, y1, x2, y2, x3, y3, x4, y4, z) {
                            ...
                            var z2 = z / 2,
                                ...
                                Cvalues = [
                                    0.2491, 0.2491, 0.2335, 0.2335, 0.2032,
                                    0.2032, 0.1601, 0.1601, 0.1069, 0.1069,
                                    0.0472, 0.0472,
                                ],
                                sum = 0;
                            for (var i = 0; i < n; i++) {
                        ...
                        function getTatLen(x1, y1, x2, y2, x3, y3, x4, y4, ll) {
                            if (
                                ll < 0 ||
                                bezlen(x1, y1, x2, y2, x3, y3, x4, y4) < ll
                            ) {
                                return;
                            }
                            var t = 1,
                        ...
                        function interHelper(bez1, bez2, justCount) {
                            ...
                            for (var i = 0; i < n1 + 1; i++) {
                                var p = R.findDotsAtSegment.apply(
                                    R,
                                    bez1.concat(i / n1)
                                );
                            ...
                            for (i = 0; i < n1; i++) {
                                for (var j = 0; j < n2; j++) {
                                    var di = dots1[i],
                                        ...
                                        dj1 = dots2[j + 1],
                                        ci =
                                            abs(di1.x - di.x) < 0.001
                                                ? "y"
                                                : "x",
                                        cj =
                                            abs(dj1.x - dj.x) < 0.001
                                                ? "y"
                                                : "x",
                                        is = intersect(
                                            di.x,
    ...
    \*/
                        var pathDimensions = (R.pathBBox = function (path) {
                            ...
                            pathToRelative = (R._pathToRelative = function (
                                pathArray
                            ) {
                                ...
                                for (
                                    var i = start, ii = pathArray.length;
                                    i < ii;
                                    i++
                                ) {
                                    var r = (res[i] = []),
                            ...
                            pathToAbsolute = (R._pathToAbsolute = function (
                                pathArray
                            ) {
                                var pth = paths(pathArray);
                                if (pth.abs) {
                                ...
                                for (
                                    var r, pa, i = start, ii = pathArray.length;
                                    i < ii;
                                    i++
                                ) {
                                    res.push((r = []));
                            ...
                            path2curve = (R._path2curve = cacher(
                                function (path, path2) {
                                    ...
                                    for (
                                        ...
                                        attrs.bx =
                                            toFloat(seg[seglen - 4]) || attrs.x;
                                        attrs.by =
                                            toFloat(seg[seglen - 3]) || attrs.y;
                                        attrs2.bx =
                                            p2 &&
                                            (toFloat(seg2[seg2len - 4]) ||
                                                attrs2.x);
                                        attrs2.by =
                                            p2 &&
                                            (toFloat(seg2[seg2len - 3]) ||
                                                attrs2.y);
                            ...
                            parseDots = (R._parseDots = cacher(function (
                                gradient
                            ) {
                                var dots = [];
                                for (
                                    var i = 0, ii = gradient.length;
                                    i < ii;
                                    i++
                                ) {
                                    var dot = {},
                            ...
                            insertafter = (R._insertafter = function (
                                el,
                                el2,
                                paper
                            ) {
                            ...
                            insertbefore = (R._insertbefore = function (
                                el,
                                el2,
                                paper
                            ) {
         ...
         * Returns path transformed by a given transformation
         ...
         = (string) path
        \*/
                            transformPath = (R.transformPath = function (
                                path,
                                transform
                            ) {
                                return mapPath(path, toMatrix(path, transform));
                            }),
                            extractTransform = (R._extractTransform = function (
                                el,
                                tstr
                            ) {
                                if (tstr == null) {
            ...
            \*/
                            ...
                            equaliseTransform = (R._equaliseTransform =
                                function (t1, t2) {
                        ...
                        R._getContainer = function (x, y, w, h) {
                            var container;
                            container =
                                h == null && !R.is(x, "object")
                                    ? g.doc.getElementById(x)
                                    : x;
                            if (container == null) {
                                return;
                            }
                            if (container.tagName) {
                                if (y == null) {
                                    return {
                                        container: container,
                                        width:
                                            container.style.pixelWidth ||
                                            container.offsetWidth,
                                        height:
                                            container.style.pixelHeight ||
    ...
    \*/
        ...
        \*/
                            ...
                            matrixproto.get = function (i) {
                                return +this[Str.fromCharCode(97 + i)].toFixed(
                                    4
                                );
                            };
        ...
        \*/
                            matrixproto.split = function () {
                                ...
                                out.isSimple =
                                    !+out.shear.toFixed(9) &&
                                    (out.scalex.toFixed(9) ==
                                        out.scaley.toFixed(9) ||
                                        !out.rotate);
                                out.isSuperSimple =
                                    !+out.shear.toFixed(9) &&
                                    out.scalex.toFixed(9) ==
                                    ...
                                    !out.rotate;
                                out.noRotation =
                                    !+out.shear.toFixed(9) && !out.rotate;
                                return out;
                            };
                            /*\
    ...
    \*/
                        for (var i = events.length; i--; ) {
                            (function (eventName) {
                                R[eventName] = elproto[eventName] = function (
                                    fn,
                                    scope
                                ) {
                                    if (R.is(fn, "function")) {
    ...
    \*/
                        elproto.drag = function (
                            ...
                            function start(e) {
                                ...
                                onmove &&
                                    eve.on(
                                        "raphael.drag.move." + this.id,
                                        onmove
                                    );
                                onend &&
                                    eve.on(
                                        "raphael.drag.end." + this.id,
                                        onend
                                    );
                                eve(
                                    "raphael.drag.start." + this.id,
    ...
    \*/
                        paperproto.setViewBox = function (x, y, w, h, fit) {
                            return R._engine.setViewBox.call(
                                this,
                                x,
                                y,
                                w,
    ...
    \*/
                        elproto.getBBox = function (isWithoutTransform) {
                            ...
                            if (_.dirty || _.dirtyT || !_.bbox) {
                                ...
                                _.bbox = pathDimensions(
                                    mapPath(this.realPath, this.matrix)
                                );
    ...
    \*/
                        elproto.animateWith = function (
                            ...
                            for (
                                var i = 0, ii = animationElements.length;
                                i < ii;
                                i++
                            ) {
                                if (
                                    ...
                                    animationElements[ii - 1].start =
                                        animationElements[i].start;
                                    break;
                                }
                            }
                            return element;
    ...
    \*/
                        ...
                        function runAnimation(
                            ...
                            if (status) {
                                for (
                                    i = 0, ii = animationElements.length;
                                    i < ii;
                                    i++
                                ) {
                            ...
                            for (
                                var i = 0, ii = anim.percents.length;
                                i < ii;
                                i++
                            ) {
                                if (
                            ...
                            if (!isInAnim) {
                                for (var attr in params)
                                    if (params[has](attr)) {
                                        if (
                                            ...
                                            element.paper.customAttributes[has](
                                                attr
                                            )
                                        ) {
                                ...
                                timestamp =
                                    params.start || anim.start || +new Date();
                                e = {
                                    anim: anim,
                                    percent: percent,
                                    timestamp: timestamp,
                                ...
                                isInAnim.start =
                                    new Date() - isInAnim.ms * status;
                            }
                            eve(
                                "raphael.anim.start." + element.id,
                                element,
                                anim
                            );
                        }
    ...
    \*/
                        ...
                        setproto.animate = function (
                            ...
                            while (i--) {
                                ...
                                (this.items[i] && !this.items[i].removed) ||
                                    len--;
                            }
                            return this;
                        };
    ...
    \*/
                        paperproto.print = function (
                            ...
                            if (font) {
                                scale =
                                    (size || 16) / font.face["units-per-em"];
  ...
  \****************************/
                            ...
                            addArrow = function (o, value, isEnd) {
                                if (o.type == "path") {
                                    ...
                                    for (attr in markerCounter)
                                        if (
                                            markerCounter[has](attr) &&
                                            !markerCounter[attr]
                                        ) {
                                            var item =
                                                R._g.doc.getElementById(attr);
                                            item &&
                            ...
                            tuneText = function (el, params) {
                                ...
                                if (params[has]("text")) {
                                    ...
                                    for (
                                        ...
                                        tspan.appendChild(
                                            R._g.doc.createTextNode(texts[i])
                                        );
    ...
    \*/
                        elproto.rotate = function (deg, cx, cy) {
                            ...
                            this.transform(
                                this._.transform.concat([["r", deg, cx, cy]])
                            );
                            return this;
                        };
                        /*\
    ...
    \*/
                        elproto.scale = function (sx, sy, cx, cy) {
                            ...
                            this.transform(
                                this._.transform.concat([["s", sx, sy, cx, cy]])
                            );
                            return this;
                        };
                        /*\
    ...
    \*/
                        elproto.translate = function (dx, dy) {
                            ...
                            dy = +dy || 0;
                            this.transform(
                                this._.transform.concat([["t", dx, dy]])
                            );
                            return this;
                        };
                        /*\
    ...
    \*/
                        ...
                        elproto._getBBox = function () {
                            ...
                            if (this.paper.canvas.parentElement) {
                                containerStyle =
                                    this.paper.canvas.parentElement.style;
                            } //IE10+ can't find parentElement
                            else if (this.paper.canvas.parentNode) {
                                containerStyle =
                                    this.paper.canvas.parentNode.style;
                            }
                        ...
                        elproto.attr = function (name, value) {
                            ...
                            if (value == null && R.is(name, "string")) {
                                ...
                                for (
                                    ...
                                    if (name in this.attrs) {
                                        ...
                                        R.is(
                                            this.paper.customAttributes[name],
                                            "function"
                                        )
                                    ) {
                                        out[name] =
                                            this.paper.customAttributes[
                                                name
                                            ].def;
                                    } else {
                            ...
                            for (key in this.paper.customAttributes)
                                if (
                                    ...
                                    params[has](key) &&
                                    R.is(
                                        this.paper.customAttributes[key],
                                        "function"
                                    )
                                ) {
                                    var par = this.paper.customAttributes[
                                        key
                                    ].apply(this, [].concat(params[key]));
    ...
    \*/
                        elproto.insertAfter = function (element) {
                            ...
                            if (afterNode.nextSibling) {
                                afterNode.parentNode.insertBefore(
                                    node,
    ...
    \*/
                        elproto.insertBefore = function (element) {
                            ...
                            var node = getRealNode(this.node);
                            var beforeNode = getRealNode(
                                element.node || element[0].node
                            );
                        ...
                        R._engine.setViewBox = function (x, y, w, h, fit) {
                            ...
                            while (size && top) {
                                sw =
                                    "stroke-width" in top.attrs
                                        ? top.attrs["stroke-width"]
                                        : 1;
    ...
    \*/
                        R.prototype.clear = function () {
                            ...
                            (this.desc = $("desc")).appendChild(
                                R._g.doc.createTextNode(
                                    "Created with Rapha\xebl " + R.version
                                )
                            );
                ...
                /***/ function (module, exports, __webpack_require__) {
                    ...
                    (__WEBPACK_AMD_DEFINE_RESULT__ = function (R) {
                        ...
                        var has = "hasOwnProperty",
                            ...
                            setCoords = function (p, sx, sy, dx, dy, deg) {
                                ...
                                if (fillpos || _.fillsize) {
                                    var fill =
                                        o.getElementsByTagName(fillString);
                                    fill = fill && fill[0];
                                    o.removeChild(fill);
                                    if (fillpos) {
                                        c = compensation(
                        ...
                        var addArrow = function (o, value, isEnd) {
                                ...
                                var stroke =
                                    o.node.getElementsByTagName("stroke")[0];
                            ...
                            setFillAndStroke = function (o, params) {
                                ...
                                if ("clip-rect" in params) {
                                    var rect = Str(params["clip-rect"]).split(
                                        separator
                                    );
                                    if (rect.length == 4) {
                                ...
                                if (o.textpath) {
                                    ...
                                    params["font-family"] &&
                                        (textpathStyle.fontFamily =
                                            ...
                                            '"');
                                    params["font-size"] &&
                                        (textpathStyle.fontSize =
                                            params["font-size"]);
                                    params["font-weight"] &&
                                        (textpathStyle.fontWeight =
                                            params["font-weight"]);
                                    params["font-style"] &&
                                        (textpathStyle.fontStyle =
                                            params["font-style"]);
                                }
                                ...
                                if (
                                    ...
                                    if (fill.on && params.fill) {
                                        var isURL = Str(params.fill).match(
                                            R._ISURL
                                        );
                                        if (isURL) {
                                ...
                                if (res.type == "text") {
                                    ...
                                    res.W = a.w =
                                        (brect.right - brect.left) / m;
                                    res.H = a.h =
                                        (brect.bottom - brect.top) / m;
                                    ...
                                    switch (a["text-anchor"]) {
                                        case "start":
                                            res.textpath.style["v-text-align"] =
                                                "left";
                                            res.bbx = res.W / 2;
                                            break;
                                        case "end":
  ...
  \*****************************************/
                ...
                /***/ function (module, exports, __webpack_require__) {
                    var __WEBPACK_AMD_DEFINE_ARRAY__,
                        __WEBPACK_AMD_DEFINE_RESULT__; // Copyright (c) 2013 Adobe Systems Incorporated. All rights reserved.
                    //
