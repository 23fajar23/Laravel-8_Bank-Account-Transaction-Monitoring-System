    ...
    Markdown.prototype = {
        ...
        __alterButtons: function (name, alter) {
            ...
            $.each(handler, function (k, v) {
                ...
                if (halt === false) {
                    alter(
                        that.$editor.find('button[data-handler="' + v + '"]')
                    );
                }
            });
        },
                ...
                for (y = 0; y < btnGroups.length; y++) {
                    ...
                    for (z = 0; z < buttons.length; z++) {
                        var button = buttons[z],
                            ...
                            hotkey =
                                typeof button.hotkey !== "undefined"
                                    ...
                                    : "",
                            hotkeyCaption =
                                typeof jQuery.hotkeys !== "undefined" &&
                                hotkey !== ""
                                    ? " (" + hotkey + ")"
                                    : "";
                        ...
                        buttonContainer.attr({
                            type: "button",
                            title:
                                this.__localize(button.title) + hotkeyCaption,
                            tabindex: tabIndex,
                            "data-provider": ns,
                        ...
                        function (idx, buttonGroup) {
                            ...
                            var matchingGroups = $.grep(
                                ...
                                function (allButtonGroup, allIdx) {
                                    return (
                                        allButtonGroup.name === buttonGroup.name
                                    );
                                }
                            );
                            ...
                            if (matchingGroups.length > 0) {
                                matchingGroups[0].data =
                                    matchingGroups[0].data.concat(
                                        buttonGroup.data
                                    );
                            } else {
                                allBtnGroups.push(
                                    options.additionalButtons[0][idx]
                                );
                            }
                        }
                    );
                    ...
                    editorHeader
                        .append(
                            '<div class="md-controls"><a class="md-control md-control-fullscreen" href="#"><span class="' +
                                this.__getIcon(
                                    options.fullscreen.icons.fullscreenOn
                                ) +
                                '"></span></a></div>'
                        )
                ...
                if (options.height && options.height !== "inherit") {
                    if (jQuery.isNumeric(options.height)) {
                        ...
                        if (editorHeader)
                            height = Math.max(
                                0,
                                height - editorHeader.outerHeight()
                            );
                        if (editorFooter)
                            height = Math.max(
                                0,
                                height - editorFooter.outerHeight()
                            );
