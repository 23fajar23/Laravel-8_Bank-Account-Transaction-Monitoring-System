...
(function () {
    ...
    function setup($) {
        ...
        $.growlUI = function (title, message, timeout, onClose) {
            ...
            var callBlock = function (opts) {
                ...
                $.blockUI({
                    message: $m,
                    fadeIn:
                        typeof opts.fadeIn !== "undefined" ? opts.fadeIn : 700,
                    fadeOut:
                        typeof opts.fadeOut !== "undefined"
                            ? opts.fadeOut
                            : 1000,
                    timeout:
        ...
        function install(el, opts) {
            ...
            var full = el == window;
            var msg =
                opts && opts.message !== undefined ? opts.message : undefined;
            ...
            if (ie6 || expr) {
                ...
                $.each(layers, function (i, o) {
                    ...
                    if (i < 2) {
                        ...
                        var top =
                            opts.css && opts.css.top
                                ? parseInt(opts.css.top, 10)
                                : 0;
                        var expression =
        ...
        function bind(b, el, opts) {
            ...
            if (
                !b &&
                ((full && !pageBlock) ||
                    (!full && !$el.data("blockUI.isBlocked")))
            )
                return;
        ...
        function center(el, x, y) {
            var p = el.parentNode,
                s = el.style;
            var l =
                (p.offsetWidth - el.offsetWidth) / 2 - sz(p, "borderLeftWidth");
            var t =
                (p.offsetHeight - el.offsetHeight) / 2 -
                sz(p, "borderTopWidth");
