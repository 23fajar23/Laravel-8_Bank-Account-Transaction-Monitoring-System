(function (a) {
    ...
    function a() {
        ...
        k = new Date().toString();
        p =
            ((m = k.split("(")[1]) != null ? m.slice(0, -1) : 0) ||
            k.split(" ");
    ...
    var g = function (k, j) {
        ...
        this.language =
            j.language || this.element.data("date-language") || "en";
        this.language =
        ...
        this.linkField =
            j.linkField || this.element.data("link-field") || false;
        ...
        this.todayBtn =
            j.todayBtn || this.element.data("date-today-btn") || false;
        this.clearBtn =
            j.clearBtn || this.element.data("date-clear-btn") || false;
        this.todayHighlight =
            j.todayHighlight ||
    ...
    g.prototype = {
        ...
        setDate: function (i) {
            this.setUTCDate(
                new Date(i.getTime() - i.getTimezoneOffset() * 60000)
            );
        },
        ...
        fill: function () {
            ...
            for (var y = 0; y < 24; y++) {
                ...
                if (
                    this.showMeridian &&
                    e[this.language].meridiem.length === 2
                ) {
                    C =
                        y < 12
        ...
        showMode: function (i) {
            if (i) {
                var j = Math.max(
                    0,
                    Math.min(c.modes.length - 1, this.viewMode + i)
                );
        ...
        this.each(function () {
            ...
            if (!m) {
                n.data(
                    ...
                    (m = new g(
                        this,
                        d.extend({}, d.fn.datetimepicker.defaults, l)
                    ))
                );
            }
