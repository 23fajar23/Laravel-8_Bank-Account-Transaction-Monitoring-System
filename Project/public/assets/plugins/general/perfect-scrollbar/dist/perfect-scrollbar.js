...
(function (global, factory) {
    ...
    var updateGeometry = function (i) {
        ...
        if (!element.contains(i.scrollbarXRail)) {
            // clean up and append
            queryChildren(element, cls.element.rail("x")).forEach(function (
                el
            ) {
                return remove(el);
            });
        ...
        if (!element.contains(i.scrollbarYRail)) {
            // clean up and append
            queryChildren(element, cls.element.rail("y")).forEach(function (
                el
            ) {
                return remove(el);
            });
    ...
    var touch = function (i) {
        ...
        function touchMove(e) {
            if (shouldHandle(e)) {
                ...
                if (
                    shouldBeConsumedByChild(e.target, differenceX, differenceY)
                ) {
                    return;
                }
