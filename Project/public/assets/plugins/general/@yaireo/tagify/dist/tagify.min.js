        ...
        (t.prototype = {
            ...
            applySettings: function (t, e) {
                ...
                if (
                    ...
                    (this.DEFAULTS.dropdown.itemTemplate =
                        this.templates.dropdownItem),
                    (this.settings = this.extend({}, this.DEFAULTS, e)),
                    (this.settings.readonly = t.hasAttribute("readonly")),
                    this.isIE && (this.settings.autoComplete = !1),
                    n &&
                        (n = n.split(this.settings.delimiters)) instanceof
                            Array &&
                        (this.settings.blacklist = n),
                    i &&
                        (i = i.split(this.settings.delimiters)) instanceof
                            Array &&
                        (this.settings.whitelist = i),
                    t.pattern)
                )
                    try {
            ...
            parseHTML: function (t) {
                return new DOMParser().parseFromString(t.trim(), "text/html")
            ...
            loadOriginalValues: function (t) {
                ...
                if (e) {
                    ...
                    "mix" == this.settings.mode
                        ? this.parseMixTags(e)
                        : this.addTags(e).forEach(function (t) {
            ...
            extend: function (t, e, i) {
                ...
                return (
                    t instanceof Object || (t = {}), s(t, e), i && s(t, i), t
                );
            },
                    ...
                    (this.trigger = function (t, e) {
                        ...
                        if (t)
                            if (n.settings.isJQueryPlugin)
                                $(n.DOM.originalInput).triggerHandler(t, [e]);
                            else {
                                try {
            ...
            events: {
                ...
                binding: function (t) {
                    ...
                    for (var a in (i &&
                        ...
                        (this.DOM.input.addEventListener(
                            ...
                            n[this.isIE ? "onInputIE" : "onInput"].bind(this)
                        ),
                        this.settings.isJQueryPlugin &&
                            $(this.DOM.originalInput).on(
                ...
                callbacks: {
                    onFocusBlur: function (t) {
                        ...
                        "mix" != this.settings.mode &&
                            ("focus" == t.type
                                ? (this.DOM.scope.classList.add(
                                      "tagify--focus"
                                  ),
                                  0 === this.settings.dropdown.enabled &&
                                      this.dropdown.show.call(this))
                                : "blur" == t.type
                                ? (this.DOM.scope.classList.remove(
                                      "tagify--focus"
                                  ),
                                  e &&
                                      this.settings.addTagOnBlur &&
                                      this.addTags(e, !0).length)
                    ...
                    onKeydown: function (t) {
                        var e,
                            i = this,
                            n = t.target.textContent.trim();
                        if ("mix" == this.settings.mode) {
                            switch (t.key) {
                                case "Delete":
                                case "Backspace":
                                    var s = [];
                                    (e = this.DOM.input.children),
                                        setTimeout(function () {
                    ...
                    onInput: function (t) {
                        ...
                        e
                            ? this.input.value != e &&
                              ((n.isValid = this.validateTag.call(this, e)),
                              this.input.set.call(this, e, !1),
                              this.trigger("input", n),
                              -1 != e.search(this.settings.delimiters)
                                  ? this.addTags(e).length &&
                    ...
                    onMixTagsInput: function (t) {
                        ...
                        window.getSelection &&
                            0 < (e = window.getSelection()).rangeCount &&
                            ((i = e.getRangeAt(0).cloneRange()).collapse(!0),
                            i.setStart(window.getSelection().focusNode, 0),
                            (s = (n = i
                                .toString()
                                .split(this.settings.mixTagsAllowedAfter))[
                                n.length - 1
                            ].match(this.settings.pattern)) &&
                                ((this.state.tag = {
                                    prefix: s[0],
                                ...
                                (a =
                                    ...
                                    this.settings.dropdown.enabled))),
                            this.update(),
                            this.trigger(
                                "input",
                                this.extend({}, this.state.tag, {
                                    textContent: this.DOM.input.textContent,
                                })
                            ),
                            this.state.tag &&
                                this.dropdown[a ? "show" : "hide"].call(
                                    this,
                    ...
                    onEditTagInput: function (t) {
                        var e = t.closest("tag"),
                            ...
                            s =
                                n.toLowerCase() ==
                                    t.originalValue.toLowerCase() ||
                                this.validateTag(n);
                        e.classList.toggle("tagify--invalid", !0 !== s),
                            (e.isValid = s),
                            this.trigger("input", {
                                tag: e,
                                index: i,
                    ...
                    onEditTagBlur: function (t) {
                        var e,
                            ...
                            a = s || t.originalValue,
                            o = this.input.normalize(t) != t.originalValue,
                            r = i.isValid,
                            l = u({}, this.value[n], { value: a });
                        s
                            ? (o &&
                                  (this.settings.transformTag.call(this, l),
                                  (r = this.validateTag(l.value))),
                              (void 0 !== r && !0 !== r) ||
                                  ((t.textContent = l.value),
                                  (this.value[n].value = l.value),
                                  this.update(),
                                  (e = t.cloneNode(!0)).removeAttribute(
                                      "contenteditable"
                                  ),
                                  (i.title = l.value),
                                  i.classList.remove("tagify--editable"),
                    ...
                    onDoubleClickScope: function (t) {
                        var e,
                            i,
                            n = t.target.closest("tag"),
                            s = this.settings;
                        n &&
                            ((e = n.classList.contains("tagify--editable")),
            ...
            editTag: function (t) {
                ...
                n
                    ? (i.classList.add("tagify--editable"),
                      (n.originalValue = n.textContent),
                      n.setAttribute("contenteditable", !0),
                      n.addEventListener("blur", s.onEditTagBlur.bind(this, n)),
                      n.addEventListener(
                          "input",
                          s.onEditTagInput.bind(this, n)
                      ),
            ...
            input: {
                ...
                setRangeAtStartEnd: function (t, e) {
                    ...
                    document.createRange &&
                        ((i = document.createRange()).selectNodeContents(
                            a || this.DOM.input
                        ),
                        i.collapse(s),
                ...
                validate: function () {
                    var t =
                        !this.input.value ||
                        this.validateTag.call(this, this.input.value);
                    ...
                    suggest: function (t) {
                        t && this.input.value
                            ? this.DOM.input.setAttribute(
                                  "data-suggest",
                                  t.substring(this.input.value.length)
                              )
            ...
            isTagWhitelisted: function (e) {
                return this.settings.whitelist.some(function (t) {
                    if ((t.value || t).toLowerCase() === e.toLowerCase())
                        return !0;
                });
            },
                ...
                return (
                    e
                        ? this.settings.pattern &&
                          !this.settings.pattern.test(e)
                            ? (i = this.TEXTS.pattern)
                            : this.settings.duplicates ||
                              -1 === this.isTagDuplicate(e)
                            ? (this.isTagBlacklisted(e) ||
                                  (this.settings.enforceWhitelist &&
                                      !this.isTagWhitelisted(e))) &&
                              (i = this.TEXTS.notAllowed)
                            : (i = this.TEXTS.duplicate)
                        : (i = this.TEXTS.empty),
                    i
                );
            },
                ...
                return (
                    (t = t
                        ...
                        .map(function (t) {
                            ...
                            return (
                                1 < i.length &&
                                    s.isTagWhitelisted(i[0]) &&
                                    (o || -1 === s.isTagDuplicate(i[0])) &&
                                    ((n = s.normalizeTags(i[0])[0]),
                                    (e = s.createTagElem(n)),
                                    (i[0] = e.outerHTML + "&#8288;"),
                                    s.value.push(n)),
                                i.join("")
                ...
                if (t && this.state.tag) {
                    for (
                        var e,
                            ...
                            n,
                            s,
                            a = this.state.tag.prefix + this.state.tag.value,
            ...
            addTags: function (t, e, i) {
                ...
                if (
                    ((t = this.normalizeTags.call(this, t)),
                    "mix" == this.settings.mode)
                )
                    return this.addMixTag(t[0]);
                return (
                    this.DOM.input.removeAttribute("style"),
                    t.forEach(function (t) {
                        ...
                        if (
                            ((t = Object.assign({}, t)),
                            s.settings.transformTag.call(s, t),
                            !0 !==
                                (e =
                                    s.maxTagsReached() ||
                                    s.validateTag.call(s, t.value)))
                        ) {
                            if (a) return;
                            (n["aria-invalid"] = !0),
                                (n.class =
                                    (t.class || "") + " tagify--notAllowed"),
                                (n.title = e),
                        ...
                        (n.role = "tag"),
                            t.readonly && (n["aria-readonly"] = !0),
                            (i = s.createTagElem(s.extend({}, t, n))),
                            o.push(i),
                            function (t) {
                ...
                var n = this,
                    s =
                        0 < arguments.length && void 0 !== t
                            ...
                            : this.getLastTag(),
                    a = 1 < arguments.length ? e : void 0,
                    o = 2 < arguments.length && void 0 !== i ? i : 250;
                if (
                    ("string" == typeof s && (s = this.getTagElmByValue(s)),
                        ...
                        c = function () {
                            s.parentNode &&
                                ...
                                a ||
                                    ...
                                    n.dropdown.render.call(n)));
                        };
                    o && 10 < o
                        ? ((s.style.width =
                              parseFloat(window.getComputedStyle(s).width) +
                              "px"),
                          document.body.clientTop,
                          s.classList.add("tagify--hide"),
                          setTimeout(c, 400))
                        : c();
                }
            },
            ...
            getMixedTagsAsString: function () {
                var i = "";
                return (
                    this.DOM.input.childNodes.forEach(function (t, e) {
                        1 == t.nodeType
            ...
            dropdown: {
                ...
                show: function (t) {
                    var e,
                        i = "manual" == this.settings.dropdown.position;
                    if (this.settings.whitelist.length) {
                        ...
                        (e = this.dropdown.createListHTML.call(
                            ...
                            (this.DOM.dropdown.innerHTML = this.minify(e)),
                            this.settings.enforceWhitelist &&
                                !i &&
                ...
                position: function () {
                    ...
                    this.DOM.dropdown.style.cssText =
                        "left: " +
                        (t.left + window.pageXOffset) +
                        "px;                                                top: " +
                        (t.top + t.height - 1 + window.pageYOffset) +
                        "px;                                                width: " +
                        t.width +
                        "px";
                },
                events: {
                    binding: function (t) {
                        var e = !(0 < arguments.length && void 0 !== t) || t,
                            i = (this.listeners.dropdown = this.listeners
                                .dropdown || {
                                position: this.dropdown.position.bind(this),
                                onKeyDown:
                                    this.dropdown.events.callbacks.onKeyDown.bind(
                                        this
                                    ),
                                onMouseOver:
                                    this.dropdown.events.callbacks.onMouseOver.bind(
                                        this
                                    ),
                                onClick:
                                    this.dropdown.events.callbacks.onClick.bind(
                                        this
                                    ),
                            }),
                        ...
                        "manual" != this.settings.dropdown.position &&
                            ...
                            window[n]("mousedown", i.onClick),
                            this.DOM.dropdown[n]("mouseover", i.onMouseOver);
                    },
                    callbacks: {
                        onKeyDown: function (t) {
                            var e = this,
                                i = this.DOM.dropdown.querySelector(
                                    "[class$='--active']"
                                ),
                        ...
                        onMouseOver: function (t) {
                            t.target.className.includes("__item") &&
                                this.dropdown.highlightOption.call(
                                    this,
                                    t.target
                                );
                        ...
                        onClick: function (t) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (i.parentNode !== this.DOM.dropdown)
                                        return;
                                    (e =
                                        this.suggestedListItems[
                                            this.getNodeIndex(i)
                ...
                highlightOption: function (t, e) {
                    if (t) {
                        var i,
                            n = "tagify__dropdown__item--active";
                        this.DOM.dropdown
                            .querySelectorAll("[class$='--active']")
                            .forEach(function (t) {
                            ...
                            this.settings.autoComplete &&
                                !this.settings.dropdown.fuzzySearch &&
                                ((i =
                                    this.suggestedListItems[
                                        this.getNodeIndex(t)
                ...
                filterListItems: function (t) {
                    ...
                    for (
                        ...
                        ((n = (
                            ((e =
                                r[c] instanceof Object ? r[c] : { value: r[c] })
                                .searchBy || "") +
                            " " +
                            e.value
                        )
                        ...
                        (i = this.settings.dropdown.fuzzySearch
                            ? 0 <= n
                            : 0 == n),
                        (s =
                            !this.settings.duplicates &&
