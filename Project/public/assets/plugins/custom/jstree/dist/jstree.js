...
(function (factory) {
    ...
    $.jstree.core.prototype = {
        ...
        get_node: function (obj, as_dom) {
            ...
            try {
                if (this._model.data[obj]) {
                    ...
                    obj =
                        this._model.data[
                            dom.closest(".jstree-node").attr("id")
                        ];
                } else if (
        ...
        get_prev_dom: function (obj, strict) {
            ...
            return tmp &&
                tmp.className &&
                tmp.className.indexOf("jstree-node") !== -1
                ? $(tmp)
                : false;
        },
        /**
        ...
        is_parent: function (obj) {
            obj = this.get_node(obj);
            return (
                obj && (obj.state.loaded === false || obj.children.length > 0)
            );
        },
        /**
        ...
        _append_html_data: function (dom, data, cb) {
            ...
            dat.each(
                $.proxy(function (i, v) {
                    tmp = this._parse_model_from_html(
                        $(v),
                        par,
                        p.parents.concat()
                    );
            ...
            var w = null,
                ...
                func = function (data, undefined) {
                        ...
                        parse_flat = function (d, p, ps) {
                            ...
                            for (i = 0, j = tmp.children.length; i < j; i++) {
                                ...
                                if (e.children_d.length) {
                                    tmp.children_d = tmp.children_d.concat(
                                        e.children_d
                                    );
                                }
                            }
                    ...
                    if (
                        ...
                        for (i = 0, j = dat.length; i < j; i++) {
                            ...
                            m[dat[i].parent.toString()].children.push(
                                dat[i].id.toString()
                            );
                ...
                rslt = function (rslt, worker) {
                    ...
                    if (worker) {
                        ...
                        if (
                            r.length !== s.length ||
                            $.vakata.array_unique(r.concat(s)).length !==
                                r.length
                        ) {
            ...
            if (tmp.length) {
                tmp.each(
                    $.proxy(function (i, v) {
                        ...
                        if (e.children_d.length) {
                            data.children_d = data.children_d.concat(
                                e.children_d
                            );
                        }
                    }, this)
        ...
        _parse_model_from_flat_json: function (d, p, ps) {
            ...
            m[tmp.id] = tmp;
            for (i = 0, j = tmp.children.length; i < j; i++) {
                c = this._parse_model_from_flat_json(
                    m[tmp.children[i]],
                    tmp.id,
                    ps
                );
        ...
        _parse_model_from_json: function (d, p, ps) {
            ...
            tmp = {
                ...
                text: typeof d === "string" ? d : "",
                icon:
                    typeof d === "object" && d.icon !== undefined
                        ? d.icon
                        : true,
                parent: p,
                parents: ps,
        ...
        draw_children: function (node) {
            ...
            if (obj.children.length && obj.state.loaded) {
                ...
                for (i = 0, j = obj.children.length; i < j; i++) {
                    k.appendChild(
                        this.redraw_node(obj.children[i], true, true)
                    );
                }
                node.appendChild(k);
            }
        ...
        redraw_node: function (node, deep, is_callback, force_render) {
            ...
            if (!node) {
                ...
                if (!is_callback) {
                    ...
                    ind = $.inArray(
                        obj.id,
                        par === null
                            ? m[$.jstree.root].children
                            : m[obj.parent].children
                    );
                }
            } else {
                node = $(node);
            ...
            if ((obj.icon && obj.icon !== true) || obj.icon === false) {
                if (obj.icon === false) {
                    ...
                    node.childNodes[1].childNodes[0].style.backgroundPosition =
                        "center center";
                    node.childNodes[1].childNodes[0].style.backgroundSize =
                        "auto";
                    node.childNodes[1].childNodes[0].className +=
            ...
            if (
                ...
                for (i = 0, j = obj.children.length; i < j; i++) {
                    k.appendChild(
                        this.redraw_node(obj.children[i], deep, true)
                    );
                }
                node.appendChild(k);
            }
            ...
            if (!is_callback) {
                ...
                for (i = 0, j = par.childNodes.length; i < j; i++) {
                    if (
                        ...
                        par.childNodes[i].className.indexOf(
                            "jstree-children"
                        ) !== -1
                    ) {
        ...
        refresh: function (skip_loading, forget_state) {
            this._data.core.state =
                forget_state === true ? {} : this.get_state();
            if (forget_state && $.isFunction(forget_state)) {
                this._data.core.state = forget_state.call(
                    this,
                    this._data.core.state
                );
            }
        ...
        set_id: function (obj, id) {
            ...
            m[obj.parent].children[$.inArray(obj.id, m[obj.parent].children)] =
                id;
            for (i = 0, j = obj.parents.length; i < j; i++) {
            ...
            if (!options || !options.no_children) {
                for (i = 0, j = obj.children.length; i < j; i++) {
                    if (options && options.flat) {
                        ...
                        tmp.children.push(
                            this.get_json(obj.children[i], options)
                        );
                    }
                }
            }
            ...
            if ($.inArray(this._data.core.focused, tmp) !== -1) {
                ...
                if (par.id === $.jstree.root) {
                    if (this._model.data[$.jstree.root].children[0]) {
                        this.get_node(
                            this._model.data[$.jstree.root].children[0],
                            true
                        )
                            .children(".jstree-anchor")
                            .focus();
        ...
        check: function (chk, obj, par, pos, more) {
            ...
            var tmp = chk.match(/^move_node|copy_node|create_node$/i)
                    ? par
                    : obj,
        ...
        move_node: function (
            ...
            if (
                !this.check("move_node", obj, new_par, pos, {
                    ...
                    origin: origin,
                    is_multi:
                        old_ins && old_ins._id && old_ins._id !== this._id,
            ...
            if (obj.parent === new_par.id) {
                ...
                for (i = 0, j = new_par.parents.length; i < j; i++) {
                    this._model.data[new_par.parents[i]].children_d =
                        this._model.data[new_par.parents[i]].children_d.concat(
                            tmp
                        );
                }
                dpc = [];
                ...
                for (i = 0, j = obj.children_d.length; i < j; i++) {
                    this._model.data[obj.children_d[i]].parents =
                        this._model.data[obj.children_d[i]].parents.slice(
                            0,
                            p * -1
                        );
        ...
        edit: function (obj, default_text, callback) {
            ...
            tmp = obj;
            default_text =
                typeof default_text === "string" ? default_text : obj.text;
            this.set_text(obj, "");
        ...
        set_icon: function (obj, icon) {
            ...
            if (icon === false) {
                ...
                dom.addClass(icon + " jstree-themeicon-custom").attr(
                    "rel",
                    icon
                );
                if (old === false) {
    ...
    $.jstree.plugins.checkbox = function (options, parent) {
                ...
                this.element
                            ...
                            if (s.indexOf("up") !== -1) {
                                ...
                                for (k = 0, l = chd.length; k < l; k++) {
                                    ...
                                    while (p && p.id !== $.jstree.root) {
                                        c = 0;
                                        for (
                                            i = 0, j = p.children.length;
                                            i < j;
                                            i++
                                        ) {
                                            c +=
                                                m[p.children[i]].state[
                                                    t ? "selected" : "checked"
                                                ];
                                        }
                                        if (c === j) {
                    ...
                    .on(
                        ...
                        $.proxy(function (e, data) {
                            ...
                            if (s.indexOf("down") !== -1) {
                                ...
                                var selectedIds =
                                    this._cascade_new_checked_state(
                                        obj.id,
                                        true
                                    );
                            ...
                            if (s.indexOf("up") !== -1) {
                                while (par && par.id !== $.jstree.root) {
                                    c = 0;
                                    for (
                                        i = 0, j = par.children.length;
                                        i < j;
                                        i++
                                    ) {
                                        c +=
                                            m[par.children[i]].state[
                                                t ? "selected" : "checked"
                                            ];
                                    }
                                    if (c === j) {
                    ...
                    .on(
                        ...
                        $.proxy(function (e, data) {
                            ...
                            if (
                                s.indexOf("up") !== -1 &&
                                cur.indexOf(obj.id) === -1
                            ) {
                                for (
                                    i = 0, j = obj.parents.length;
                                    i < j;
                                    i++
                                ) {
            ...
            if (obj) {
                ...
                for (i = 0, j = obj.childNodes.length; i < j; i++) {
                    if (
                        ...
                        obj.childNodes[i].className.indexOf("jstree-anchor") !==
                            -1
                    ) {
            ...
            if (
                ...
                if (node.children) {
                    for (i = 0, j = node.children.length; i < j; i++) {
                        ...
                        selectedNodeIds =
                            selectedNodeIds.concat(selectedChildIds);
        ...
        this.uncheck_node = function (obj, e) {
            ...
            if (obj.state.checked) {
                ...
                if (dom.length) {
                    dom.children(".jstree-anchor").removeClass(
                        "jstree-checked"
                    );
                }
                /**
            ...
            show: function (reference, position, data) {
                ...
                switch (cond) {
                    ...
                    case !position && !!reference:
                        vakata_context.reference = reference;
                        o = reference.offset();
                        vakata_context.position_x =
                            o.left + reference.outerHeight();
                ...
                if (
                    !!reference &&
                    !data &&
                    $(reference).data("vakata_contextmenu")
                ) {
        ...
        this.bind = function () {
            ...
            this.element.on(
                ...
                $.proxy(function (e) {
                    if (
                        this.settings.dnd.large_drag_target &&
                        $(e.target).closest(".jstree-node")[0] !==
                            e.currentTarget
                    ) {
                        return true;
                    }
                ...
                if (this.settings.dnd.large_drag_target) {
                    ...
                    for (i = 0, j = obj.childNodes.length; i < j; i++) {
                        if (
                            obj.childNodes[i] &&
                            obj.childNodes[i].className &&
                            obj.childNodes[i].className.indexOf(
                                "jstree-anchor"
                            ) !== -1
                        ) {
                            tmp = obj.childNodes[i];
        ...
        $(document)
            ...
            .on("dnd_move.vakata.jstree", function (e, data) {
                ...
                if (
                    ...
                    data.event.target.id === "jstree-marker"
                ) {
                    return;
                }
                lastev = data.event;
                ...
                if (ins && ins._data && ins._data.dnd) {
                    ...
                    if (
                        ...
                        ok = true;
                        for (
                            t1 = 0, t2 = data.data.nodes.length;
                            t1 < t2;
                            t1++
                        ) {
                            ok =
                        ...
                        if (ok) {
                            ...
                            if (
                                ...
                                data.event.originalEvent.dataTransfer.dropEffect =
                                    is_copy ? "copy" : "move";
                            }
                            return;
                        }
                            ...
                            $.each(o, function (j, v) {
                                ...
                                for (
                                    ...
                                    if (
                                        ...
                                        data.data.origin === ins &&
                                        p ===
                                            ins.get_parent(data.data.nodes[t1])
                                    ) {
                                        pr = ins.get_node(p);
                                        if (
                                            ps >
    ...
    (function ($) {
        ...
        $.vakata.dnd = {
            ...
            _scroll: function (init_only) {
                ...
                if (!vakata_dnd.scroll_i) {
                    vakata_dnd.scroll_i = setInterval(
                        $.vakata.dnd._scroll,
                        100
                    );
                    return false;
            ...
            drag: function (e) {
                ...
                if (vakata_dnd.helper) {
                    ht = parseInt(
                        e.pageY + $.vakata.dnd.settings.helper_top,
                        10
                    );
                    hl = parseInt(
                        e.pageX + $.vakata.dnd.settings.helper_left,
                        10
                    );
                    if (dh && ht + 25 > dh) {
                        ht = dh - 50;
                ...
                for (i = 0, j = nodes.length; i < j; i++) {
                    if (
                        ...
                        (!m[nodes[i]].state.loaded &&
                            !m[nodes[i]].state.failed) ||
                        force_reload
                    ) {
                        toLoad.push(nodes[i]);
                        dom = this.get_node(nodes[i], true);
                        if (dom && dom.length) {
                            dom.addClass("jstree-loading").attr(
                                "aria-busy",
                                true
                            );
                        }
                        ...
                        return s.call(
                            ...
                            $.proxy(function (data) {
                                ...
                                for (i = 0, j = nodes.length; i < j; i++) {
                                    dom = this.get_node(nodes[i], true);
                                    if (dom && dom.length) {
                                        dom.removeClass("jstree-loading").attr(
                                            "aria-busy",
                                            false
                                        );
                                    }
    ...
    $.jstree.plugins.search = function (options, parent) {
        ...
        this.search = function (
            ...
            $.each(
                m[inside ? inside : $.jstree.root].children_d,
                function (ii, i) {
                    var v = m[i];
                    if (
                        v.text &&
                        ...
                        ((s.search_callback &&
                            s.search_callback.call(this, str, v)) ||
        ...
        $.vakata.search = function (pattern, txt, options) {
            ...
            search = function (text) {
                ...
                for (i = 0; i < patternLen; i++) {
                    ...
                    while (binMin < binMid) {
                        if (
                            match_bitapScore(i, MATCH_LOCATION + binMid) <=
                            scoreThreshold
                        ) {
                            binMin = binMid;
                        } else {
                    ...
                    finish =
                        Math.min(MATCH_LOCATION + binMid, textLen) + patternLen;
                    ...
                    if (
                        match_bitapScore(i + 1, MATCH_LOCATION) > scoreThreshold
                    ) {
                        break;
                    }
                    lastRd = rd;
    ...
    $.jstree.plugins.types = function (options, parent) {
            ...
            this.element.on(
                ...
                $.proxy(function (e, data) {
                    ...
                    for (i = 0, j = dpc.length; i < j; i++) {
                        ...
                        if (
                            t[c].a_attr !== undefined &&
                            typeof t[c].a_attr === "object"
                        ) {
                            for (k in t[c].a_attr) {
        ...
        this.get_json = function (obj, options, flat) {
            var i,
                ...
                m = this._model.data,
                opt = options
                    ? $.extend(true, {}, options, { no_id: false })
                    : {},
                    ...
                    if (
                        ...
                        if (
                            ...
                            this._data.core.last_error = {
                                ...
                                id: "types_01",
                                reason:
                                    "max_children prevents function: " + chk,
                                data: JSON.stringify({
                                    chk: chk,
                                    pos: pos,
                                    obj: obj && obj.id ? obj.id : false,
                        ...
                        if (
                            ...
                            this._data.core.last_error = {
                                ...
                                id: "types_02",
                                reason:
                                    "valid_children prevents function: " + chk,
                                data: JSON.stringify({
                                    chk: chk,
                                    pos: pos,
                                    obj: obj && obj.id ? obj.id : false,
                        ...
                        if (m && obj.children_d && obj.parents) {
                            ...
                            for (i = 0, j = obj.children_d.length; i < j; i++) {
                                d = Math.max(
                                    d,
                                    m[obj.children_d[i]].parents.length
                                );
                            }
                        ...
                        do {
                            if (
                                ...
                                this._data.core.last_error = {
                                    ...
                                    id: "types_03",
                                    reason:
                                        "max_depth prevents function: " + chk,
                                    data: JSON.stringify({
                                        chk: chk,
                                        pos: pos,
                                        obj: obj && obj.id ? obj.id : false,
        ...
        this.set_type = function (obj, type) {
            ...
            if (
                ...
                this.set_icon(
                    obj,
                    t[type].icon !== undefined ? t[type].icon : true
                );
            }
                ...
                for (k in t[old_type].li_attr) {
                    if (t[old_type].li_attr.hasOwnProperty(k)) {
                        if (k === "id") {
                            ...
                            m[obj.id].li_attr[k] === t[old_type].li_attr[k]
                        ) {
                ...
                for (k in t[old_type].a_attr) {
                    if (t[old_type].a_attr.hasOwnProperty(k)) {
                        if (k === "id") {
                            ...
                            m[obj.id].a_attr[k] === t[old_type].a_attr[k]
                        ) {
                            if (k === "href") {
                                m[obj.id].a_attr[k] = "#";
                                if (a) {
            ...
            if (
                t[type].a_attr !== undefined &&
                typeof t[type].a_attr === "object"
            ) {
    ...
    $.jstree.plugins.wholerow = function (options, parent) {
                ...
                .on(
                    ...
                    $.proxy(function (e, data) {
                        ...
                        for (i = 0, j = data.selected.length; i < j; i++) {
                            ...
                            if (tmp && tmp.length) {
                                tmp.children(".jstree-wholerow").addClass(
        ...
        this.redraw_node = function (obj, deep, callback, force_render) {
            ...
            if (obj) {
                ...
                if (
                    this._data.core.focused &&
                    this._data.core.focused === obj.id
                ) {
        ...
        proto.createdCallback = function () {
            ...
            for (i in $.jstree.plugins) {
                if ($.jstree.plugins.hasOwnProperty(i) && this.attributes[i]) {
                    ...
                    if (
                        this.getAttribute(i) &&
                        JSON.parse(this.getAttribute(i))
                    ) {
            ...
            for (i in $.jstree.defaults.core) {
                if (
                    $.jstree.defaults.core.hasOwnProperty(i) &&
                    this.attributes[i]
                ) {
                    c.core[i] =
                        JSON.parse(this.getAttribute(i)) ||
