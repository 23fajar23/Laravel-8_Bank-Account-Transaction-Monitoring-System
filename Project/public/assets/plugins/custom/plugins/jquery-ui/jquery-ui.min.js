                ...
                return (
                    this._helper &&
                        ...
                        (l =
                            ...
                            null),
                        h.animate ||
                            this.element.css(t.extend(a, { top: l, left: r })),
                    ...
                    t.extend(t.effects, {
                        save: function (t, e) {
                            for (var i = 0, s = e.length; s > i; i++)
                                null !== e[i] &&
                                    t.data(l + e[i], t[0].style[e[i]]);
                        },
                        restore: function (t, e) {
                            for (var i, s = 0, n = e.length; n > s; s++)
                                null !== e[s] &&
                                    ((i = t.data(l + e[s])), t.css(e[s], i));
                        },
    ...
    t.effects.define("blind", "hide", function (e, i) {
        ...
        t.effects.define("drop", "hide", function (e, i) {
            ...
            t.effects.createPlaceholder(n),
                (s =
                    e.distance ||
                    n["top" === l ? "outerHeight" : "outerWidth"](!0) / 2),
                (u[l] = h + s),
