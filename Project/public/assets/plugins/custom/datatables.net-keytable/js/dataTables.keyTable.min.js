    ...
    f.extend(n.prototype, {
            ...
            b.on("draw.keyTable", function (c) {
                if (!a.s.focusDraw) {
                    ...
                    if (d && d.node && f(d.node).closest("body") === h.body) {
                        ...
                        0 !== e.recordsDisplay &&
                            (m >= e.recordsDisplay &&
                                (m = e.recordsDisplay - 1),
                            a._focus(m, d.column, !0, c));
                    }
                }
            });
        ...
        _clipboard: function () {
            var a = this.s.dt,
                b = this;
            k.getSelection &&
                (f(h).on("copy.keyTable", function (a) {
                    var a = a.originalEvent,
                        d = k.getSelection().toString(),
                        e = b.s.lastFocus;
                    !d &&
                        e &&
                        (a.clipboardData.setData(
                            "text/plain",
                            e.cell.render(b.c.clipboardOrthogonal)
                        ),
                        a.preventDefault());
                }),
                f(h).on("paste.keyTable", function (c) {
                    var c = c.originalEvent,
                        ...
                        f = b.c.editor,
                        g;
                    if (d && (!e || "body" === e.nodeName.toLowerCase()))
                        c.preventDefault(),
                            k.clipboardData && k.clipboardData.getData
                                ? (g = k.clipboardData.getData("Text"))
                                : c.clipboardData &&
                                  c.clipboardData.getData &&
                                  (g = c.clipboardData.getData("text/plain")),
                            f
                                ? f
                                      .inline(d.cell.index())
                                      .set(f.displayed()[0], g)
                                      .submit()
                                : (d.cell.data(g), a.draw(!1));
                }));
        },
        _columns: function () {
            var a = this.s.dt,
        ...
        _editor: function (a, b, c) {
            var d = this,
                e = this.s.dt,
                j = this.c.editor,
                g = this.s.lastFocus.cell;
            if (
                !f("div.DTE", g.node()).length &&
                !(
                    null !== a &&
                    ((0 <= a && 9 >= a) ||
                        11 === a ||
                ...
                var i = function () {
                    j.one("open.keyTable", function () {
                        ...
                        j.one("close", function () {
                            ...
                            j.off(".keyTable");
                            f(e.table().container()).removeClass(
                                "dtk-focus-alt"
                            );
                        });
                    })
                ...
                if (-1 !== g.length && (a < g.start || a >= g.start + g.length))
                    ...
                    if (c === o || !0 === c)
                        this._scroll(f(k), f(h.body), i, "offset"),
                            (c = j.table().body().parentNode),
                            c !== j.table().header().parentNode &&
                                ((c = f(c.parentNode)),
        ...
        _shift: function (a, b, c) {
            ...
            if (g) {
                ...
                "right" === b
                    ...
                    ? h--
                    : "down" === b && h++;
                0 <= h && h < j && -1 !== f.inArray(e, i)
                    ? (a.preventDefault(), this._focus(h, e, !0, a))
                    : !c || !this.c.blurable
                    ? a.preventDefault()
                    : this._blur();
            }
