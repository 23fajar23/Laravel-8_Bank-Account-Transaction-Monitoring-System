...
var JQVMap = function (params) {
    ...
    jQuery(window).resize(function () {
        ...
        if (newWidth && newHeight) {
            ...
            jQuery(params.container).trigger(resizeEvent, [
                newWidth,
                newHeight,
            ]);
        ...
        function (e) {
            ...
            if (e.type === "mouseover") {
                ...
                if (params.showTooltip) {
                    ...
                    jQuery(params.container).trigger(labelShowEvent, [
                        map.label,
                        code,
                    ]);
    ...
    jQuery(params.container).delegate(
        ...
        function (regionClickEvent) {
            ...
            if (
                ...
                !mapClickEvent.isDefaultPrevented()
            ) {
...
JQVMap.prototype.positionPins = function () {
    ...
    jQuery.each(pins, function (index, pinObj) {
        ...
        var left =
                position.left + (bbox.width / 2) * scale - pinObj.width() / 2,
            top =
                position.top + (bbox.height / 2) * scale - pinObj.height() / 2;
...
JQVMap.prototype.zoomIn = function () {
    ...
    if (map.zoomCurStep < map.zoomMaxStep) {
        map.transX -=
            (map.width / map.scale - map.width / (map.scale * map.zoomStep)) /
            2;
        map.transY -=
            (map.height / map.scale - map.height / (map.scale * map.zoomStep)) /
            2;
...
JQVMap.prototype.zoomOut = function () {
    ...
    if (map.zoomCurStep > 1) {
        map.transX +=
            (map.width / (map.scale / map.zoomStep) - map.width / map.scale) /
            2;
        map.transY +=
            (map.height / (map.scale / map.zoomStep) - map.height / map.scale) /
            2;
        map.setScale(map.scale / map.zoomStep);
        map.zoomCurStep--;
