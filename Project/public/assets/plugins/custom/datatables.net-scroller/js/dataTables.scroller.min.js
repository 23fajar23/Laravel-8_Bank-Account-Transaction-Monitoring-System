...
(function (e) {
    ...
    e.extend(g.prototype, {
        ...
        fnPixelsToRow: function (a, b, c) {
            ...
            c = c
                ? (this._domain("physicalToVirtual", this.s.baseScrollTop) +
                      a) /
                  this.s.heights.row
        ...
        fnScrollToRow: function (a, b) {
            var c = this,
                ...
                j = a - ((this.s.displayBuffer - 1) / 2) * this.s.viewportRows;
            0 > j && (j = 0);
            if (
                (f > this.s.redrawBottom || f < this.s.redrawTop) &&
                this.s.dt._iDisplayStart !== j
            )
                (d = !0),
                    (f = this._domain(
                        "virtualToPhysical",
                        a * this.s.heights.row
                    )),
                    this.s.redrawTop < f &&
                        f < this.s.redrawBottom &&
        ...
        fnMeasure: function (a) {
            ...
            b.row &&
                ((b.viewport = e.contains(i, this.dom.scroller)
                    ? e(this.dom.scroller).height()
                    : this._parseHeight(e(this.dom.scroller).css("height"))),
                b.viewport ||
                    (b.viewport = this._parseHeight(
                        e(this.dom.scroller).css("max-height")
                    )),
        ...
        _fnConstruct: function () {
            ...
            if (this.s.dt.oFeatures.bPaginate) {
                ...
                d &&
                    d.scroller &&
                    ((this.s.topRowFloat = d.scroller.topRow),
                    (this.s.baseScrollTop = d.scroller.baseScrollTop),
                    (this.s.baseRowTop = d.scroller.baseRowTop));
        ...
        _fnScroll: function () {
            ...
            if (!this.s.skip && !this.s.ingnoreScroll)
                if (this.s.dt.bFiltered || this.s.dt.bSorted)
                    ...
                    } else this.s.topRowFloat = this.fnPixelsToRow(c, !1, !0);
        ...
        _parseHeight: function (a) {
            ...
            "px" === c
                ...
                ? (b = (a / 100) * e(h).height())
                : "rem" === c
                ? (b = a * parseFloat(e(":root").css("font-size")))
                : "em" === c &&
                  (b = a * parseFloat(e("body").css("font-size")));
            return b ? b : 0;
        },
        _fnDrawCallback: function () {
            ...
            this.s.skip = !0;
            if ((this.s.dt.bSorted || this.s.dt.bFiltered) && 0 === f)
            ...
            "undefined" != typeof this.s.dt.oLoadedState.iScroller
                ? (((c =
                      ...
                      (!c && 1 == this.s.dt.iDraw)) &&
                  setTimeout(function () {
                      e(a.dom.scroller).scrollTop(
                          a.s.dt.oLoadedState.iScroller
                      );
                      a.s.redrawTop =
                ...
                var a = this.s.dt,
                    ...
                    h =
                        ...
                        a.fnRecordsDisplay() == a.fnRecordsTotal()
                            ...
                            ? b.sInfoEmpty +
                              " " +
                              b.sInfoFiltered.replace("_MAX_", k) +
                              b.sInfoPostFix
                            : a.fnRecordsDisplay() == a.fnRecordsTotal()
                            ? b.sInfo
                                  .replace("_START_", h)
                                  .replace("_END_", i)
                                  .replace("_MAX_", k)
                                  .replace("_TOTAL_", l) + b.sInfoPostFix
                            : b.sInfo
                                  .replace("_START_", h)
                                  .replace("_END_", i)
                                  .replace("_MAX_", k)
                              ...
                              b.sInfoPostFix;
                (b = b.fnInfoCallback) &&
                    (h = b.call(a.oInstance, a, d, c, f, g, h));
                d = a.aanFeatures.i;
    ...
    e(i).on("preInit.dt.dtscroller", function (a, b) {
        if ("dt" === a.namespace) {
