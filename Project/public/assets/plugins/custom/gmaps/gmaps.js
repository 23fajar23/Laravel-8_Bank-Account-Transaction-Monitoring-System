...
(function (root, factory) {
    ...
    var GMaps = (function (global) {
        ...
        var GMaps = function (options) {
            ...
            var self = this,
                ...
                streetViewControl = valueOrDefault(
                ...
                map_controls_options = {
                    ...
                    zoomControlOptions: {
                        ...
                        position:
                            google.maps.ControlPosition[zoomControlPosition],
                    },
    ...
    GMaps.prototype.addMarker = function (options) {
        ...
        if (options.hasOwnProperty("gm_accessors_")) {
            ...
            if (
                (options.hasOwnProperty("lat") &&
                    options.hasOwnProperty("lng")) ||
                options.position
            ) {
    ...
    GMaps.prototype.addLayer = function (layerName, options) {
        ...
        switch (layerName) {
            case "weather":
                ...
                break;
            case "clouds":
                this.singleLayers.clouds = layer =
    ...
    GMaps.prototype.removeLayer = function (layer) {
        if (
            typeof layer == "string" &&
            this.singleLayers[layer] !== undefined
        ) {
    ...
    GMaps.prototype.renderRoute = function (options, renderOptions) {
        var self = this,
            panel =
                typeof renderOptions.panel === "string"
                    ? document.getElementById(
                          renderOptions.panel.replace("#", "")
                      )
                    : renderOptions.panel,
            display;
    ...
    GMaps.prototype.toImage = function (options) {
        ...
        if (this.polylines.length > 0) {
            ...
            static_map_options["polyline"]["strokeColor"] =
                polyline.strokeColor;
            static_map_options["polyline"]["strokeOpacity"] =
                polyline.strokeOpacity;
            static_map_options["polyline"]["strokeWeight"] =
    ...
    GMaps.staticMapURL = function (options) {
        ...
        if (options.center) {
            ...
            parameters.push(
                ["center=", options.lat, ",", options.lng].join("")
            );
            delete options.lat;
            delete options.lng;
        ...
        if (styles) {
            for (var i = 0; i < styles.length; i++) {
                ...
                if (styles[i].featureType) {
                    styleRule.push(
                        "feature:" + styles[i].featureType.toLowerCase()
                    );
                }

                if (styles[i].elementType) {
                    styleRule.push(
                        "element:" + styles[i].elementType.toLowerCase()
                    );
                }
    ...
    GMaps.prototype.addMapType = function (mapTypeId, options) {
        if (
            ...
            options.tileSize =
                options.tileSize || new google.maps.Size(256, 256);
