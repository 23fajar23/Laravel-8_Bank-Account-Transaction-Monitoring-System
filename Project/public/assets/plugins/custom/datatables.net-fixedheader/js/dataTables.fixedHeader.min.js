    ...
    d.extend(h.prototype, {
        ...
        _constructor: function () {
            ...
            b.on("destroy.dtfc", function () {
                ...
                a.c.footer &&
                    a.dom.tfoot.length &&
                    a._modeChange("in-place", "footer", true);
                b.off(".dtfc");
        ...
        _horizontal: function (a, b) {
            ...
            e.floating &&
                d[a] !== b &&
                (e.floating.css("left", c.left - b), (d[a] = b));
        },
        _modeChange: function (a, b, e) {
            ...
            if ("in-place" === a) {
                if (
                    (c.placeholder &&
                        (c.placeholder.remove(), (c.placeholder = null)),
                    this._unsize(b),
                    "header" === b ? c.host.prepend(g) : c.host.append(g),
                    c.floating)
                )
        ...
        _positions: function () {
            ...
            f.length
                ? ((b.tfootTop = f.offset().top),
                  (b.tfootBottom = b.tfootTop + f.outerHeight()),
        ...
        _scroll: function (a) {
            ...
            if (
                ...
                (this.c.header &&
                    ((f =
                        !c.visible || b <= c.theadTop - this.c.headerOffset
                            ? "in-place"
                            : b <=
                              c.tfootTop - c.theadHeight - this.c.headerOffset
                            ? "in"
                            : "below"),
                ...
                (b =
                    !c.visible ||
                    b + c.windowHeight >= c.tfootBottom + this.c.footerOffset
                        ? "in-place"
                        : c.windowHeight + b >
                          c.tbodyTop + c.tfootHeight + this.c.footerOffset
                        ? "in"
                        : "above"),
                    (a || b !== this.s.footerMode) &&
                        this._modeChange(b, "footer", a),
