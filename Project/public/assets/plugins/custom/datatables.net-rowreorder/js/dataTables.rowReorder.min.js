            ...
            var c = this.s.dt,
                ...
                a = d.map(e, function (a, b) {
                    return e.length < b - 1
                        ...
                        : (a +
                              a +
                              d(c.row(":last-child").node()).outerHeight()) /
                              2;
                });
            this.s.middles = a;
        ...
        _mouseMove: function (c) {
            ...
            if (null === this.s.lastInsert || this.s.lastInsert !== e)
                0 === e
                    ...
                    : ((b = d.unique(
                          i.rows({ page: "current" }).nodes().toArray()
                      )),
                      e > this.s.lastInsert
                ...
                ? ((this.c.enable = !1),
                  this.c.editor
                      .edit(
                          l,
                          !1,
                          d.extend({ submit: "changed" }, this.c.formOptions)
                      )
                      .multiSet(i, k)
        ...
        _shiftScroll: function (c) {
            ...
            !this.s.scrollInterval &&
                ...
                (this.s.scrollInterval = setInterval(function () {
                    if (a.windowVert)
                        g.body.scrollTop = g.body.scrollTop + a.windowVert;
                    if (a.dtVert) {
