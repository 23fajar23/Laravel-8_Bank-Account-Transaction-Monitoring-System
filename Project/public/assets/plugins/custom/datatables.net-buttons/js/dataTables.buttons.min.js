...
(function (d) {
    "function" === typeof define && define.amd
        ...
        ? (module.exports = function (p, o) {
              p || (p = window);
              if (!o || !o.fn.dataTable) o = require("datatables.net")(p, o).$;
              return d(o, p, p.document);
          })
    ...
    d.extend(m.prototype, {
        ...
        remove: function (a) {
            var b = this._nodeToButton(a),
                ...
                e = this.s.dt;
            if (b.buttons.length)
                for (var i = b.buttons.length - 1; 0 <= i; i--)
        ...
        _constructor: function () {
            ...
            for (var i = 0, g = e.length; i < g; i++) this.add(e[i]);
                ...
                if (r)
                    if (d.isArray(r)) this._expandButton(a, r, c, e);
                        ...
                        if (h) {
                            ...
                            r.init &&
                                r.init.call(i.button(h.node), i, d(h.node), r);
                            g++;
                        }
                    }
            }
        ...
        _buildButton: function (a, b) {
            ...
            e.tag
                ? ((i = d("<" + e.tag + "/>")
                  ...
                  "a" === e.tag.toLowerCase() && i.attr("href", "#"),
                  h.append(i))
                : h.html(f(a.text));
            ...
            var c = [],
                ...
                i = function (a, b) {
                    ...
                    if (d.isArray(a) || a instanceof d) {
                        h = 0;
                        for (g = a.length; h < g; h++) i(a[h], b);
                    } else if (null === a || a === n || "*" === a) {
                        h = 0;
                        for (g = f.length; h < g; h++)
                            c.push({ inst: b, node: f[h].node });
    ...
    d.extend(l, {
            ...
            action: function (a, b, c, e) {
                var i = function () {
                        b.buttons(
                            ...
                            .nodes()
                            .each(function () {
                                var a = d(this).siblings(
                                    ".dt-button-collection"
                                );
                                a.length &&
                                    a.stop().fadeOut(e.fade, function () {
                                        a.detach();
                                    });
                ...
                if (!a) {
                    ...
                    g.length &&
                        ((k = d(".dt-button-collection").position()),
                        (j = g),
                    ...
                    k && "absolute" === g
                        ? e._collection.css({ top: k.top, left: k.left })
                        : "absolute" === g
                        ? (e._collection.css({
                              top: a.top + c.outerHeight(),
                              left: a.left,
                          }),
                          (k = f.offset().top + f.height()),
                          (k =
                              a.top +
                              c.outerHeight() +
                          ...
                          e._collection.hasClass(e.rightAlignClassName) &&
                              e._collection.css(
                                  "left",
                                  a.left +
                                      c.outerWidth() -
                                      e._collection.outerWidth()
                              ),
                          (k = a.left + e._collection.outerWidth()),
                          (f = f.offset().left + f.width()),
                          k > f && e._collection.css("left", a.left - (k - f)),
                        ...
                        : ((c = e._collection.height() / 2),
                          c > d(p).height() / 2 && (c = d(p).height() / 2),
                          e._collection.css("marginTop", -1 * c));
                    e.background &&
                        m.background(!0, e.backgroundClassName, e.fade, j);
                    setTimeout(function () {
        ...
        excel: function (a, b) {
            if (l.excelHtml5 && l.excelHtml5.available(a, b))
                return "excelHtml5";
            if (l.excelFlash && l.excelFlash.available(a, b))
                return "excelFlash";
        },
        pdf: function (a, b) {
    ...
    j.Api.register("buttons()", function (a, b) {
        ...
        var c = this.iterator(
            ...
            function (c) {
                if (c._buttons)
                    return m.buttonSelector(
                        m.instanceSelector(a, c._buttons),
                        b
                    );
            },
            !0
