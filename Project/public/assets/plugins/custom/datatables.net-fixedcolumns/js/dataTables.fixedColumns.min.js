    ...
    d.extend(m.prototype, {
        ...
        _fnGridSetup: function () {
            ...
            if (
                ...
                0 < this.s.iLeftColumns &&
                    (this.dom.grid.left.foot = e.childNodes[2]),
                0 < this.s.iRightColumns)
            )
        ...
        _fnGridLayout: function () {
            ...
            0 < this.s.iLeftColumns &&
                ...
                b.left.foot &&
                    (b.left.foot.style.top = (f.x ? f.bar : 0) + "px"),
                j(b.left.liner, g),
            ...
            0 < this.s.iRightColumns &&
                ...
                (e.style.height = "1px"),
                this.s.rtl
                    ? ((e.style.left = f.y ? f.bar + "px" : 0),
                      (e.style.right = ""))
                    : ((e.style.left = ""),
                      (e.style.right = f.y ? f.bar + "px" : 0)),
                (b.right.body.style.height = c + "px"),
                b.right.foot &&
                    (b.right.foot.style.top = (f.x ? f.bar : 0) + "px"),
                j(b.right.liner, h),
                    ...
                    if (-1 !== d.inArray(l, b)) {
                        ...
                        -1 === q
                            ? ((q = d(a[h][l].cell).clone(c, !1)[0]),
                              f.push(q),
                              g.push(a[h][l].cell),
                              j.push({ cell: q, unique: a[h][l].unique }))
                            : j.push({ cell: f[q], unique: a[h][l].unique });
                    }
                e.push(j);
            }
            return e;
        ...
        _fnClone: function (a, b, c, e) {
                ...
                for (h = n.length; g < h; g++) {
                    ...
                    for (j = n[g].length; i < j; i++)
                        (m[g][i].cell.className = n[g][i].cell.className),
                            d("span.DataTables_sort_icon", m[g][i].cell).each(
                                function () {
                                    this.className = d(
            ...
            if (0 < k.aiDisplay.length) {
                ...
                for (q = 0; q < c.length; q++)
                    (l = c[q]),
                        (o = d(k.aoColumns[l].nTh).clone(!0)[0]),
                        (o.innerHTML = ""),
                        (j = o.style),
                        (j.paddingTop = "0"),
                        (j.paddingBottom = "0"),
                        (j.borderTopWidth = "0"),
                        (j.borderBottomWidth = "0"),
                        (j.height = 0),
                        (j.width = f.s.aiInnerWidths[l] + "px"),
                        h.appendChild(o);
                d(">tbody>tr", f.dom.body).each(function (a) {
                    var a =
                            f.s.dt.oFeatures.bServerSide === false
                                ...
                                : a,
                        b =
                            f.s.dt.aoData[a].anCells ||
                            d(this).children("td, th"),
            ...
            k.oScroller !== t &&
                ((h = k.oScroller.dom.force),
                b.forcer
                    ? (b.forcer.style.height = h.style.height)
                    : ((b.forcer = h.cloneNode(!0)),
                      b.liner.appendChild(b.forcer)));
            b.liner.appendChild(a.body);
            this._fnEqualiseHeights("tbody", f.dom.body, a.body);
            if (null !== k.nTFoot) {
                if (e) {
                    null !== a.footer &&
                        a.footer.parentNode.removeChild(a.footer);
            ...
            null !== f.s.dt.nTFoot &&
                ((b = k.oApi._fnGetUniqueThs(k, d(">tfoot", a.footer)[0])),
                d(b).each(function (a) {
                    l = c[a];
                    this.style.width = f.s.aiInnerWidths[l] + "px";
                }));
