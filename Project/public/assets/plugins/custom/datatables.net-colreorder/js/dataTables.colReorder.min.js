...
(function (e) {
    ...
    function s(a, b, c) {
        for (var f = [], e = 0, d = a.childNodes.length; e < d; e++)
            1 == a.childNodes[e].nodeType && f.push(a.childNodes[e]);
        b = f[b];
    ...
    e.extend(i.prototype, {
        ...
        fnOrder: function (a, b) {
            ...
            if (a === r) {
                ...
                for (g = d.length; f < g; f++)
                    c.push(d[f]._ColReorder_iOrigCol);
                return c;
            }
            if (b) {
                d = this.fnOrder();
        ...
        _fnStateSave: function (a) {
            ...
            if (a.aaSorting) {
                ...
                for (c = g.length; b < c; b++)
                    (f = g[b]._ColReorder_iOrigCol),
                        (a.aoSearchCols[f] = d[b]),
        ...
        _fnMouseDown: function (a, b) {
            ...
            g !== r &&
                ...
                (this.s.mouse.offsetX =
                    this._fnCursorPosition(a, "pageX") - f.left),
                (this.s.mouse.offsetY =
                    this._fnCursorPosition(a, "pageY") - f.top),
        ...
        _fnMouseMove: function (a) {
            ...
            for (
                var b = !1,
                    ...
                    f = 1,
                    e = this.s.aoTargets.length;
                f < e;
                f++
            )
                if (
                    this._fnCursorPosition(a, "pageX") <
                    this.s.aoTargets[f - 1].x +
                        (this.s.aoTargets[f].x - this.s.aoTargets[f - 1].x) / 2
                ) {
        ...
        _fnRegions: function () {
            ...
            for (
                var b = 0, c = this.s.aoTargets[0].x, f = 0, g = a.length;
                f < g;
                f++
            )
                f != this.s.mouse.fromIndex && b++,
                    a[f].bVisible &&
                        "none" !== a[f].nTh.style.display &&
                        ((c += e(a[f].nTh).outerWidth()),
        ...
        _fnCreateDragNode: function () {
            var a = "" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY,
                ...
                g = f.parentNode,
                d = e(b).clone();
            this.dom.drag = e(g.cloneNode(!1))
                .addClass("DTCR_clonedTable")
                .append(
                    e(f.cloneNode(!1)).append(e(c.cloneNode(!1)).append(d[0]))
                )
                .css({
                    position: "absolute",
                    top: 0,
    ...
    e(l).on("preInit.dt.colReorder", function (a, b) {
        if ("dt" === a.namespace) {
