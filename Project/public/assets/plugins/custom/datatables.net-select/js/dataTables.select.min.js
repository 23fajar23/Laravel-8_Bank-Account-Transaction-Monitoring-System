...
(function (e) {
    "function" === typeof define && define.amd
        ? define(["jquery", "datatables.net"], function (i) {
              return e(i, window, document);
          })
        : "object" === typeof exports
        ? (module.exports = function (i, l) {
              i || (i = window);
        ...
        c.on("mousedown.dtSelect", d, function (b) {
            ...
            .on("click.dtSelect", d, function (b) {
                ...
                if (f) {
                    ...
                    if (
                        (!d.anchorNode ||
                            e(d.anchorNode).closest("table")[0] ===
                                a.table().node()) &&
                        d !== f
                    )
                        return;
                ...
                var d = a.settings()[0],
                    g = e
                        ...
                        .replace(/ +/g, ".");
                if (
                    e(b.target).closest("div." + g)[0] ==
                        a.table().container() &&
                    ((g = a.cell(e(b.target).closest("td, th"))), g.any())
                ) {
                    ...
                    h.isDefaultPrevented() ||
                        ((h = g.index()),
                        "row" === c
                            ? ((c = h.row), r(b, a, d, "row", c))
                            : "column" === c
                            ? ((c = g.index().column), r(b, a, d, "column", c))
                            : "cell" === c &&
                              ((c = g.index()), r(b, a, d, "cell", c)),
                        (d._select_lastCell = h));
                }
            });
    ...
    function r(a, c, b, d, f) {
        ...
        "os" === e
            ? a.ctrlKey || a.metaKey
                ...
                : a.shiftKey
                ? "cell" === d
                    ? u(c, f, b._select_lastCell || null)
                    : z(
                          c,
                          d,
                          f,
                          b._select_lastCell ? b._select_lastCell[d] : null
                      )
                : ((a = c[d + "s"]({ selected: !0 })),
    ...
    g.select.init = function (a) {
        ...
        if (!0 === b) (f = "os"), (j = !0);
            ...
            b.info !== h && (v = b.info),
            b.items !== h && (d = b.items),
            (f = b.style !== h ? b.style : "os"),
            (j = !0),
            b.selector !== h && (w = b.selector),
            b.className !== h)
        )
            i = b.className;
        a.select.selector(w);
        ...
        !j &&
            e(a.table().node()).hasClass("selectable") &&
            a.select.style("os");
    };
    e.each(
        [
    ...
    n("cells().deselect()", "cell().deselect()", function () {
        ...
        this.iterator("cell", function (a, b, d) {
            ...
            b.anCells &&
                ...
                e(b.anCells[d]).removeClass(a._select.className);
        });
        this.iterator("table", function (c, b) {
    ...
    e.extend(g.ext.buttons, {
        selected: {
            ...
            init: function (a, c, b) {
                ...
                a.on(s(b), function () {
                    d.enable(
                        (-1 !== e.inArray("rows", b.limitTo) &&
                            a.rows({ selected: !0 }).any()) ||
                            (-1 !== e.inArray("columns", b.limitTo) &&
                                a.columns({ selected: !0 }).any()) ||
                            (-1 !== e.inArray("cells", b.limitTo) &&
