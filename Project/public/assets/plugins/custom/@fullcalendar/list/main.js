...
(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : ((global = global || self),
          factory((global.FullCalendarList = {}), global.FullCalendar));
    ...
    */
    var ListView = /** @class */ (function (_super) {
        ...
        function ListView(context, viewSpec, dateProfileGenerator, parentEl) {
            ...
            _this.renderContent = core.memoizeRendering(
                eventRenderer.renderSegs.bind(eventRenderer),
                eventRenderer.unrender.bind(eventRenderer)
            );
            _this.el.classList.add("fc-list-view");
            var listViewClassNames = (
                _this.theme.getClass("listView") || ""
            ).split(" "); // wish we didn't have to do this
            for (
        ...
        ListView.prototype.eventRangesToSegs = function (
            ...
            for (
                ...
                segs.push.apply(
                    segs,
                    this.eventRangeToSegs(eventRange, dayRanges)
                );
            }
            return segs;
        };
