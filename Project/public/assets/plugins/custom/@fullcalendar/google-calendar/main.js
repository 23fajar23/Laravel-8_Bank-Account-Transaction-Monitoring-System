...
(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : ((global = global || self),
          factory(
              (global.FullCalendarGoogleCalendar = {}),
              global.FullCalendar
          ));
    ...
    ***************************************************************************** */
    ...
    var eventSourceDef = {
        parseMeta: function (raw) {
            ...
            if (typeof raw === "object") {
                ...
                if (!standardProps.googleCalendarId && standardProps.url) {
                    standardProps.googleCalendarId = parseGoogleCalendarId(
                        standardProps.url
                    );
                }
        ...
        fetch: function (arg, onSuccess, onFailure) {
            ...
            var apiKey =
                meta.googleCalendarApiKey ||
                calendar.opt("googleCalendarApiKey");
            if (!apiKey) {
                onFailure({
                    message:
    ...
    function buildUrl(meta) {
        return (
            API_BASE +
            "/" +
            encodeURIComponent(meta.googleCalendarId) +
            "/events"
        );
    }
