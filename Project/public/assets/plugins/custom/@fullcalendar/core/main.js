...
(function (global, factory) {
    ...
    function computeEdges(el, getPadding) {
        ...
        var scrollbarLeftRight = sanitizeScrollbarWidth(
            el.offsetWidth - el.clientWidth - borderLeft - borderRight
        );
        var scrollbarBottom = sanitizeScrollbarWidth(
            el.offsetHeight - el.clientHeight - borderTop - borderBottom
        );
        var res = {
    ...
    function computeAlignedDayRange(timedRange) {
        var dayCnt =
            Math.floor(diffDays(timedRange.start, timedRange.end)) || 1;
    ...
    function diffDates(date0, date1, dateEnv, largeUnit) {
        if (largeUnit === "year") {
            ...
            return createDuration(
                dateEnv.diffWholeMonths(date0, date1),
                "month"
            );
        } else {
    ...
    ***************************************************************************** */
    ...
    function parseRecurring(
        ...
        for (var i = 0; i < recurringTypes.length; i++) {
            var localLeftovers = {};
            var parsed = recurringTypes[i].parse(
                eventInput,
                localLeftovers,
                dateEnv
            );
    ...
    */
    ...
    function transformEachRawEvent(rawEvents, func) {
        ...
        if (!func) {
            ...
            refinedEvents = [];
            for (
                var _i = 0, rawEvents_2 = rawEvents;
                _i < rawEvents_2.length;
                _i++
            ) {
    ...
    function intersectRanges(range0, range1) {
        ...
        if (range1.start !== null) {
            if (start === null) {
                ...
                start = new Date(
                    Math.max(start.valueOf(), range1.start.valueOf())
                );
            }
        }
        if (range1.end != null) {
    ...
    */
    function memoizeOutput(workerFunc, equalityFunc) {
        ...
        return function () {
            ...
            if (
                cachedRes === null ||
                !(cachedRes === newRes || equalityFunc(cachedRes, newRes))
            ) {
                cachedRes = newRes;
            }
            return cachedRes;
    ...
    var NativeFormatter = /** @class */ (function () {
        ...
        NativeFormatter.prototype.formatRange = function (start, end, context) {
            ...
            var insertion = findCommonInsertion(
                full0,
                partial0,
                full1,
                partial1
    ...
    function buildNativeFormattingFunc(
        ...
        if (extendedSettings.omitZeroMinute) {
            ...
            zeroFormat = new Intl.DateTimeFormat(
                context.locale.codes,
                zeroProps
            );
        }
    ...
    var CmdFormatter = /** @class */ (function () {
        ...
        CmdFormatter.prototype.format = function (date, context) {
            return context.cmdFormatter(
                this.cmdStr,
                createVerboseFormattingArg(date, null, context, this.separator)
            );
        };
        CmdFormatter.prototype.formatRange = function (start, end, context) {
            return context.cmdFormatter(
                this.cmdStr,
                createVerboseFormattingArg(start, end, context, this.separator)
            );
        };
        return CmdFormatter;
    })();
    ...
    */
                    ...
                    (def.rendering === "background" ? bgRanges : fgRanges).push(
                        {
                            ...
                            isStart:
                                normalRange.start &&
                                normalRange.start.valueOf() ===
                                    slicedRange.start.valueOf(),
                            isEnd:
                                normalRange.end &&
                                normalRange.end.valueOf() ===
    ...
    function hasBgRendering(def) {
        return (
            def.rendering === "background" ||
            def.rendering === "inverse-background"
        );
    }
    ...
    function applyMutationToEventStore(
        ...
        for (var defId in eventStore.defs) {
            ...
            dest.defs[defId] = applyMutationToEventDef(
                ...
                eventConfigs[defId],
                mutation,
                calendar.pluginSystem.hooks.eventDefMutationAppliers,
                calendar
            );
        }
        for (var instanceId in eventStore.instances) {
    ...
    function applyMutationToEventInstance(
        ...
        if (copy.range.end < copy.range.start) {
            copy.range.end = calendar.getDefaultEventEnd(
                eventDef.allDay,
                copy.range.start
            );
        }
    ...
    function applyMutationToRelated(
        ...
        relevant = applyMutationToEventStore(
            relevant,
            eventConfigBase,
            mutation,
            calendar
    ...
    function isNewPropsValid(newProps, calendar) {
        ...
        return (
            calendar.pluginSystem.hooks.isPropsValid || isPropsValid
        )(props, calendar);
    }
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            for (var otherInstanceId in otherInstances) {
                ...
                if (rangesIntersect(subjectRange, otherInstance.range)) {
                    var otherOverlap =
                        otherConfigs[otherInstance.defId].overlap;
            ...
            for (var _i = 0, _a = subjectConfig.allows; _i < _a.length; _i++) {
                ...
                var origInstance =
                    calendarEventStore.instances[subjectInstanceId];
                var eventApi = void 0;
                if (origDef) {
    ...
    function isDateSelectionPropsValid(
        ...
        for (var _i = 0, _a = selectionConfig.allows; _i < _a.length; _i++) {
            ...
            if (
                !selectionAllow(calendar.buildDateSpanApi(fullDateSpan), null)
            ) {
                return false;
            }
        }
    ...
    function processUnscopedUiProps(rawProps, calendar, leftovers) {
        var props = refineProps(
            rawProps,
            UNSCOPED_EVENT_UI_PROPS,
            {},
            leftovers
        );
        ...
        return {
            startEditable:
                props.startEditable != null
                    ? props.startEditable
                    : props.editable,
            durationEditable:
                props.durationEditable != null
    ...
    */
    ...
    function memoizeRendering(renderFunc, unrenderFunc, dependencies) {
        ...
        function unrender() {
            if (prevArgs) {
                for (
                    var _i = 0, dependents_1 = dependents;
                    _i < dependents_1.length;
                    _i++
                ) {
    ...
    var Splitter = /** @class */ (function () {
        ...
        Splitter.prototype.splitProps = function (props) {
            ...
            var individualUi = this.splitIndividualUi(
                props.eventUiBases,
                defKeys
            ...
            this.eventUiBuilders = mapHash(keyInfos, function (info, key) {
                return (
                    _this.eventUiBuilders[key] || memoize(buildEventUiForKey)
                );
            });
    ...
    function getAllDayHtml(component) {
        return (
            component.opt("allDayHtml") ||
            htmlEscape(component.opt("allDayText"))
        );
    }
    ...
    function getDayClasses(date, dateProfile, context, noThemeHighlight) {
        ...
        if (!rangeContainsMarker(dateProfile.activeRange, date)) {
            ...
            if (
                view.opt("monthMode") &&
                dateEnv.getMonth(date) !==
                    dateEnv.getMonth(dateProfile.currentRange.start)
            ) {
    ...
    var EmitterMixin = /** @class */ (function (_super) {
        ...
        EmitterMixin.prototype.hasHandlers = function (type) {
            return (
                (this._handlers &&
                    this._handlers[type] &&
                    this._handlers[type].length) ||
                (this._oneHandlers &&
                    this._oneHandlers[type] &&
                    this._oneHandlers[type].length)
            );
        };
        return EmitterMixin;
    })(Mixin);
    ...
    */
        ...
        ScrollComponent.prototype.lockOverflow = function (scrollbarWidths) {
            ...
            if (overflowY === "auto") {
                overflowY =
                    ...
                    scrollbarWidths.right || // horizontal scrollbars?
    ...
    var Component = /** @class */ (function () {
        ...
        Component.addEqualityFuncs = function (newFuncs) {
            this.prototype.equalityFuncs = __assign(
                {},
        ...
        for (var key in newProps) {
            if (
                ...
                (oldProps[key] === newProps[key] ||
                    (equalityFuncs[key] &&
                        equalityFuncs[key](oldProps[key], newProps[key])))
            ) {
    ...
    */
    var DateComponent = /** @class */ (function (_super) {
        ...
        */
        ...
        DateComponent.prototype.publiclyTriggerAfterSizing = function (
            name,
            args
        ) {
            var calendar = this.calendar;
        ...
        DateComponent.prototype.triggerRenderedSegs = function (
            segs,
            isMirrors
        ) {
            var calendar = this.calendar;
        ...
        DateComponent.prototype.triggerWillRemoveSegs = function (
            segs,
            isMirrors
        ) {
            var calendar = this.calendar;
        ...
        DateComponent.prototype.isValidDateDownEl = function (el) {
            ...
            return (
                (!segEl || segEl.classList.contains("fc-mirror")) &&
    ...
    function combineHooks(hooks0, hooks1) {
        return {
            ...
            eventDefParsers: hooks0.eventDefParsers.concat(
                hooks1.eventDefParsers
            ),
            isDraggableTransformers: hooks0.isDraggableTransformers.concat(
                hooks1.isDraggableTransformers
            ),
            eventDragMutationMassagers:
                hooks0.eventDragMutationMassagers.concat(
            ...
            viewContainerModifiers: hooks0.viewContainerModifiers.concat(
                hooks1.viewContainerModifiers
            ),
    ...
    function refinePluginDefs(pluginInputs) {
        var plugins = [];
        for (
            var _i = 0, pluginInputs_1 = pluginInputs;
            _i < pluginInputs_1.length;
            _i++
        ) {
            var pluginInput = pluginInputs_1[_i];
            if (typeof pluginInput === "string") {
                var globalName =
                    "FullCalendar" + capitaliseFirstLetter(pluginInput);
    ...
    var OptionsManager = /** @class */ (function () {
        ...
        OptionsManager.prototype.mutate = function (
            updates,
            removals,
            isDynamic
        ) {
            var overrideHash = isDynamic
                ? this.dynamicOverrides
                : this.overrides;
            __assign(overrideHash, updates);
            for (
                var _i = 0, removals_1 = removals;
                _i < removals_1.length;
                _i++
            ) {
        ...
        OptionsManager.prototype.compute = function () {
            ...
            var localeDefaults = buildLocale(
                locale || available.defaultCode,
                available.map
            ).options;
    ...
    var DateEnv = /** @class */ (function () {
        function DateEnv(settings) {
            ...
            if (settings.namedTimeZoneImpl && isNamedTimeZone) {
                this.namedTimeZoneImpl = new settings.namedTimeZoneImpl(
                    timeZone
                );
            }
            ...
            this.weekLabel =
                settings.weekLabel != null
                    ? settings.weekLabel
                    : settings.locale.options.weekLabel;
        ...
        DateEnv.prototype.timestampToMarker = function (ms) {
            if (this.timeZone === "local") {
                ...
                return arrayToUtcDate(
                    this.namedTimeZoneImpl.timestampToArray(ms)
                );
            }
        };
    ...
    function fetchSource(eventSource, fetchRange, calendar) {
        var sourceDef =
            calendar.pluginSystem.hooks.eventSourceDefs[
                eventSource.sourceDefId
            ];
    ...
    function receiveResponse(sourceHash, sourceId, fetchId, fetchRange) {
        ...
        if (
            ...
            return __assign(
                ...
                sourceHash,
                ((_a = {}),
                (_a[sourceId] = __assign({}, eventSource, {
                    isFetching: false,
                    fetchRange: fetchRange,
                })),
                _a)
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        DateProfileGenerator.prototype.buildPrev = function (
            ...
            var prevDate = dateEnv.subtract(
                dateEnv.startOf(
                    currentDate,
                    currentDateProfile.currentRangeUnit
        ...
        DateProfileGenerator.prototype.buildRangeFromDuration = function (
            ...
            if (!alignment) {
                ...
                if (dateIncrementInput) {
                    ...
                    if (
                        asRoughMs(dateIncrementDuration) < asRoughMs(duration)
                    ) {
    ...
    function reduce(state, action, calendar) {
        ...
        var dateProfile = reduceDateProfile(
            state.dateProfile,
            action,
            state.currentDate,
            viewType,
        ...
        var nextState = __assign({}, state, {
            ...
            dateSelection: reduceDateSelection(
                state.dateSelection,
                action,
                calendar
            ),
            eventSelection: reduceSelectedEvent(state.eventSelection, action),
            eventDrag: reduceEventDrag(
                state.eventDrag,
                action,
                eventSources,
                calendar
            ),
            eventResize: reduceEventResize(
                state.eventResize,
                action,
                eventSources,
                calendar
        ...
        for (
            var _i = 0, _a = calendar.pluginSystem.hooks.reducers;
            _i < _a.length;
            _i++
        ) {
    ...
    function reduceDateProfile(
        ...
        switch (action.type) {
            case "PREV":
                newDateProfile = calendar.dateProfileGenerators[
                    viewType
        ...
        if (
            ...
            !(
                currentDateProfile &&
                isDateProfilesEqual(currentDateProfile, newDateProfile)
            )
        ) {
    ...
    function reduceCurrentDate(currentDate, action, dateProfile) {
        switch (action.type) {
            ...
            case "SET_VIEW_TYPE":
                ...
                if (
                    dateProfile.activeRange &&
                    !rangeContainsMarker(dateProfile.activeRange, newDate)
                ) {
                    return dateProfile.currentRange.start;
                } else {
                    return newDate;
    ...
    */
    ...
    function buildViewSpec(viewDef, overrideConfigs, optionsManager) {
        ...
        if (durationInput) {
            ...
            if (duration) {
                // valid?
                var denom = greatestDurationDenominator(
                    duration,
                ...
                if (denom.value === 1) {
                    ...
                    singleUnitOverrides = overrideConfigs[durationUnit]
                        ? overrideConfigs[durationUnit].options
                        : {};
                }
            }
        }
    ...
    var Toolbar = /** @class */ (function (_super) {
        ...
        function Toolbar(context, extraClassName) {
            ...
            _this._renderLayout = memoizeRendering(
                _this.renderLayout,
                _this.unrenderLayout
            );
            _this._updateTitle = memoizeRendering(_this.updateTitle, null, [
                _this._renderLayout,
            ]);
            _this._updateActiveButton = memoizeRendering(
                _this.updateActiveButton,
                null,
                [_this._renderLayout]
            );
            _this._updateToday = memoizeRendering(_this.updateToday, null, [
                _this._renderLayout,
            ]);
            _this._updatePrev = memoizeRendering(_this.updatePrev, null, [
                _this._renderLayout,
            ]);
            _this._updateNext = memoizeRendering(_this.updateNext, null, [
                _this._renderLayout,
            ]);
        ...
        Toolbar.prototype.renderSection = function (position, buttonStr) {
            ...
            var calendarCustomButtons =
                optionsManager.computed.customButtons || {};
                    ...
                    buttonGroupStr.split(",").forEach(function (buttonName, j) {
                        ...
                        if (buttonName === "title") {
                            ...
                            if (
                                ...
                                (buttonIcon =
                                    theme.getCustomButtonIconClass(
                                        customButtonProps
                                    )) ||
                                    (buttonIcon =
                                        theme.getIconClass(buttonName)) ||
        ...
        Toolbar.prototype.updateActiveButton = function (buttonName) {
            ...
            findElements(this.el, "button").forEach(function (buttonEl) {
                if (
                    buttonName &&
                    buttonEl.classList.contains("fc-" + buttonName + "-button")
                ) {
        ...
        Toolbar.prototype.toggleButtonEnabled = function (buttonName, bool) {
            findElements(this.el, ".fc-" + buttonName + "-button").forEach(
                function (buttonEl) {
    ...
    var CalendarComponent = /** @class */ (function (_super) {
        ...
        function CalendarComponent(context, el) {
            ...
            _this.buildViewPropTransformers = memoize(
                buildViewPropTransformers
            );
            _this.el = el;
            prependToElement(
                el,
                (_this.contentEl = createElement("div", {
            ...
            for (
                var _i = 0,
                    _a = calendar.pluginSystem.hooks.viewContainerModifiers;
                _i < _a.length;
                _i++
            ) {
        ...
        CalendarComponent.prototype.renderToolbars = function (
            viewSpec,
            dateProfile,
            currentDate,
            ...
            if (headerLayout) {
                ...
                this.header.receiveProps(
                    __assign({ layout: headerLayout }, toolbarProps)
                );
            } else if (this.header) {
                this.header.destroy();
                this.header = null;
            ...
            if (footerLayout) {
                ...
                this.footer.receiveProps(
                    __assign({ layout: footerLayout }, toolbarProps)
                );
            } else if (this.footer) {
                this.footer.destroy();
                this.footer = null;
        ...
        CalendarComponent.prototype.renderView = function (props, title) {
            ...
            var viewProps = {
                ...
                businessHours: this.parseBusinessHours(
                    viewSpec.options.businessHours
                ),
        ...
        CalendarComponent.prototype.computeHeightVars = function () {
            ...
            this.isHeightAuto =
                heightInput === "auto" || contentHeightInput === "auto";
    ...
    */
    ...
    var Calendar = /** @class */ (function () {
        function Calendar(el, overrides) {
            ...
            this.buildEventUiBySource = memoizeOutput(
            ...
            this.calendarInteractions =
                this.pluginSystem.hooks.calendarInteractions.map(function (
        ...
        Calendar.prototype.addPluginInputs = function (pluginInputs) {
            ...
            for (
                var _i = 0, pluginDefs_1 = pluginDefs;
                _i < pluginDefs_1.length;
                _i++
            ) {
        ...
        Calendar.prototype.bindHandlers = function () {
            ...
            this.removeNavLinkListener = listenBySelector(
                this.el,
                "click",
                "a[data-goto]",
                function (ev, anchorEl) {
                    ...
                    var customAction = _this.viewOpt(
        ...
        Calendar.prototype.hydrate = function () {
            ...
            this.batchRendering(function () {
                ...
                _this.dispatch({
                    type: "SET_VIEW_TYPE",
                    viewType:
                        _this.opt("defaultView") ||
                        _this.pluginSystem.hooks.defaultView,
                });
            });
        };
        ...
        Calendar.prototype.dispatch = function (action) {
            ...
            if (!this.isReducing) {
                ...
                if (
                    oldState.eventStore !== newState.eventStore ||
                ...
                if (
                    oldState.dateProfile !== newState.dateProfile ||
                    this.needsFullRerender
                ) {
        ...
        */
        Calendar.prototype.renderComponent = function (needsFull) {
            ...
            var savedScroll =
                needsFull && component ? component.view.queryScroll() : null;
            if (!viewSpec) {
            ...
            var renderableEventStore = (this.renderableEventStore =
                state.eventSourceLoadingLevel &&
                !this.opt("progressiveEventRendering")
                    ? this.renderableEventStore
                    : state.eventStore);
            var eventUiSingleBase = this.buildEventUiSingleBase(
                viewSpec.options
            );
            var eventUiBySource = this.buildEventUiBySource(state.eventSources);
            var eventUiBases = (this.eventUiBases = this.buildEventUiBases(
        ...
        */
        Calendar.prototype.mutateOptions = function (
            updates,
            removals,
            isDynamic,
            deepEqual
            ...
            this.batchRendering(function () {
                ...
                if (deepEqual) {
                    for (var name_3 in specialUpdates) {
                        changeHandlers[name_3](
                            specialUpdates[name_3],
                            _this,
                            deepEqual
                        );
                    }
        ...
        */
        Calendar.prototype.handleOptions = function (options) {
            ...
            this.delayedRerender = this.buildDelayedRerender(
                options.rerenderDelay
            );
            this.theme = this.buildTheme(options);
            var available = this.parseRawLocales(options.locales);
            this.availableRawLocales = available.map;
            var locale = this.buildLocale(
                options.locale || available.defaultCode,
                available.map
            );
            ...
            // ineffecient to do every time?
            this.dateProfileGenerators = mapHash(
                this.viewSpecs,
                function (viewSpec) {
                    return new viewSpec.class.prototype.dateProfileGeneratorClass(
                        viewSpec,
                        _this
                    );
                }
        ...
        Calendar.prototype.publiclyTriggerAfterSizing = function (name, args) {
            ...
            (
                afterSizingTriggers[name] || (afterSizingTriggers[name] = [])
            ).push(args);
        };
        Calendar.prototype.releaseAfterSizingTriggers = function () {
            ...
            for (var name_4 in afterSizingTriggers) {
                for (
                    var _i = 0, _a = afterSizingTriggers[name_4];
                    _i < _a.length;
                    _i++
                ) {
                    var args = _a[_i];
        ...
        Calendar.prototype.getUnitViewSpec = function (unit) {
            ...
            if (component.header) {
                viewTypes.push.apply(
                    viewTypes,
                    component.header.viewsWithButtons
                );
            }
            if (component.footer) {
                viewTypes.push.apply(
                    viewTypes,
                    component.footer.viewsWithButtons
                );
            }
        ...
        // -----------------------------------------------------------------------------------------------------------------
        Calendar.prototype.registerInteractiveComponent = function (
            component,
            settingsInput
        ) {
        ...
        Calendar.prototype.unregisterInteractiveComponent = function (
            component
        ) {
            for (
                var _i = 0, _a = this.interactionsStore[component.uid];
                _i < _a.length;
                _i++
            ) {
                var listener = _a[_i];
        ...
        // TODO: receive pev?
        Calendar.prototype.triggerDateClick = function (
            dateSpan,
            dayEl,
            view,
            ev
        ...
        Calendar.prototype.buildDatePointApi = function (dateSpan) {
            var props = {};
            for (
                var _i = 0, _a = this.pluginSystem.hooks.datePointTransforms;
                _i < _a.length;
                _i++
            ) {
                var transform = _a[_i];
        ...
        Calendar.prototype.buildDateSpanApi = function (dateSpan) {
            var props = {};
            for (
                var _i = 0, _a = this.pluginSystem.hooks.dateSpanTransforms;
                _i < _a.length;
                _i++
            ) {
                var transform = _a[_i];
        ...
        Calendar.prototype.getEventSources = function () {
            ...
            for (var internalId in sourceHash) {
                sourceApis.push(
                    new EventSourceApi(this, sourceHash[internalId])
                );
            }
            return sourceApis;
        };
            ...
            if (sourceInput instanceof EventSourceApi) {
                ...
                if (
                    !this.state.eventSources[
                        sourceInput.internalEventSource.sourceId
                    ]
                ) {
                    this.dispatch({
    ...
    function buildTheme(calendarOptions) {
        var themeClass =
            this.pluginSystem.hooks.themeClasses[calendarOptions.themeSystem] ||
            StandardTheme;
    ...
    var View = /** @class */ (function (_super) {
        ...
        function View(context, viewSpec, dateProfileGenerator, parentEl) {
            ...
            _this.renderDatesMem = memoizeRendering(
                _this.renderDatesWrap,
                _this.unrenderDatesWrap
            );
            _this.renderBusinessHoursMem = memoizeRendering(
                _this.renderBusinessHours,
                _this.unrenderBusinessHours,
                [_this.renderDatesMem]
            );
            _this.renderDateSelectionMem = memoizeRendering(
                _this.renderDateSelectionWrap,
                _this.unrenderDateSelectionWrap,
                [_this.renderDatesMem]
            );
            _this.renderEventsMem = memoizeRendering(
                _this.renderEvents,
                _this.unrenderEvents,
                [_this.renderDatesMem]
            );
            _this.renderEventSelectionMem = memoizeRendering(
                _this.renderEventSelectionWrap,
                _this.unrenderEventSelectionWrap,
                [_this.renderEventsMem]
            );
            _this.renderEventDragMem = memoizeRendering(
                _this.renderEventDragWrap,
                _this.unrenderEventDragWrap,
                [_this.renderDatesMem]
            );
            _this.renderEventResizeMem = memoizeRendering(
                _this.renderEventResizeWrap,
                _this.unrenderEventResizeWrap,
                [_this.renderDatesMem]
            );
            ...
            _this.nextDayThreshold = createDuration(
        ...
        View.prototype.updateBaseSize = function (
            isResize,
            viewHeight,
            isAuto
        ) {};
        ...
        View.prototype.computeEventDraggable = function (eventDef, eventUi) {
            var transformers =
                this.calendar.pluginSystem.hooks.isDraggableTransformers;
        ...
        View.prototype.computeEventStartResizable = function (
            eventDef,
            eventUi
        ) {
            return (
                eventUi.durationEditable && this.opt("eventResizableFromStart")
            );
        };
    ...
    var FgEventRenderer = /** @class */ (function () {
        ...
        FgEventRenderer.prototype.renderSegs = function (segs, mirrorInfo) {
            ...
            this.context.view.triggerRenderedSegs(
                this.segs,
                Boolean(mirrorInfo)
            );
        };
        FgEventRenderer.prototype.unrender = function (_segs, mirrorInfo) {
            this.context.view.triggerWillRemoveSegs(
                this.segs,
                Boolean(mirrorInfo)
            );
        ...
        FgEventRenderer.prototype.getSegClasses = function (
            seg,
            isDraggable,
            isResizable,
            mirrorInfo
        ...
        FgEventRenderer.prototype.getTimeText = function (
            eventRange,
            formatter,
            displayEnd
        ) {
        ...
        FgEventRenderer.prototype._getTimeText = function (
            start,
            end,
            allDay,
            formatter,
        ...
        FgEventRenderer.prototype.selectByInstanceId = function (instanceId) {
            if (instanceId) {
                for (var _i = 0, _a = this.segs; _i < _a.length; _i++) {
                    ...
                    if (
                        eventInstance &&
                        eventInstance.instanceId === instanceId &&
                        seg.el // necessary?
                    ) {
    ...
    var FillRenderer = /** @class */ (function () {
        ...
        FillRenderer.prototype.renderSegs = function (type, segs) {
            ...
            if (containerEls) {
                (_a =
                    this.containerElsByType[type] ||
                    (this.containerElsByType[type] = [])).push.apply(
                    _a,
                    containerEls
                );
            }
    ...
    */
    ...
    function formatRange(
        ...
        var formatter = createFormatter(
            settings,
            globalDefaults.defaultRangeSeparator
        );
    ...
    function buildDateEnv$1(settings) {
        ...
        settings = __assign(
            { timeZone: globalDefaults.timeZone, calendarSystem: "gregory" },
            settings,
            { locale: locale }
        );
    ...
    function renderDateCell(
        ...
        if (typeof options.columnHeaderHtml === "function") {
            ...
            innerHtml = htmlEscape(
                options.columnHeaderText(dateEnv.toDate(dateMarker))
            );
        } else {
        ...
        return (
            ...
            (isDateValid && datesRepDistinctDays
                ? ' data-date="' +
                  dateEnv.formatIso(dateMarker, { omitTime: true }) +
                  '"'
                : "") +
    ...
    var DayHeader = /** @class */ (function (_super) {
        ...
        function DayHeader(context, parentEl) {
            ...
            parentEl.appendChild(
                (_this.el = htmlToElement(
                    '<div class="fc-row ' +
                        _this.theme.getClass("headerRow") +
                        '">' +
                        '<table class="' +
                        _this.theme.getClass("tableGrid") +
                        '">' +
                        "<thead></thead>" +
                        "</table>" +
                        "</div>"
        ...
        DayHeader.prototype.render = function (props) {
            ...
            var colHeadFormat = createFormatter(
    ...
    var Slicer = /** @class */ (function () {
        ...
        Slicer.prototype.sliceProps = function (
            ...
            return {
                dateSelectionSegs: this.sliceDateSelection.apply(
                    this,
                    [props.dateSelection, eventUiBases, component].concat(
                        extraArgs
                    )
                ),
        ...
        Slicer.prototype._sliceEventStore = function (
            ...
            if (eventStore) {
                ...
                return {
                    bg: this.sliceEventRanges(
                        rangeRes.bg,
                        component,
                        extraArgs
                    ),
                    fg: this.sliceEventRanges(
                        rangeRes.fg,
                        component,
                        extraArgs
                    ),
        ...
        Slicer.prototype._sliceDateSpan = function (
            ...
            var eventRange = fabricateEventRange(
                dateSpan,
                eventUiBases,
                component.calendar
            );
            var segs = this.sliceRange.apply(
                this,
                [dateSpan.range].concat(extraArgs)
            );
        ...
        */
        Slicer.prototype.sliceEventRanges = function (
            eventRanges,
            component, // TODO: kill
            extraArgs
        ) {
            ...
            for (
                ...
                segs.push.apply(
                    segs,
                    this.sliceEventRange(eventRange, component, extraArgs)
                );
            }
            return segs;
        };
        ...
        */
        Slicer.prototype.sliceEventRange = function (
            ...
            var segs = this.sliceRange.apply(
                this,
                [eventRange.range].concat(extraArgs)
            );
            for (var _i = 0, segs_2 = segs; _i < segs_2.length; _i++) {
                var seg = segs_2[_i];
                seg.component = component;
