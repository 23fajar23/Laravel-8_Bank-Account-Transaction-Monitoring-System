...
(function (f) {
                ...
                for (h = m.length; p < h; p++)
                    if ("number" === typeof m[p] && 0 <= m[p]) {
                        ...
                        for (g = k.length; v < g; v++)
                            ("_all" == m[p] || f(k[v].nTh).hasClass(m[p])) &&
                                d(v, l);
                    }
            }
    ...
    function rb(a) {
        ...
        for (
            var h = a.sDom.split(""), g, k, l, m, p, n, u = 0;
            u < h.length;
            u++
        ) {
            g = null;
    ...
    function tb(a) {
        var b = a.oClasses,
            ...
            g =
                ...
                b.sFilterInput +
                ' searchbtn form-control form-control-lg  mr-4 border-1 bg-light"/>',
            k = d.sSearch;
    ...
    function za(a) {
        ...
        if (e.bSort && e.bSortClasses) {
            ...
            for (h = b.length; e < h; e++) {
                var g = b[e].src;
                f(K(a.aoData, "anCells", g)).removeClass(
                    c + (2 > e ? e + 1 : 3)
                );
            }
            e = 0;
            for (h = d.length; e < h; e++)
                (g = d[e].src),
                    f(K(a.aoData, "anCells", g)).addClass(
                        c + (2 > e ? e + 1 : 3)
                    );
        }
        a.aLastSort = d;
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    for (l = u.length; k < l; k++) {
                        ...
                        if (
                            ...
                            var w =
                                g.bRetrieve !== n ? g.bRetrieve : p.bRetrieve;
                    ...
                    e = function () {
                        ...
                        0 === b.length || 0 === b.children().length
                            ...
                            : 0 < b.length &&
                              ((r.nTFoot = b[0]), ea(r.aoFooter, r.nTFoot));
                        if (g.aaData)
    ...
    var db = function (a, b, c, d, e) {
            var h = [],
                ...
                l;
            var m = typeof b;
            (b && "string" !== m && "function" !== m && b.length !== n) ||
                (b = [b]);
            m = 0;
                    ...
                    if (f.isArray(b) || b instanceof f)
                        ...
                        b.nodeName && "tr" === b.nodeName.toLowerCase()
                            ...
                            : ((d = f("<tr><td/></tr>").addClass(c)),
                              (f("td", d).addClass(c).html(b)[0].colSpan =
                                  V(a)),
                              e.push(d[0]));
                };
            h(c, d);
    ...
    q.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {
                sFirst: "Pertama",
                sLast: "Terakhir",
                sNext: "<b>Selanjutnya</b>",
                sPrevious: "<b>Sebelumnya</b>",
            },
            sEmptyTable: "Rekaman Data Tidak Tersedia",
            ...
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "<b> Tampilkan _MENU_ Data </b>",
            sLoadingRecords: "Loading...",
            sProcessing: "Memuat Data...",
            sSearch: "<b> Pencarian : </b>",
            sSearchPlaceholder: " Data Pencarian ",
            sUrl: "",
