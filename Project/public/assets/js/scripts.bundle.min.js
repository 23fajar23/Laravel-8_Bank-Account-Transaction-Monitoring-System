    ...
    var t = {},
        ...
        l = function () {
            $('[data-ktportlet="true"]').each(function () {
                var t = $(this);
                !0 !== t.data("data-ktportlet-initialized") &&
                    (o(t, {}), t.data("data-ktportlet-initialized", !0));
            });
        },
        r = function () {
        ...
        block: function (t, e) {
            var a,
                ...
                i =
                    ...
                    ((e = $.extend(
                        ...
                        : "") +
                    " " +
                    (e.state ? "kt-spinner--" + e.state : "") +
                    " " +
                    (e.size ? "kt-spinner--" + e.size : "") +
                    '"></div';
            ...
            var l = {
                ...
                onUnblock: function () {
                    n &&
                        n[0] &&
                        (KTUtil.css(n[0], "position", ""),
                        KTUtil.css(n[0], "zoom", ""));
                },
            };
            "body" == t
                ? ((l.css.top = "50%"), $.blockUI(l))
                : (n = $(t)).block(l);
        },
        unblock: function (t) {
        ...
        var i = {},
            o = {
                construct: function (t) {
                    return (
                        KTUtil.data(n).has("avatar")
                            ? (a = KTUtil.data(n).get("avatar"))
                            : (o.init(t),
                              o.build(),
                              KTUtil.data(n).set("avatar", a)),
                        a
                    );
                },
                init: function (t) {
                    (a.element = n),
                        ...
                        (a.holder = KTUtil.find(n, ".kt-avatar__holder")),
                        (a.cancel = KTUtil.find(n, ".kt-avatar__cancel")),
                        (a.src = KTUtil.css(a.holder, "backgroundImage")),
                    ...
                    KTUtil.addEvent(a.input, "change", function (t) {
                        ...
                        KTUtil.addEvent(a.cancel, "click", function (t) {
                            t.preventDefault(),
                                ...
                                KTUtil.css(a.holder, "background-image", a.src),
                                (a.input.value = "");
                        });
                },
        ...
        o = {
            ...
            show: function () {
                return (
                    ...
                    KTUtil.setHTML(e, a.options.message),
                    KTUtil.addClass(e, "kt-dialog kt-dialog--shown"),
                    KTUtil.addClass(e, "kt-dialog--" + a.options.state),
                    KTUtil.addClass(e, "kt-dialog--" + a.options.type),
                    "top center" == a.options.placement &&
                        KTUtil.addClass(e, "kt-dialog--top-center"),
                    n.appendChild(e),
                    (a.state = "shown"),
                    o.eventTrigger("shown"),
                    a
                );
            },
            hide: function () {
            ...
            addEvent: function (t, e, n) {
                return (
                    a.events.push({ name: t, handler: e, one: n, fired: !1 }), a
                );
            },
        };
    return (
    ...
    if (void 0 !== n) {
        var o = {
            ...
            l = {
                construct: function (t) {
                    return (
                        KTUtil.data(n).has("header")
                            ? (a = KTUtil.data(n).get("header"))
                            : (l.init(t),
                              l.build(),
                              KTUtil.data(n).set("header", a)),
                        a
                    );
                },
                init: function (t) {
                    ...
                    (!1 === a.options.minimize.mobile &&
                        ...
                        window.addEventListener("scroll", function () {
                            ...
                            KTUtil.isInResponsiveRange("desktop")
                                ? ((d = a.options.offset.desktop),
                                  (o = a.options.minimize.desktop.on),
                                  (r = a.options.minimize.desktop.off))
                                : KTUtil.isInResponsiveRange(
                                      "tablet-and-mobile"
                                  ) &&
                                  ((d = a.options.offset.mobile),
                                  (o = a.options.minimize.mobile.on),
                                  (r = a.options.minimize.mobile.off)),
                                (s = KTUtil.getScrollTop()),
                                console.log("top:" + s),
                                console.log("offset:" + d),
                                console.log("documentHeight:" + n),
                                (KTUtil.isInResponsiveRange(
                                    "tablet-and-mobile"
                                ) &&
                                    a.options.classic &&
                                ...
                                (KTUtil.isInResponsiveRange("desktop") &&
                                    ...
                                    ? s > d
                                        ? (KTUtil.addClass(i, o),
                                          KTUtil.removeClass(i, r),
                                          e &&
                                              (l.eventTrigger("minimizeOn", a),
                                              (e = !1)))
                                        : (KTUtil.addClass(i, r),
                                          KTUtil.removeClass(i, o),
                                          0 == e &&
                                              (l.eventTrigger("minimizeOff", a),
                                              (e = !0)))
                                    : (s > d && t < s
                                          ? (KTUtil.addClass(i, o),
                                            KTUtil.removeClass(i, r),
    ...
    if (i) {
        var l = {
            ...
            r = {
                construct: function (t) {
                    return (
                        KTUtil.data(i).has("menu")
                            ? (a = KTUtil.data(i).get("menu"))
                            : (r.init(t),
                              r.reset(),
                              r.build(),
                              KTUtil.data(i).set("menu", a)),
                        a
                    );
                },
                init: function (t) {
                    (a.events = []),
                        (a.eventHandlers = {}),
                        (a.options = KTUtil.deepExtend({}, l, t)),
                        (a.pauseDropdownHoverTime = 0),
                        (a.uid = KTUtil.getUniqueID());
                },
                update: function (t) {
                    (a.options = KTUtil.deepExtend({}, l, t)),
                        (a.pauseDropdownHoverTime = 0),
                ...
                build: function () {
                    (a.eventHandlers.event_1 = KTUtil.on(
                        i,
                        ".kt-menu__toggle",
                        "click",
                        ...
                        (a.eventHandlers.event_6 = KTUtil.on(
                            i,
                ...
                reset: function () {
                    KTUtil.off(i, "click", a.eventHandlers.event_1),
                        KTUtil.off(i, "mouseover", a.eventHandlers.event_2),
                        KTUtil.off(i, "mouseout", a.eventHandlers.event_3),
                        KTUtil.off(i, "click", a.eventHandlers.event_4),
                        KTUtil.off(i, "click", a.eventHandlers.event_5),
                    ...
                    a.options.scroll && a.options.scroll.height
                        ? (KTUtil.scrollDestroy(i),
                          KTUtil.scrollInit(i, {
                              ...
                              rememberPosition:
                                  a.options.scroll.rememberPosition,
                          }))
                        : KTUtil.scrollDestroy(i);
                },
                ...
                getSubmenuMode: function (t) {
                    return KTUtil.isInResponsiveRange("desktop")
                        ? t &&
                          KTUtil.hasAttr(t, "data-ktmenu-submenu-toggle") &&
                          "hover" ==
                              KTUtil.attr(t, "data-ktmenu-submenu-toggle")
                            ? "dropdown"
                            : KTUtil.isset(
                                  a.options.submenu,
                                  "desktop.state.body"
                            ...
                            : KTUtil.isset(a.options.submenu, "desktop")
                            ? a.options.submenu.desktop
                            : void 0
                        : KTUtil.isInResponsiveRange("tablet") &&
                          KTUtil.isset(a.options.submenu, "tablet")
                        ? a.options.submenu.tablet
                        : !(
                              !KTUtil.isInResponsiveRange("mobile") ||
                              !KTUtil.isset(a.options.submenu, "mobile")
                          ) && a.options.submenu.mobile;
                },
                isConditionalSubmenuDropdown: function () {
                    return !(
                        !KTUtil.isInResponsiveRange("desktop") ||
                        !KTUtil.isset(a.options.submenu, "desktop.state.body")
                    );
                },
                resetSubmenuProps: function (t) {
                    ...
                    if (e)
                        for (var a = 0, n = e.length; a < n; a++)
                            KTUtil.css(e[0], "display", ""),
                                KTUtil.css(e[0], "overflow", "");
                },
                ...
                handleSubmenuDropdownClick: function (t) {
                    if ("accordion" !== r.getSubmenuMode(this)) {
                        ...
                        "accordion" !=
                            e.getAttribute("data-ktmenu-submenu-mode") &&
                            (!1 === KTUtil.hasClass(e, "kt-menu__item--hover")
                                ? (KTUtil.addClass(
                                      e,
                ...
                handleSubmenuDropdownTabClick: function (t) {
                    if ("accordion" !== r.getSubmenuMode(this)) {
                        ...
                        "accordion" !=
                            e.getAttribute("data-ktmenu-submenu-mode") &&
                            (0 == KTUtil.hasClass(e, "kt-menu__item--hover") &&
                                (KTUtil.addClass(
                                    e,
                                    "kt-menu__item--open-dropdown"
                                ),
                ...
                handleLinkClick: function (t) {
                    ...
                    !1 !== r.eventTrigger("linkClick", this, t) &&
                        e &&
                ...
                handleSubmenuDropdownClose: function (t, e) {
                    if ("accordion" !== r.getSubmenuMode(e)) {
                        ...
                        if (
                            a.length > 0 &&
                            !1 === KTUtil.hasClass(e, "kt-menu__toggle") &&
                            0 === e.querySelectorAll(".kt-menu__toggle").length
                        )
                ...
                handleSubmenuAccordion: function (t, e) {
                    ...
                    if (
                        "dropdown" === r.getSubmenuMode(e) &&
                        (n = i.closest(".kt-menu__item")) &&
                        "accordion" !=
                            n.getAttribute("data-ktmenu-submenu-mode")
                    )
                        t.preventDefault();
                    else {
                        ...
                        if (
                            ...
                            if (
                                !1 === KTUtil.hasClass(o, "kt-menu__item--open")
                            ) {
                                ...
                                KTUtil.slideDown(l, s, function () {
                                    r.scrollToItem(i),
                                        r.scrollUpdate(),
                                        r.eventTrigger("submenuToggle", l, t);
                                }),
                ...
                scrollToItem: function (t) {
                    KTUtil.isInResponsiveRange("desktop") &&
                        ...
                        "1" !== i.getAttribute("data-ktmenu-scroll") &&
                        KTUtil.scrollTo(t, a.options.accordion.autoScrollSpeed);
                },
                hideSubmenuDropdown: function (t, e) {
                    e &&
                        (KTUtil.removeClass(t, "kt-menu__item--hover"),
                        KTUtil.removeClass(t, "kt-menu__item--active-tab")),
                        t.removeAttribute("data-hover"),
                        t.getAttribute("data-ktmenu-dropdown-toggle-class") &&
                            KTUtil.removeClass(
                                o,
                                t.getAttribute(
                ...
                showSubmenuDropdown: function (t) {
                    ...
                    KTUtil.addClass(t, "kt-menu__item--hover"),
                        t.getAttribute("data-ktmenu-dropdown-toggle-class") &&
                            KTUtil.addClass(
                                o,
                                t.getAttribute(
                ...
                createSubmenuDropdownClickDropoff: function (t) {
                    var e,
                        a =
                            (e = KTUtil.child(t, ".kt-menu__submenu")
                                ? KTUtil.css(e, "z-index")
                                : 0) - 1,
                    ...
                    o.appendChild(n),
                        KTUtil.addEvent(n, "click", function (e) {
                            e.stopPropagation(),
                                e.preventDefault(),
                                KTUtil.remove(this),
                ...
                resetActiveItem: function (t) {
                    for (
                        ...
                        var r = e[0];
                        KTUtil.removeClass(r, "kt-menu__item--active"),
                            KTUtil.hide(KTUtil.child(r, ".kt-menu__submenu"));
                        for (
                            var s = 0,
                                d = (n =
                                    KTUtil.parents(
                            ...
                            var c = n[o];
                            KTUtil.removeClass(c, "kt-menu__item--open"),
                                KTUtil.hide(
                                    KTUtil.child(c, ".kt-menu__submenu")
                                );
                        }
                    }
                    if (
                        !1 === a.options.accordion.expandAll &&
                        (e = i.querySelectorAll(".kt-menu__item--open"))
                    )
                ...
                setActiveItem: function (t) {
                    ...
                    for (
                        var e =
                                KTUtil.parents(t, ".kt-menu__item--submenu") ||
                                [],
                            a = 0,
                            n = e.length;
                        a < n;
                ...
                getBreadcrumbs: function (t) {
                    ...
                    a.push({
                        text: (e = KTUtil.child(n, ".kt-menu__link-text")
                            ? e.innerHTML
                            : ""),
                    ...
                    for (
                        var i = KTUtil.parents(t, ".kt-menu__item--submenu"),
                            o = 0,
                            l = i.length;
                        o < l;
                        o++
                        ...
                        a.push({
                            text: (e = KTUtil.child(r, ".kt-menu__link-text")
                                ? e.innerHTML
                                : ""),
                ...
                getPageTitle: function (t) {
                    var e;
                    return KTUtil.child(t, ".kt-menu__link-text")
                        ? e.innerHTML
                        : "";
                },
...
"undefined" != typeof module &&
    ...
    document.addEventListener("click", function (t) {
        var e;
        if (
            (e = KTUtil.get("body").querySelectorAll(
    ...
    if (n) {
        var o = {},
            l = {
                construct: function (t) {
                    return (
                        KTUtil.data(n).has("offcanvas")
                            ? (a = KTUtil.data(n).get("offcanvas"))
                            : (l.init(t),
                              l.build(),
                              KTUtil.data(n).set("offcanvas", a)),
                        a
                    );
                },
                init: function (t) {
                    (a.events = []),
                        ...
                        (a.state = KTUtil.hasClass(n, a.classShown)
                            ? "shown"
                            : "hidden");
                },
                build: function () {
                    ...
                    e &&
                        KTUtil.addEvent(e, "click", function (t) {
                            t.preventDefault(), l.hide();
                        }),
                        KTUtil.addResizeHandler(function () {
                            (parseInt(KTUtil.css(n, "left")) >= 0 ||
                                parseInt(KTUtil.css(n, "right") >= 0) ||
                                "fixed" != KTUtil.css(n, "position")) &&
                                KTUtil.css(n, "opacity", "1");
                        });
                },
                isShown: function (t) {
                    return "shown" == a.state;
                ...
                show: function (t) {
                    "shown" != a.state &&
                        ...
                        KTUtil.addClass(i, a.classShown),
                        KTUtil.addClass(n, a.classShown),
                        KTUtil.css(n, "opacity", "1"),
                        (a.state = "shown"),
                        a.options.overlay &&
                            ((a.overlay = KTUtil.insertAfter(
                                document.createElement("DIV"),
                                n
                            )),
                            KTUtil.addClass(a.overlay, a.classOverlay),
                            KTUtil.addEvent(a.overlay, "click", function (e) {
                                e.stopPropagation(),
                                    e.preventDefault(),
                                    l.hide(t);
                            })),
                ...
                hide: function (t) {
                    "hidden" != a.state &&
                        ...
                        KTUtil.removeClass(i, a.classShown),
                        KTUtil.removeClass(n, a.classShown),
                        (a.state = "hidden"),
                        a.options.overlay &&
                            a.overlay &&
                            KTUtil.remove(a.overlay),
                        KTUtil.transitionEnd(n, function () {
                ...
                togglerClass: function (t, e) {
                    ...
                    if (
                        ...
                        for (var o in a.options.toggleBy)
                            a.options.toggleBy[o].target === i &&
                                (n = a.options.toggleBy[o]);
                    else
                        a.options.toggleBy &&
                            a.options.toggleBy.target &&
                    ...
                    if (n) {
                        ...
                        "show" === e && KTUtil.addClass(l, n.state),
                            "hide" === e && KTUtil.removeClass(l, n.state);
                    }
                },
                eventTrigger: function (t, e) {
                    for (var n = 0; n < a.events.length; n++) {
    ...
    if (n) {
        var o = {
            ...
            l = {
                construct: function (t) {
                    return (
                        KTUtil.data(n).has("portlet")
                            ? (a = KTUtil.data(n).get("portlet"))
                            : (l.init(t),
                              l.build(),
                              KTUtil.data(n).set("portlet", a)),
                        a
                    );
                },
                init: function (t) {
                    (a.element = n),
                        (a.events = []),
                        (a.options = KTUtil.deepExtend({}, o, t)),
                        (a.head = KTUtil.child(n, ".kt-portlet__head")),
                        (a.foot = KTUtil.child(n, ".kt-portlet__foot")),
                        KTUtil.child(n, ".kt-portlet__body")
                            ? (a.body = KTUtil.child(n, ".kt-portlet__body"))
                            : KTUtil.child(n, ".kt-form") &&
                              (a.body = KTUtil.child(n, ".kt-form"));
                },
                build: function () {
                    var t = KTUtil.find(a.head, "[data-ktportlet-tool=remove]");
                    t &&
                        KTUtil.addEvent(t, "click", function (t) {
                    ...
                    n &&
                        KTUtil.addEvent(n, "click", function (t) {
                            t.preventDefault(), l.toggle();
                        });
                    var i = KTUtil.find(
                        a.head,
                    ...
                    i &&
                        KTUtil.addEvent(i, "click", function (t) {
                ...
                initSticky: function () {
                    ...
                    a.head &&
                        window.addEventListener("scroll", l.onScrollSticky);
                },
                onScrollSticky: function (t) {
                    ...
                    if (!isNaN(e)) {
                        ...
                        o >= e &&
                        !1 === KTUtil.hasClass(i, "kt-portlet--sticky")
                            ? (l.eventTrigger("stickyOn"),
                              KTUtil.addClass(i, "kt-portlet--sticky"),
                              KTUtil.addClass(n, "kt-portlet--sticky"),
                              l.updateSticky())
                            : 1.5 * o <= e &&
                              KTUtil.hasClass(i, "kt-portlet--sticky") &&
                              (l.eventTrigger("stickyOff"),
                              KTUtil.removeClass(i, "kt-portlet--sticky"),
                              KTUtil.removeClass(n, "kt-portlet--sticky"),
                              l.resetSticky());
                    }
                },
                    ...
                    a.head &&
                        ...
                        ((t =
                            a.options.sticky.position.top instanceof Function
                                ? parseInt(
                                      a.options.sticky.position.top.call(
                                          this,
                                          a
                                      )
                                  )
                        ...
                        (e =
                            a.options.sticky.position.left instanceof Function
                                ? parseInt(
                                      a.options.sticky.position.left.call(
                                          this,
                                          a
                                      )
                                  )
                        ...
                        (n =
                            a.options.sticky.position.right instanceof Function
                                ? parseInt(
                                      a.options.sticky.position.right.call(
                                          this,
                                          a
                                      )
                                  )
                                : parseInt(a.options.sticky.position.right)),
                        KTUtil.css(a.head, "z-index", a.options.sticky.zIndex),
                        KTUtil.css(a.head, "top", t + "px"),
                        KTUtil.css(a.head, "left", e + "px"),
                        KTUtil.css(a.head, "right", n + "px"));
                },
                resetSticky: function () {
                    a.head &&
                        !1 === KTUtil.hasClass(i, "kt-portlet--sticky") &&
                        (KTUtil.css(a.head, "z-index", ""),
                        KTUtil.css(a.head, "top", ""),
                        KTUtil.css(a.head, "left", ""),
                        KTUtil.css(a.head, "right", ""));
                },
                remove: function () {
                    !1 !== l.eventTrigger("beforeRemove") &&
                        (KTUtil.hasClass(i, "kt-portlet--fullscreen") &&
                            KTUtil.hasClass(n, "kt-portlet--fullscreen") &&
                            l.fullscreen("off"),
                        l.removeTooltips(),
                        KTUtil.remove(n),
                ...
                setupTooltips: function () {
                    if (a.options.tooltips) {
                        var t =
                                KTUtil.hasClass(n, "kt-portlet--collapse") ||
                                KTUtil.hasClass(n, "kt-portlet--collapsed"),
                            e =
                                KTUtil.hasClass(i, "kt-portlet--fullscreen") &&
                                KTUtil.hasClass(n, "kt-portlet--fullscreen"),
                            o = KTUtil.find(
                ...
                removeTooltips: function () {
                    if (a.options.tooltips) {
                        ...
                        t &&
                            KTUtil.data(t).has("tooltip") &&
                            KTUtil.data(t).get("tooltip").dispose();
                        var e = KTUtil.find(
                            a.head,
                            "[data-ktportlet-tool=reload]"
                        );
                        e &&
                            KTUtil.data(e).has("tooltip") &&
                            KTUtil.data(e).get("tooltip").dispose();
                        var n = KTUtil.find(
                            a.head,
                            "[data-ktportlet-tool=toggle]"
                        );
                        n &&
                            KTUtil.data(n).has("tooltip") &&
                            KTUtil.data(n).get("tooltip").dispose();
                        var i = KTUtil.find(
                            a.head,
                            "[data-ktportlet-tool=fullscreen]"
                        );
                        i &&
                            KTUtil.data(i).has("tooltip") &&
                            KTUtil.data(i).get("tooltip").dispose();
                    }
                },
                reload: function () {
                ...
                expand: function () {
                    if (!1 !== l.eventTrigger("beforeExpand")) {
                        KTUtil.slideDown(
                            ...
                            KTUtil.removeClass(n, "kt-portlet--collapse"),
                            KTUtil.removeClass(n, "kt-portlet--collapsed");
                        var t = KTUtil.find(
                            a.head,
                            "[data-ktportlet-tool=toggle]"
                        );
                ...
                fullscreen: function (t) {
                    if (
                        ...
                        l.eventTrigger("beforeFullscreenOff"),
                            KTUtil.removeClass(i, "kt-portlet--fullscreen"),
                            KTUtil.removeClass(n, "kt-portlet--fullscreen"),
                            l.removeTooltips(),
                            l.setupTooltips(),
                            a.foot &&
                                (KTUtil.css(a.body, "margin-bottom", ""),
                                KTUtil.css(a.foot, "margin-top", "")),
                            l.eventTrigger("afterFullscreenOff");
                    else {
                        if (
                            (l.eventTrigger("beforeFullscreenOn"),
                            KTUtil.addClass(n, "kt-portlet--fullscreen"),
                            KTUtil.addClass(i, "kt-portlet--fullscreen"),
                            l.removeTooltips(),
                            l.setupTooltips(),
                            a.foot)
                        ) {
                            var e = parseInt(KTUtil.css(a.foot, "height")),
                                o =
                                    parseInt(KTUtil.css(a.foot, "height")) +
                                    parseInt(KTUtil.css(a.head, "height"));
                            KTUtil.css(a.body, "margin-bottom", e + "px"),
                                KTUtil.css(
                                    a.foot,
                                    "margin-top",
                                    "-" + o + "px"
...
var KTScrolltop = function (t, e) {
    var a = this,
        ...
        i = KTUtil.get("body");
    if (n) {
        var o = { offset: 300, speed: 600, toggleClass: "kt-scrolltop--on" },
            l = {
                construct: function (t) {
                    return (
                        KTUtil.data(n).has("scrolltop")
                            ? (a = KTUtil.data(n).get("scrolltop"))
                            : (l.init(t),
                              l.build(),
                              KTUtil.data(n).set("scrolltop", a)),
                        a
                    );
                },
                init: function (t) {
                ...
                handle: function () {
                    window.pageYOffset > a.options.offset
                        ? KTUtil.addClass(i, a.options.toggleClass)
                        : KTUtil.removeClass(i, a.options.toggleClass);
                },
                scroll: function (t) {
...
var KTToggle = function (t, e) {
    ...
    KTUtil.get("body");
    if (n) {
        var i = { togglerState: "", targetState: "" },
            o = {
                construct: function (t) {
                    return (
                        KTUtil.data(n).has("toggle")
                            ? (a = KTUtil.data(n).get("toggle"))
                            : (o.init(t),
                              o.build(),
                              KTUtil.data(n).set("toggle", a)),
                        a
                    );
                },
                init: function (t) {
                    (a.element = n),
                        (a.events = []),
                        (a.options = KTUtil.deepExtend({}, i, t)),
                        (a.target = KTUtil.get(a.options.target)),
                        (a.targetState = a.options.targetState),
                        (a.togglerState = a.options.togglerState),
                        (a.state = KTUtil.hasClasses(a.target, a.targetState)
                            ? "on"
                            : "off");
                },
                build: function () {
                ...
                toggle: function (t) {
                    return (
                        o.eventTrigger("beforeToggle"),
                        "off" == a.state ? o.toggleOn() : o.toggleOff(),
                        o.eventTrigger("afterToggle"),
                        t.preventDefault(),
                        a
                    );
                },
                toggleOn: function () {
                    return (
                        o.eventTrigger("beforeOn"),
                        KTUtil.addClass(a.target, a.targetState),
                        a.togglerState && KTUtil.addClass(n, a.togglerState),
                        (a.state = "on"),
                        o.eventTrigger("afterOn"),
                ...
                toggleOff: function () {
                    return (
                        o.eventTrigger("beforeOff"),
                        KTUtil.removeClass(a.target, a.targetState),
                        a.togglerState && KTUtil.removeClass(n, a.togglerState),
                        (a.state = "off"),
                        o.eventTrigger("afterOff"),
                        o.eventTrigger("toggle"),
                        a
                    );
                },
    ...
    (function () {
        for (
            ...
            (window.requestAnimationFrame =
                window[e[a] + "RequestAnimationFrame"]),
                ...
                Object.defineProperty(t, "prepend", {
                    ...
                    value: function () {
                        ...
                        t.forEach(function (t) {
                            ...
                            e.appendChild(
                                a ? t : document.createTextNode(String(t))
                            );
                        }),
    ...
    return {
        ...
        getHighestZindex: function (t) {
            for (var e, a, n = KTUtil.get(t); n && n !== document; ) {
                if (
                    ("absolute" === (e = KTUtil.css(n, "position")) ||
                        "relative" === e ||
                        "fixed" === e) &&
                    ((a = parseInt(KTUtil.css(n, "z-index"))),
                    !isNaN(a) && 0 !== a)
                )
                    return a;
                n = n.parentNode;
            ...
            if (t && void 0 !== e) {
                ...
                if (t.classList)
                    for (var n = 0; n < a.length; n++)
                        a[n] &&
                            a[n].length > 0 &&
                            t.classList.add(KTUtil.trim(a[n]));
                ...
                if (t.classList)
                    ...
                    for (var i = 0; i < a.length; i++)
                        t.className = t.className.replace(
                            new RegExp("\\b" + KTUtil.trim(a[i]) + "\\b", "g"),
                            ""
                        );
            }
        },
        ...
        triggerEvent: function (t, e) {
            ...
            if (t.ownerDocument) a = t.ownerDocument;
                ...
                if (9 != t.nodeType)
                    throw new Error(
                        "Invalid node passed to fireEvent: " + t.id
                    );
                a = t;
            }
            if (t.dispatchEvent) {
                ...
                var i = "change" != e;
                (o = a.createEvent(n)).initEvent(e, i, !0),
                    (o.synthetic = !0),
                    t.dispatchEvent(o, !0);
            } else if (t.fireEvent) {
                var o;
                ((o = a.createEventObject()).synthetic = !0),
                    t.fireEvent("on" + e, o);
            }
        },
        index: function (t) {
            for (
                var e = (t = KTUtil.get(t)).parentNode.children, a = 0;
                a < e.length;
                a++
            )
                if (e[a] == t) return a;
        ...
        children: function (t, e, a) {
            if (t && t.childNodes) {
                for (var n = [], i = 0, o = t.childNodes.length; i < o; ++i)
                    1 == t.childNodes[i].nodeType &&
                        KTUtil.matches(t.childNodes[i], e, a) &&
                ...
                (t = KTUtil.get(t)),
                {
                    set: function (e, a) {
                        void 0 !== t &&
                            ...
                            (window.KTUtilElementDataStore[t.customDataTag][e] =
                                a));
                    },
                    get: function (e) {
                        if (void 0 !== t)
                            return void 0 === t.customDataTag
                                ? null
                                : this.has(e)
                                ? window.KTUtilElementDataStore[
                                      t.customDataTag
                    ...
                    has: function (e) {
                        return (
                            ...
                            !(
                                ...
                                !window.KTUtilElementDataStore[t.customDataTag][
                                    e
                                ]
                            )
                        );
        ...
        outerWidth: function (t, e) {
            ...
            return !0 === e
                ? ((a = parseFloat(t.offsetWidth)),
                  (a +=
                      parseFloat(KTUtil.css(t, "margin-left")) +
                      parseFloat(KTUtil.css(t, "margin-right"))),
                  parseFloat(a))
                : (a = parseFloat(t.offsetWidth));
        },
        offset: function (t) {
        ...
        actualCss: function (t, e, a) {
            ...
            if ((t = KTUtil.get(t)) instanceof HTMLElement != !1)
                return t.getAttribute("kt-hidden-" + e) && !1 !== a
                    ? parseFloat(t.getAttribute("kt-hidden-" + e))
                    : ((i = t.style.cssText),
                      (t.style.cssText =
        ...
        slide: function (t, e, a, n, i) {
            if (
                !(
                    !t ||
                    ("up" == e && !1 === KTUtil.visible(t)) ||
                    ("down" == e && !0 === KTUtil.visible(t))
                )
            ) {
                a = a || 600;
                var o = KTUtil.actualHeight(t),
                    l = !1,
                    r = !1;
                KTUtil.css(t, "padding-top") &&
                    !0 !== KTUtil.data(t).has("slide-padding-top") &&
                    KTUtil.data(t).set(
                        "slide-padding-top",
                        KTUtil.css(t, "padding-top")
                    ),
                    KTUtil.css(t, "padding-bottom") &&
                        !0 !== KTUtil.data(t).has("slide-padding-bottom") &&
                        KTUtil.data(t).set(
                            "slide-padding-bottom",
                            KTUtil.css(t, "padding-bottom")
                        ),
                    KTUtil.data(t).has("slide-padding-top") &&
                        (l = parseInt(KTUtil.data(t).get("slide-padding-top"))),
                    KTUtil.data(t).has("slide-padding-bottom") &&
                        (r = parseInt(
                            KTUtil.data(t).get("slide-padding-bottom")
                        )),
                    "up" == e
                        ? ((t.style.cssText =
        ...
        on: function (t, e, a, n) {
            if (e) {
                ...
                return (
                    (window.KTUtilDelegatedEventHandlers[i] = function (a) {
                        for (
                            var i = t.querySelectorAll(e), o = a.target;
                            o && o !== t;
                    ...
                    KTUtil.addEvent(
                        t,
                        a,
                        window.KTUtilDelegatedEventHandlers[i]
                    ),
                    i
                );
            }
        ...
        animateClass: function (t, e, a) {
            ...
            KTUtil.addClass(t, "animated " + e),
                KTUtil.one(t, n, function () {
        ...
        scrollTo: function (t, e, a) {
            ...
            o > l ? ((n = o), (i = l)) : ((n = l), (i = o)),
                e && (i += e),
                KTUtil.animate(n, i, a, function (t) {
                ...
                if (
                    ((n =
                        e.height instanceof Function
                            ...
                            : parseInt(e.height)),
                    (e.mobileNativeScroll || e.disableForMobile) &&
                        KTUtil.isInResponsiveRange("tablet-and-mobile"))
                )
                    (a = KTUtil.data(t).get("ps"))
                        ? (e.resetHeightOnDestroy
                              ? KTUtil.css(t, "height", "auto")
                              : (KTUtil.css(t, "overflow", "auto"),
                                n > 0 && KTUtil.css(t, "height", n + "px")),
                          a.destroy(),
                          (a = KTUtil.data(t).remove("ps")))
                        : n > 0 &&
                          (KTUtil.css(t, "overflow", "auto"),
                          KTUtil.css(t, "height", n + "px"));
                else if (
                    (n > 0 && KTUtil.css(t, "height", n + "px"),
                    e.desktopNativeScroll)
                )
                    KTUtil.css(t, "overflow", "auto");
                else {
                    KTUtil.css(t, "overflow", "hidden"),
                        (a = KTUtil.data(t).get("ps"))
                            ? a.update()
                            : (KTUtil.addClass(t, "kt-scroll"),
                              (a = new PerfectScrollbar(t, {
                                  ...
                                  suppressScrollX:
                                      "true" != KTUtil.attr(t, "data-scroll-x"),
                              })),
        ...
        scrollUpdateAll: function (t) {
            for (
                var e = KTUtil.findAll(t, ".ps"), a = 0, n = e.length;
                a < n;
                a++
            )
...
var KTWizard = function (t, e) {
    ...
    KTUtil.get("body");
    if (n) {
        var i = { startStep: 1, clickableSteps: !0 },
            o = {
                construct: function (t) {
                    return (
                        KTUtil.data(n).has("wizard")
                            ? (a = KTUtil.data(n).get("wizard"))
                            : (o.init(t),
                              o.build(),
                ...
                init: function (t) {
                    (a.element = n),
                        (a.events = []),
                        (a.options = KTUtil.deepExtend({}, i, t)),
                        (a.steps = KTUtil.findAll(
                            n,
                            '[data-ktwizard-type="step"]'
                        )),
                        (a.btnSubmit = KTUtil.find(
                            n,
                            '[data-ktwizard-type="action-submit"]'
                        )),
                        (a.btnNext = KTUtil.find(
                            n,
                            '[data-ktwizard-type="action-next"]'
                        )),
                        (a.btnPrev = KTUtil.find(
                            n,
                            '[data-ktwizard-type="action-prev"]'
                        )),
                        (a.btnLast = KTUtil.find(
                            n,
                            '[data-ktwizard-type="action-last"]'
                        )),
                        (a.btnFirst = KTUtil.find(
                            n,
                ...
                build: function () {
                    KTUtil.addEvent(a.btnNext, "click", function (t) {
                        t.preventDefault(), o.goTo(o.getNextStep(), !0);
                    }),
                        KTUtil.addEvent(a.btnPrev, "click", function (t) {
                            t.preventDefault(), o.goTo(o.getPrevStep(), !0);
                        }),
                        KTUtil.addEvent(a.btnFirst, "click", function (t) {
                            t.preventDefault(), o.goTo(o.getFirstStep(), !0);
                        }),
                        KTUtil.addEvent(a.btnLast, "click", function (t) {
                            t.preventDefault(), o.goTo(o.getLastStep(), !0);
                        }),
                ...
                goTo: function (t, e) {
                    if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
                        var n;
                        if (
                            ((t = t ? parseInt(t) : o.getNextStep()),
                            !0 === e &&
                                (n =
                                    t > a.currentStep
                                        ? o.eventTrigger("beforeNext")
                                        : o.eventTrigger("beforePrev")),
                            !0 !== a.stopped)
                        )
                            return (
                                !1 !== n &&
                                    (!0 === e && o.eventTrigger("beforeChange"),
                                    (a.currentStep = t),
                                    o.updateUI(),
                                    !0 === e && o.eventTrigger("change")),
                                !0 === e &&
                                    (t > a.startStep
                                        ? o.eventTrigger("afterNext")
                                        : o.eventTrigger("afterPrev")),
                                a
                            );
                        a.stopped = !1;
                    }
                ...
                updateUI: function () {
                    ...
                    (t = o.isLastStep()
                        ...
                        ? "first"
                        : "between"),
                        KTUtil.attr(a.element, "data-ktwizard-state", t);
                    var n = KTUtil.findAll(
                        a.element,
                        '[data-ktwizard-type="step"]'
                    );
                    if (n && n.length > 0)
...
"undefined" != typeof module &&
    ...
    (function (t) {
        ...
        if (void 0 === a)
            throw new Error(
                "Util class is required and must be included before KTDatatable"
            );
        (t.fn.KTDatatable = function (i) {
            if (0 !== t(this).length) {
                var o = this;
                (o.debug = !1),
                    (o.API = { record: null, value: null, params: null });
                var l = {
                    isInit: !1,
                    cellOffset: 110,
                    iconOffset: 15,
                    ...
                    init: function (e) {
                        ...
                        null === e.data.source && (l.extractTable(), (n = !0)),
                            l.setupBaseDOM.call(),
                            l.setupDOM(o.table),
                            l.setDataSourceQuery(
                                l.getOption("data.source.read.params.query")
                            ),
                            t(o).on(
                            ...
                            t.each(l.getOption("extensions"), function (e, a) {
                                "function" == typeof t.fn.KTDatatable[e] &&
                            ...
                            ("remote" !== e.data.type &&
                                ...
                                ((!1 === e.data.saveState ||
                                    ...
                                    l.stateRemove(l.stateId),
                                "local" === e.data.type &&
                                    "object" == typeof e.data.source &&
                                    (o.dataSet = o.originalDataSet =
                                        l.dataMapCallback(e.data.source)),
                                l.dataRender()),
                            n &&
                                (t(o.tableHead).find("tr").remove(),
                                t(o.tableFoot).find("tr").remove()),
                            l.setHeadTitle(),
                            l.getOption("layout.footer") &&
                                l.setHeadTitle(o.tableFoot),
                            void 0 !== e.layout.header &&
                                !1 === e.layout.header &&
                                t(o.table).find("thead").remove(),
                            void 0 !== e.layout.footer &&
                                !1 === e.layout.footer &&
                                t(o.table).find("tfoot").remove(),
                            (null !== e.data.type && "local" !== e.data.type) ||
                                (l.setupCellField.call(),
                        ...
                        return (
                            t(window).resize(function () {
                                i || ((a = t(this).width()), (i = !0)),
                                    t(this).width() !== a &&
                                        ((a = t(this).width()), l.fullRender());
                            }),
                            t(o).height(""),
                            t(l.getOption("search.input")).on(
                                "keyup",
                                function (e) {
                                    (l.getOption("search.onEnter") &&
                                        13 !== e.which) ||
                                        l.search(t(this).val());
                                }
                            ),
                    ...
                    extractTable: function () {
                        ...
                        t(o)
                            .find("tr")
                            .each(function () {
                                t(this).find("td").length &&
                                    l.push(t(this).prop("attributes"));
                                var e = {};
                                t(this)
                                    .find("td")
                                    .each(function (t, a) {
                    ...
                    layoutUpdate: function () {
                        l.setupSubDatatable.call(),
                            ...
                            l.isInit ||
                                (l.dropdownFix(),
                                t(o).trigger("kt-datatable--on-init", {
                                    table: t(o.wrap).attr("id"),
                                    options: i,
                                }),
                                (l.isInit = !0)),
                            t(o).trigger("kt-datatable--on-layout-updated", {
                                table: t(o.wrap).attr("id"),
                            });
                    },
                    dropdownFix: function () {
                        ...
                        t("body")
                            .on(
                                "show.bs.dropdown",
                                ".kt-datatable .kt-datatable__body",
                                function (a) {
                            ...
                            enable: function () {
                                t(o.table)
                                    ...
                                    .each(function () {
                                        var a = this;
                                        0 ===
                                            t(this).find(".kt-datatable__lock")
                                                .length &&
                    ...
                    fullRender: function () {
                        t(o.tableHead).empty(),
                            ...
                            l.getOption("layout.footer") &&
                                ...
                                l.setHeadTitle(o.tableFoot)),
                            l.spinnerCallback(!0),
                            t(o.wrap).removeClass("kt-datatable--loaded"),
                            l.insertData();
                    },
                    lockEnabledColumns: function () {
                        ...
                        return (
                            t.each(n, function (t, n) {
                                void 0 !== n.locked &&
                                    (void 0 !== n.locked.left &&
                                        a.getBreakpoint(n.locked.left) <= e &&
                                        o.left.push(n.locked.left),
                                    void 0 !== n.locked.right &&
                                        a.getBreakpoint(n.locked.right) <= e &&
                                        o.right.push(n.locked.right));
                            }),
                            o
                        );
                    },
                    afterRender: function (e, a) {
                        t(o).ready(function () {
                            l.isLocked() && l.redraw(),
                                ...
                                t(o.wrap).addClass("kt-datatable--loaded"),
                                l.spinnerCallback(!1);
                        });
                    },
                    hoverTimer: 0,
                    ...
                    adjustLockContainer: function () {
                        ...
                        var e = t(o.tableHead).width(),
                            a = t(o.tableHead)
                                .find(".kt-datatable__lock--left")
                                .width(),
                            n = t(o.tableHead)
                                .find(".kt-datatable__lock--right")
                                .width();
                        void 0 === a && (a = 0), void 0 === n && (n = 0);
                        var i = Math.floor(e - a - n);
                        return (
                            t(o.table)
                                .find(".kt-datatable__lock--scroll")
                                .css("width", i),
                            i
                        );
                    },
                    ...
                    initHeight: function () {
                        if (i.layout.height && i.layout.scroll) {
                            ...
                            e > 0 && (n -= e),
                                a > 0 && (n -= a),
                                (n -= 2),
                                t(o.tableBody).css("max-height", n),
                                t(o.tableBody)
                                    .find(".kt-datatable__lock--scroll")
                                    .css("height", n);
                        }
                    ...
                    setupBaseDOM: function () {
                        (o.initialDatatable = t(o).clone()),
                            "TABLE" === t(o).prop("tagName")
                                ? ((o.table = t(o)
                                      .removeClass("kt-datatable")
                                      .addClass("kt-datatable__table")),
                                  0 ===
                                      t(o.table).parents(".kt-datatable")
                                          .length &&
                                      (o.table.wrap(
                                          t("<div/>")
                                              .addClass("kt-datatable")
                                              .addClass(
                                                  "kt-datatable--" +
                                                      i.layout.theme
                                              )
                                      ),
                                      (o.wrap = t(o.table).parent())))
                                : ((o.wrap = t(o)
                                      .addClass("kt-datatable")
                                      .addClass(
                                          "kt-datatable--" + i.layout.theme
                                      )),
                                  (o.table = t("<table/>")
                                      .addClass("kt-datatable__table")
                                      .appendTo(o))),
                            void 0 !== i.layout.class &&
                                t(o.wrap).addClass(i.layout.class),
                            t(o.table)
                                .removeClass("kt-datatable--destroyed")
                                .css("display", "block"),
                            void 0 === t(o).attr("id") &&
                                (l.setOption("data.saveState", !1),
                                t(o.table).attr(
                                    "id",
                                    a.getUniqueID("kt-datatable--")
                                )),
                            l.getOption("layout.minHeight") &&
                                t(o.table).css(
                                    "min-height",
                                    l.getOption("layout.minHeight")
                                ),
                            l.getOption("layout.height") &&
                                t(o.table).css(
                                    "max-height",
                                    l.getOption("layout.height")
                                ),
                            null === i.data.type &&
                                t(o.table).css("width", "").css("display", ""),
                            (o.tableHead = t(o.table).find("thead")),
                            0 === t(o.tableHead).length &&
                                (o.tableHead = t("<thead/>").prependTo(
                                    o.table
                                )),
                            (o.tableBody = t(o.table).find("tbody")),
                            0 === t(o.tableBody).length &&
                                (o.tableBody = t("<tbody/>").appendTo(o.table)),
                            void 0 !== i.layout.footer &&
                                i.layout.footer &&
                                ((o.tableFoot = t(o.table).find("tfoot")),
                                0 === t(o.tableFoot).length &&
                                    (o.tableFoot = t("<tfoot/>").appendTo(
                                        o.table
                                    )));
                    },
                        ...
                        if (
                            ...
                            var a = function (a) {
                                ...
                                if (
                                    ...
                                    var o = t("<label/>")
                                        .addClass(
                                            "kt-checkbox kt-checkbox--single kt-checkbox--all"
                                        )
                                        .append(
                                            t("<input/>")
                                                .attr("type", "checkbox")
                                        ...
                                        .append("&nbsp;<span></span>");
                                    void 0 !== n.selector.class &&
                                        t(o).addClass(n.selector.class),
                                        t(i).children().html(o);
                                }
                            };
                            i.layout.header &&
                                        ...
                                        if (void 0 !== r)
                                            if ("auto" === r) {
                                                ...
                                                if (l.maxWidthList[s])
                                                    ...
                                                    var d = t(o.table).find(
                                                        '.kt-datatable__cell[data-field="' +
                                                            s +
                                                            '"]'
                                                    );
                                                    i = l.maxWidthList[s] =
                        ...
                        t.each(t(o.table).children(), function (e, a) {
                            for (
                                var n = t(a)
                                        ...
                                        .first()
                                        .parent()
                                        .find(".kt-datatable__row").length,
                                    i = 1;
                                i <= n;
                                i++
                            ) {
                                var o = t(a).find(
                                    ".kt-datatable__row:nth-child(" + i + ")"
                                );
                                if (t(o).length > 0) {
                    ...
                    setupDOM: function (e) {
                        t(e).find("> thead").addClass("kt-datatable__head"),
                            t(e).find("> tbody").addClass("kt-datatable__body"),
                            t(e).find("> tfoot").addClass("kt-datatable__foot"),
                            t(e).find("tr").addClass("kt-datatable__row"),
                            t(e)
                                .find("tr > th, tr > td")
                                .addClass("kt-datatable__cell"),
                            t(e)
                                .find("tr > th, tr > td")
                                .each(function (e, a) {
                        ...
                        var e = {
                            ...
                            init: function () {
                                ...
                                if (i.layout.scroll) {
                                    ...
                                    var r = t(o.tableBody).find(
                                        ".kt-datatable__lock--scroll"
                                    );
                                    t(r).find(".kt-datatable__row").length >
                                        0 && t(r).length > 0
                                        ? ((e.scrollHead = t(o.tableHead).find(
                                              "> .kt-datatable__lock--scroll > .kt-datatable__row"
                                          )),
                                          (e.scrollFoot = t(o.tableFoot).find(
                                              "> .kt-datatable__lock--scroll > .kt-datatable__row"
                                          )),
                                          (e.tableLocked = t(o.tableBody).find(
                                              ".kt-datatable__lock:not(.kt-datatable__lock--scroll)"
                                          )),
                                          l.getOption(
                                              "layout.customScrollbar"
                                          ) &&
                                          10 != a.detectIE() &&
                                          n > a.getBreakpoint("lg")
                                              ? e.initCustomScrollbar(r[0])
                                              : e.initDefaultScrollbar(r))
                                        : t(o.tableBody).find(
                                              ".kt-datatable__row"
                                          ).length > 0 &&
                                          ((e.scrollHead = t(o.tableHead).find(
                                          ...
                                          10 != a.detectIE() &&
                                          n > a.getBreakpoint("lg")
                                              ? e.initCustomScrollbar(
                                                    o.tableBody
                                                )
                                              : e.initDefaultScrollbar(
                                                    o.tableBody
                                                ));
                                }
                            },
                        ...
                        void 0 === r &&
                            ...
                            t.each(n, function (e, n) {
                                ...
                                if (
                                    ...
                                    var l =
                                        void 0 !== o.textAlign[n.textAlign]
                    ...
                    dataRender: function (e) {
                        ...
                        "local" === i.data.type ||
                        (!1 === i.data.serverSorting && "sort" === e) ||
                        (!1 === i.data.serverFiltering && "search" === e)
                            ? setTimeout(function () {
                                  n(), l.setAutoColumns();
                              })
                            : l.getData().done(n);
                    ...
                    insertData: function () {
                        ...
                        var e = l.getDataSourceParam(),
                            ...
                            d = {};
                        void 0 !== i.data.attr.rowProps &&
                            i.data.attr.rowProps.length &&
                            (d = i.data.attr.rowProps.slice(r, s));
                        var c = document.createElement("tbody");
                        c.style.visibility = "hidden";
                        var u = i.columns.length;
                        if (
                            (t.each(o.dataSet, function (n, r) {
                                ...
                                for (var p = 0; p < u; p += 1) {
                                    ...
                                    if (
                                        ...
                                        var h =
                                            void 0 !== o.textAlign[f.textAlign]
                                    ...
                                    a.addClass(m, g.join(" ")),
                                        m.setAttribute("data-field", f.field),
                                        void 0 !== f.autoHide &&
                                            (!0 !== f.autoHide
                                                ? m.setAttribute(
                                                      "data-autohide-disabled",
                                        ...
                                        (m.innerHTML = l.getObject(f.field, r)),
                                        s.appendChild(m);
                                }
                                c.appendChild(s);
                            }),
                            ...
                            a.addClass(p, "kt-datatable--error"),
                                (p.innerHTML = l.getOption(
                                    "translate.records.noRecords"
                                )),
                                c.appendChild(p),
                                t(o.wrap).addClass(
                                    "kt-datatable--error kt-datatable--loaded"
                                ),
                                l.spinnerCallback(!1);
                        }
                    ...
                    getData: function () {
                        var e = {
                            ...
                            data: {},
                            timeout:
                                l.getOption("data.source.read.timeout") || 3e4,
                        };
                        if (
                            ("local" === i.data.type && (e.url = i.data.source),
                            "remote" === i.data.type)
                        ) {
                            var a = l.getDataSourceParam();
                            l.getOption("data.serverPaging") ||
                                delete a.pagination,
                                l.getOption("data.serverSorting") ||
                                    delete a.sort,
                                (e.data = t.extend(
                                    {},
                                    e.data,
                                ...
                                "string" !=
                                    typeof (e = t.extend(
                                        {},
                                        e,
                                        l.getOption("data.source.read")
                                    )).url &&
                                    (e.url = l.getOption("data.source.read")),
                                "string" != typeof e.url &&
                                    (e.url = l.getOption("data.source"));
                        }
                        return t
                            .ajax(e)
                            .done(function (e, a, n) {
                                (o.lastResponse = e),
                                    (o.dataSet = o.originalDataSet =
                                        l.dataMapCallback(e)),
                                    l.setAutoColumns(),
                                    t(o).trigger("kt-datatable--on-ajax-done", [
                                        o.dataSet,
                                    ]);
                            })
                            .fail(function (e, a, n) {
                                t(o).trigger("kt-datatable--on-ajax-fail", [e]),
                                    t(o.tableBody).html(
                                        t("<span/>")
                                            .addClass("kt-datatable--error")
                                            .html(
                                                l.getOption(
                                                    "translate.records.noRecords"
                                                )
                    ...
                    paging: function (e, n) {
                        var i = {
                            ...
                            init: function (e) {
                                (i.meta = e),
                                    ...
                                    i.meta.page > i.meta.pages &&
                                        (i.meta.page = i.meta.pages),
                                    (i.paginateEvent =
                                        l.getTablePrefix("paging")),
                                    (i.pager = t(o.table).siblings(
                                        ".kt-datatable__pager"
                                    )),
                                    t(i.pager).hasClass(
                                        "kt-datatable--paging-loaded"
                            ...
                            populate: function () {
                                ...
                                t("<li/>")
                                    ...
                                    t("<li/>")
                                        ...
                                        .appendTo(n),
                                    l.getOption("toolbar.items.info") &&
                                    ...
                                    t.each(
                                        l.getOption("toolbar.layout"),
                                        function (e, a) {
                                            t(i.pagerLayout[a]).appendTo(
                                                i.pager
                                            );
                                        }
                                    );
                                var p = t("<select/>")
                                        .addClass(
                                            "selectpicker kt-datatable__pager-size"
                                        )
                                        .attr(
                                            "title",
                                            l.getOption(
                            ...
                            paste: function () {
                                t.each(
                                    t.unique(l.getOption("toolbar.placement")),
                                    function (e, a) {
                                        "bottom" === a &&
                                            t(i.pager)
                                                .clone(!0)
                            ...
                            updatePerpage: function (e) {
                                e.preventDefault(),
                                    ...
                                    e.originalEvent &&
                                        (i.meta.perpage = parseInt(
                                            t(this).val()
                                        )),
                                    t(i.pager)
                                        .find("select.kt-datatable__pager-size")
                                        .val(i.meta.perpage)
                            ...
                            addPaginateEvent: function (e) {
                                t(o)
                                    .off(i.paginateEvent)
                                    .on(i.paginateEvent, function (e, a) {
                                        l.spinnerCallback(!0),
                                            (i.pager = t(o.table).siblings(
                                                ".kt-datatable__pager"
                                            ));
                                        var n = t(i.pager).find(
                                            ".kt-datatable__pager-nav"
                                        );
                                        t(n)
                                            .find(
                                            ...
                                            t(n)
                                                .find(
                                                    '.kt-datatable__pager-link-number[data-page="' +
                                                        a.page +
                                                        '"]'
                                                )
                                                .addClass(
                                            ...
                                            t(i.pager)
                                                .find(
                                                    "select.kt-datatable__pager-size"
                                                )
                                                .val(a.perpage)
                                                .attr(
                                                    "data-selected",
                            ...
                            updateInfo: function () {
                                var e = Math.max(
                                        i.meta.perpage * (i.meta.page - 1) + 1,
                                        1
                                    ),
                                    a = Math.min(
                                        e + i.meta.perpage - 1,
                                ...
                                t(i.pager)
                                    .find(".kt-datatable__pager-info")
                                    .find(".kt-datatable__pager-detail")
                                    .html(
                                        l.dataPlaceholder(
                                            l.getOption(
                    ...
                    columnHide: function () {
                        ...
                        t.each(i.columns, function (n, i) {
                            if (
                                ...
                                var r = i.field,
                                    s = t.grep(
                                        t(o.table).find(".kt-datatable__cell"),
                                        function (e, a) {
                                            return r === t(e).data("field");
                                        }
                                    );
                                setTimeout(function () {
                                    !1 === l.getObject("visible", i)
                                        ? t(s).hide()
                                        : (a.getBreakpoint(
                                              l.getObject(
                                                  "responsive.hidden",
                    ...
                    setupSubDatatable: function () {
                        ...
                        if (
                            "function" == typeof e &&
                            !(
                                t(o.table).find(".kt-datatable__subtable")
                                    .length > 0
                            )
                        ) {
                            t(o.wrap).addClass("kt-datatable--subtable"),
                            ...
                            var a = function (a) {
                                    ...
                                    0 === t(r).length &&
                                        ...
                                        t(n).hasClass(
                                            ...
                                            t(r).addClass(
                                                "kt-datatable__row-subtable--even"
                                            )),
                                        t(r).toggle();
                                    var s = t(r).find(
                                            ".kt-datatable__subtable"
                                    ...
                                    t(n).hasClass(
                                        ...
                                        ? (t(c).addClass(
                                          ...
                                          t(o).trigger(
                                              "kt-datatable--on-collapse-subtable",
                                              [n]
                                          ))
                                        : (t(c).addClass(
                                              l.getOption(
                                          ...
                                          t(o).trigger(
                                              "kt-datatable--on-expand-subtable",
                                              [n]
                                          )),
                                        0 ===
                                            t(s).find(".kt-datatable").length &&
                                            (t.map(o.dataSet, function (t, e) {
                                                return (
                                                    d ===
                                                        t[i.columns[0].field] &&
                                                    ((a.data = t), !0)
                    ...
                    dataMapCallback: function (t) {
                        var e = t;
                        return "function" ==
                            typeof l.getOption("data.source.read.map")
                            ? l.getOption("data.source.read.map")(t)
                            : (void 0 !== t &&
                                  void 0 !== t.data &&
                                  (e = t.data),
                              e);
                        ...
                        void 0 !== a &&
                            ...
                            (t
                                ? l.isSpinning ||
                                  (void 0 !== a.message &&
                                      !0 === a.message &&
                                      (a.message = l.getOption(
                                          "translate.records.processing"
                                      )),
                                  (l.isSpinning = !0),
                                  void 0 !== n && n.block(e, a))
                                : ((l.isSpinning = !1),
                    ...
                    autoHide: function () {
                        ...
                        var n = function (e) {
                            ...
                            var a = t(this).closest(".kt-datatable__row"),
                                n = t(a).next();
                            if (t(n).hasClass("kt-datatable__row-detail"))
                                t(this)
                                    .find("i")
                                    .removeClass(
                                        l.getOption(
                                ...
                                var o = t(a)
                                    .find(".kt-datatable__cell:hidden")
                                    .clone()
                                    .show();
                                n = t("<tr/>")
                                    .addClass("kt-datatable__row-detail")
                                    .insertAfter(a);
                                var r = t("<td/>")
                                        .addClass("kt-datatable__detail")
                        ...
                        setTimeout(function () {
                            t(o.table).find(".kt-datatable__cell").show(),
                                    ...
                                    for (
                                        ...
                                        t(o.table)
                                            ...
                                            .each(function (a) {
                                                var n = t(this)
                                                    .find(
                                                        ".kt-datatable__cell:not(:hidden):not([data-autohide-disabled])"
                                                    )
                                                    .last();
                                                t(n).hide(), (e = !0);
                                            }),
                    ...
                    setAutoColumns: function () {
                        l.getOption("data.autoColumns") &&
                            (t.each(o.dataSet[0], function (e, a) {
                                0 ===
                                    t.grep(i.columns, function (t, a) {
                                        return e === t.field;
                                    }).length &&
                                    i.columns.push({ field: e, title: e });
                            }),
                            t(o.tableHead).find(".kt-datatable__row").remove(),
                            l.setHeadTitle(),
                            l.getOption("layout.footer") &&
                                (t(o.tableFoot)
                                    .find(".kt-datatable__row")
                    ...
                    isSubtable: function () {
                        return (
                            a.hasClass(o.wrap[0], "kt-datatable--subtable") ||
                            !1
                        );
                    },
                    getExtraSpace: function (e) {
                        return (
                            ...
                            Math.ceil(
                                t(e).css("border-right-width").replace("px", "")
                            )
                        );
                    },
                    ...
                    stateKeep: function (t, e) {
                        (t = l.getTablePrefix(t)),
                            !1 !== l.getOption("data.saveState") &&
                                (l.getOption("data.saveState.webstorage") &&
                                    localStorage &&
                                    localStorage.setItem(t, JSON.stringify(e)),
                                l.getOption("data.saveState.cookie") &&
                    ...
                    getTotalColumns: function (e) {
                        return (
                            ...
                            t(e)
                                .find(".kt-datatable__row")
                                .first()
                                .find(".kt-datatable__cell").length
                        );
                    },
                    getOneRow: function (e, a, n) {
                        void 0 === n && (n = !0);
                        var i = t(e).find(
                            ".kt-datatable__row:not(.kt-datatable__row-detail):nth-child(" +
                                a +
                                ")"
                        );
                    ...
                    sortColumn: function (e, a, n) {
                        ...
                        var i = t(e).index(),
                            ...
                            r = t(e).closest(".kt-datatable__lock").index();
                        -1 !== r &&
                            (l = t(o.tableBody)
                                .find(
                                    ".kt-datatable__lock:nth-child(" +
                                        (r + 1) +
                                        ")"
                                )
                                .find(".kt-datatable__row"));
                        ...
                        var e = {
                            init: function () {
                                i.sortable &&
                                    (t(o.tableHead)
                                        .find(
                                            ".kt-datatable__cell:not(.kt-datatable__cell--check)"
                                        )
                                        .addClass("kt-datatable__cell--sort")
                                        .off("click")
                                        .on("click", e.sortClick),
                                    e.setIcon());
                            },
                            setIcon: function () {
                            ...
                            sortClick: function (n) {
                                ...
                                if (
                                    ...
                                    t(o.tableHead)
                                        .find(".kt-datatable__cell > span > i")
                                        .remove(),
                                    i.sortable)
                                ) {
                                    l.spinnerCallback(!0);
                                    var c = "desc";
                                    l.getObject("field", r) === s &&
                                        (c = l.getObject("sort", r)),
                                        (r = {
                                            field: s,
                                            sort: (c =
                                                void 0 === c || "desc" === c
                    ...
                    localDataUpdate: function () {
                        var e = l.getDataSourceParam();
                        void 0 === o.originalDataSet &&
                            (o.originalDataSet = o.dataSet);
                        var a = l.getObject("sort.field", e),
                            n = l.getObject("sort.sort", e),
                            i = l.getColumnByField(a);
                        if (
                            (void 0 !== i &&
                            !0 !== l.getOption("data.serverSorting")
                                ? "function" == typeof i.sortCallback
                                    ? (o.dataSet = i.sortCallback(
                                          o.originalDataSet,
                                          n,
                                          i
                                      ))
                                    : (o.dataSet = l.sortCallback(
                                          o.originalDataSet,
                                          n,
                                          i
                                      ))
                            ...
                            "object" == typeof e.query &&
                                !l.getOption("data.serverFiltering"))
                        ) {
                            e.query = e.query || {};
                            var r = function (t) {
                                    for (var e in t)
                    ...
                    getDefaultSortColumn: function () {
                        var e;
                        return (
                            t.each(i.columns, function (a, n) {
                                if (
                                    void 0 !== n.sortable &&
                                    -1 !==
                                        t.inArray(n.sortable, ["asc", "desc"])
                                )
                                    return (
                                        (e = {
                                            sort: n.sortable,
                    ...
                    rowEvenOdd: function () {
                        t(o.tableBody)
                            .find(".kt-datatable__row")
                            .removeClass("kt-datatable__row--even"),
                            t(o.wrap).hasClass("kt-datatable--subtable")
                                ? t(o.tableBody)
                                      .find(
                                          ".kt-datatable__row:not(.kt-datatable__row-detail):even"
                                      )
                                      .addClass("kt-datatable__row--even")
                                : t(o.tableBody)
                                      .find(
                        ...
                        return (
                            (function (t, e) {
                                ...
                                i.data.serverFiltering || l.localDataUpdate(),
                                    l.dataRender(),
                                    t(o).trigger("kt-datatable--on-reloaded");
                    ...
                    getRecord: function (e) {
                        return (
                            void 0 === o.tableBody &&
                                (o.tableBody = t(o.table).children("tbody")),
                            t(o.tableBody)
                                .find(".kt-datatable__cell:first-child")
                                .each(function (a, n) {
                                    if (e == t(n).text()) {
                                        var i =
                                            t(n)
                                                ...
                                                .index() + 1;
                                        return (
                                            (o.API.record = o.API.value =
                                                l.getOneRow(o.tableBody, i)),
                                            o
                                        );
                                    }
                                }),
                    ...
                    getColumn: function (e) {
                        return (
                            l.setSelectedRecords(),
                            (o.API.value = t(o.API.record).find(
                                '[data-field="' + e + '"]'
                            )),
                            o
                        );
                    ...
                    destroy: function () {
                        ...
                        var e = t(o.initialDatatable)
                            .addClass("kt-datatable--destroyed")
                            .show();
                        return (
                            t(o).replaceWith(e),
                            t((o = e)).trigger("kt-datatable--on-destroy"),
                            (l.isInit = !1),
                            (e = null)
                        );
                    },
                    sort: function (e, a) {
                        ...
                        return (
                            ...
                            setTimeout(function () {
                                l.dataRender("sort"),
                                    t(o).trigger("kt-datatable--on-sort", n),
                                    t(o.tableHead)
                                        .find(".kt-datatable__cell > span > i")
                                        .remove();
                            }, 300),
                    ...
                    setActive: function (e) {
                        "string" == typeof e &&
                            (e = t(o.tableBody).find(
                                '.kt-checkbox--single > [type="checkbox"][value="' +
                                    e +
                                    '"]'
                            )),
                            t(e).prop("checked", !0);
                        ...
                        t(e).each(function (e, n) {
                            var i = t(n)
                                    .closest("tr")
                                    .addClass("kt-datatable__row--active"),
                                o = t(i).index() + 1;
                            t(i)
                                .closest("tbody")
                                .find("tr:nth-child(" + o + ")")
                                .not(".kt-datatable__row-subtable")
                                .addClass("kt-datatable__row--active");
                    ...
                    setInactive: function (e) {
                        ...
                        t(e).each(function (e, n) {
                            var i = t(n)
                                    .closest("tr")
                                    .removeClass("kt-datatable__row--active"),
                                o = t(i).index() + 1;
                            t(i)
                                .closest("tbody")
                                .find("tr:nth-child(" + o + ")")
                    ...
                    setActiveAll: function (e) {
                        var a = t(o.table)
                            ...
                            .not(".kt-datatable__row-subtable")
                            .find(
                                '.kt-datatable__cell--check [type="checkbox"]'
                            );
                        e ? l.setActive(a) : l.setInactive(a);
                    },
                    setSelectedRecords: function () {
                        return (
                            (o.API.record = t(o.tableBody).find(
                                ".kt-datatable__row--active"
                            )),
                            o
                        );
                        ...
                        void 0 !== a && (a = t.makeArray(a)),
                            (n = function () {
                                ...
                                "object" == typeof a &&
                                    ...
                                    o.setDataSourceParam(
                                        "pagination",
                                        Object.assign(
                                            {},
                                            o.getDataSourceParam("pagination"),
                                            { page: 1 }
                                        )
                                    ),
                                    i.data.serverFiltering ||
                                        l.localDataUpdate(),
                                    l.dataRender("search");
                            }),
                        ...
                        return (
                            l.isLocked()
                                ...
                                : (l.nodeTr = l.recentNode =
                                      t(o.tableBody)
                                          .find(e)
                                          .filter(".kt-datatable__row")),
                            o
                        );
                    },
                    column: function (e) {
                        return (
                            (l.nodeCols = l.recentNode =
                                t(o.tableBody).find(
                                    ".kt-datatable__cell:nth-child(" +
                                        (e + 1) +
                                        ")"
                                )),
                            o
                    ...
                    columns: function (e) {
                        ...
                        var n = t(a).find(
                            '.kt-datatable__cell[data-field="' + e + '"]'
                        );
                        return (
                            n.length > 0
                                ? (l.nodeCols = l.recentNode = n)
                                : (l.nodeCols = l.recentNode =
                                      t(a)
                                          .find(e)
                                          .filter(".kt-datatable__cell")),
                            o
                        );
                    },
                    cell: function (e) {
                    ...
                    visible: function (e) {
                        if (t(l.recentNode.length)) {
                            ...
                            if (l.recentNode === l.nodeCols) {
                                ...
                                if (l.isLocked()) {
                                    var o = t(l.recentNode).closest(
                                        ".kt-datatable__lock--scroll"
                                    ).length;
                                    o
                                        ? (n += a.left.length + 1)
                                        : t(l.recentNode).closest(
                            ...
                            e
                                ? (l.recentNode === l.nodeCols &&
                                      delete i.columns[n - 1].visible,
                                  t(l.recentNode).show())
                                : (l.recentNode === l.nodeCols &&
                                      l.setOption(
                                          "columns." + (n - 1) + ".visible",
                    ...
                    gotoPage: function (t) {
                        void 0 !== l.pagingObject &&
                            ((l.isInit = !0), l.pagingObject.openPage(t));
                    },
                };
                if (
                    ...
                    if ("string" == typeof i) {
                        ...
                        o.data(e) ||
                            t(this).hasClass("kt-datatable--loaded") ||
                            ((o.dataSet = null),
                            (o.textAlign = {
                    ...
                    void 0 === (o = t(this).data(e)) &&
                        t.error("KTDatatable not initialized"),
                        (i = o.options);
                return o;
            }
                ...
                var n = {
                    ...
                    init: function () {
                        n.selectorEnabled() &&
                            ...
                            a.vars.requestIds &&
                                e.setDataSourceParam(a.vars.requestIds, !0),
                            t(e).on("kt-datatable--on-reloaded", function () {
                                e.stateRemove("checkbox"),
                                    e.setDataSourceParam(
                    ...
                    initEvent: function () {
                        t(e.tableHead)
                            .find('.kt-checkbox--all > [type="checkbox"]')
                            .click(function (i) {
                                if (
                                ...
                                e.setDataSourceParam(
                                    ...
                                    t(e).trigger(
                                        "kt-datatable--on-click-checkbox",
                                        [t(this)]
                                    );
                            }),
                            t(e.tableBody)
                                ...
                                .click(function (i) {
                                    var o = t(this).val();
                                    t(this).is(":checked")
                                        ? (n.selectedRows.push(o),
                                          (n.unselectedRows = n.remove(
                                              n.unselectedRows,
                                              o
                                          )))
                                        : (n.unselectedRows.push(o),
                                          (n.selectedRows = n.remove(
                                              n.selectedRows,
                                              o
                                          ))),
                                        !a.vars.requestIds &&
                                            ...
                                            t(e.tableHead)
                                                .find(
                                                    '.kt-checkbox--all > [type="checkbox"]'
                                                )
                                                .prop("checked", !1);
                                    var l = {};
                                    (l.selectedRows = t.unique(n.selectedRows)),
                                        (l.unselectedRows = t.unique(
                                            n.unselectedRows
                                        )),
...
var KTChat = (function () {
        ...
        if (e) {
            KTUtil.scrollInit(e, {
                ...
                height: function () {
                    ...
                    if (KTUtil.isInResponsiveRange("tablet-and-mobile"))
                        return KTUtil.hasAttr(e, "data-mobile-height")
                            ? parseInt(KTUtil.attr(e, "data-mobile-height"))
                            : 300;
                    if (
                        KTUtil.isInResponsiveRange("desktop") &&
                        KTUtil.hasAttr(e, "data-height")
                    )
                        return parseInt(KTUtil.attr(e, "data-height"));
                    ...
                    return (
                        (a = KTUtil.isInResponsiveRange("desktop")
                            ? KTLayout.getContentHeight()
                            : KTUtil.getViewPort().height),
                        n &&
                            (a =
                                (a =
                                    a -
                                    parseInt(KTUtil.css(n, "margin-top")) -
                                    parseInt(KTUtil.css(n, "margin-bottom"))) -
                                parseInt(KTUtil.css(n, "padding-top")) -
                                parseInt(KTUtil.css(n, "padding-bottom"))),
                        i &&
                            (a =
                                (a -= parseInt(KTUtil.css(i, "height"))) -
                                parseInt(KTUtil.css(i, "margin-top")) -
                                parseInt(KTUtil.css(i, "margin-bottom"))),
                        o &&
                            (a =
                                (a =
                                    a -
                                    parseInt(KTUtil.css(o, "margin-top")) -
                                    parseInt(KTUtil.css(o, "margin-bottom"))) -
                                parseInt(KTUtil.css(o, "padding-top")) -
                                parseInt(KTUtil.css(o, "padding-bottom"))),
                        l &&
                            (a =
                                (a -= parseInt(KTUtil.css(l, "height"))) -
                                parseInt(KTUtil.css(l, "margin-top")) -
                                parseInt(KTUtil.css(l, "margin-bottom"))),
                        (a -= 5)
                    );
                },
            });
            var a = function () {
                ...
                if (0 !== n.value.length) {
                    ...
                    var o,
                        l =
                            '<div class="kt-chat__user"><span class="kt-chat__datetime">Just now</span><a href="#" class="kt-chat__username">Jason Muller</span></a><span class="kt-media kt-media--circle kt-media--sm"><img src="./assets/media/users/100_12.jpg" alt="image"></span></div><div class="kt-chat__text kt-bg-light-brand">' +
                            n.value;
                    KTUtil.setHTML(i, l),
                        a.appendChild(i),
                        (n.value = ""),
                        (e.scrollTop = parseInt(KTUtil.css(a, "height"))),
                        (o = KTUtil.data(e).get("ps")) && o.update(),
                        setTimeout(function () {
    ...
    return {
        init: function () {
            t(KTUtil.getByID("kt_chat_modal")),
                ("keenthemes.com" != encodeURI(window.location.hostname) &&
                    ...
                    setTimeout(function () {
                        if (!Cookies.get("kt_app_chat_shown")) {
                            ...
                            Cookies.set("kt_app_chat_shown", 1, { expires: t }),
                                KTUtil.getByID(
                                    "kt_app_chat_launch_btn"
                                ).click();
                        }
                    }, 2e3);
        },
...
"undefined" != typeof module && (module.exports = KTChat),
    KTUtil.ready(function () {
        KTChat.init();
    });
                ...
                (function () {
                    ...
                    KTUtil.scrollInit(n, {
                        ...
                        height: function () {
                            ...
                            return (
                                a &&
                                    ((e -= parseInt(KTUtil.actualHeight(a))),
                                    (e -= parseInt(
                                        KTUtil.css(a, "marginBottom")
                                    ))),
                                (e -= parseInt(KTUtil.css(t, "paddingTop"))),
                                (e -= parseInt(KTUtil.css(t, "paddingBottom")))
                            );
                        },
                    }),
                        void 0 !== e &&
...
var KTLayout = (function () {
    var t,
        ...
        r = function () {
            return new KTPortlet("kt_page_portlet", {
                sticky: {
                    offset: parseInt(
                        KTUtil.css(KTUtil.get("kt_header"), "height")
                    ),
                    zIndex: 90,
                    position: {
                        top: function () {
                            ...
                            return (
                                KTUtil.isInResponsiveRange("desktop")
                                    ? (KTUtil.hasClass(t, "kt-header--fixed") &&
                                          (e += parseInt(
                                              KTUtil.css(
    ...
    return {
        ...
        initHeader: function () {
            var t, n, i;
            (n = KTUtil.get("kt_header")),
                (i = {
                    classic: { desktop: !0, mobile: !1 },
                    offset: {},
                    minimize: {
                ...
                (t = KTUtil.attr(n, "data-ktheader-minimize-offset")) &&
                    (i.offset.desktop = t),
                (t = KTUtil.attr(n, "data-ktheader-minimize-mobile-offset")) &&
                    (i.offset.mobile = t),
                new KTHeader("kt_header", i),
                (a = new KTOffcanvas("kt_header_menu_wrapper", {
                    overlay: !0,
                ...
                new KTScrolltop("kt_scrolltop", { offset: 300, speed: 600 });
        },
        initAside: function () {
            var a, r, s, d, c, u, p;
            (s = KTUtil.get("kt_aside")),
                KTUtil.get("kt_aside_brand"),
                (d = KTUtil.hasClass(s, "kt-aside--offcanvas-default")
                    ? "kt-aside--offcanvas-default"
                    : "kt-aside"),
                (i = new KTOffcanvas("kt_aside", {
                    baseClass: d,
                    overlay: !0,
                ...
                KTUtil.hasClass(t, "kt-aside--fixed") &&
                    (KTUtil.addEvent(s, "mouseenter", function (e) {
                        e.preventDefault(),
                            !1 !== KTUtil.isInResponsiveRange("desktop") &&
                                (r && (clearTimeout(r), (r = null)),
                                (a = setTimeout(function () {
                                    KTUtil.hasClass(t, "kt-aside--minimize") &&
                                        KTUtil.isInResponsiveRange("desktop") &&
                                        (KTUtil.removeClass(
                                            t,
                                            "kt-aside--minimize"
                                        ...
                                        KTUtil.transitionEnd(t, function () {
                                            KTUtil.removeClass(
                                                t,
                                                "kt-aside--minimizing"
                                            );
                ...
                (u = KTUtil.get("kt_aside_menu")),
                (p =
                    "1" === KTUtil.attr(u, "data-ktmenu-dropdown")
                        ? "dropdown"
                        : "accordion"),
                "1" === KTUtil.attr(u, "data-ktmenu-scroll") &&
                    (c = {
                        rememberPosition: !0,
                        height: function () {
                            var t;
                            return (
                                (t = KTUtil.isInResponsiveRange("desktop")
                                    ? parseInt(KTUtil.getViewPort().height) -
                                      parseInt(
                                          KTUtil.actualHeight("kt_aside_brand")
                                      ) -
                                      parseInt(
                                ...
                                (t -=
                                    parseInt(KTUtil.css(u, "marginBottom")) +
                                    parseInt(KTUtil.css(u, "marginTop")))
                            );
                        },
                    }),
                ...
                KTUtil.get("kt_aside_toggler") &&
                    ((o = new KTToggle("kt_aside_toggler", {
                        target: "body",
                        targetState: "kt-aside--minimize",
                        togglerState: "kt-aside__brand-aside-toggler--active",
                    })).on("toggle", function (a) {
                        KTUtil.addClass(t, "kt-aside--minimizing"),
                            KTUtil.get("kt_page_portlet") && l.updateSticky(),
                            KTUtil.transitionEnd(t, function () {
                                KTUtil.removeClass(t, "kt-aside--minimizing");
                            }),
                            e.pauseDropdownHover(800),
                            n.pauseDropdownHover(800),
                            Cookies.set("kt_aside_toggle_state", a.getState());
                    }),
                    o.on("beforeToggle", function (t) {
                        var e = KTUtil.get("body");
                        !1 === KTUtil.hasClass(e, "kt-aside--minimize") &&
                            KTUtil.hasClass(e, "kt-aside--minimize-hover") &&
                            KTUtil.removeClass(e, "kt-aside--minimize-hover");
                    })),
        ...
        getContentHeight: function () {
            return (
                ...
                KTUtil.getByID("kt_header") &&
                    (t -= KTUtil.actualHeight("kt_header")),
                KTUtil.getByID("kt_subheader") &&
                    (t -= KTUtil.actualHeight("kt_subheader")),
                KTUtil.getByID("kt_footer") &&
                    (t -= parseInt(KTUtil.css("kt_footer", "height"))),
                KTUtil.getByID("kt_content") &&
                    (t =
                        t -
...
"undefined" != typeof module && (module.exports = KTLayout),
    $(document).ready(function () {
        KTLayout.init();
    });
var KTOffcanvasPanel = (function () {
    ...
    return {
        init: function () {
            (t = KTUtil.get("kt_offcanvas_toolbar_notifications")),
                ...
                (function () {
                    ...
                    new KTOffcanvas(t, {
                        ...
                        toggleBy:
                            "kt_offcanvas_toolbar_notifications_toggler_btn",
                    });
                    KTUtil.scrollInit(a, {
                        disableForMobile: !0,
                        resetHeightOnDestroy: !0,
                        ...
                        height: function () {
                            ...
                            return (
                                e &&
                                    ((a -= parseInt(KTUtil.actualHeight(e))),
                                    (a -= parseInt(
                                        KTUtil.css(e, "marginBottom")
                                    ))),
                                (a -= parseInt(KTUtil.css(t, "paddingTop"))),
                                (a -= parseInt(KTUtil.css(t, "paddingBottom")))
                            );
                        },
                    });
                })(),
                (function () {
                    ...
                    KTUtil.scrollInit(a, {
                        ...
                        height: function () {
                            ...
                            return (
                                t &&
                                    ((a -= parseInt(KTUtil.actualHeight(t))),
                                    (a -= parseInt(
                                        KTUtil.css(t, "marginBottom")
                                    ))),
                                (a -= parseInt(KTUtil.css(e, "paddingTop"))),
                                (a -= parseInt(KTUtil.css(e, "paddingBottom")))
                            );
                        },
                    });
                })(),
                (function () {
                    ...
                    KTUtil.scrollInit(e, {
                        ...
                        height: function () {
                            ...
                            return (
                                t &&
                                    ((e -= parseInt(KTUtil.actualHeight(t))),
                                    (e -= parseInt(
                                        KTUtil.css(t, "marginBottom")
                                    ))),
                ...
                (function () {
                    var t = KTUtil.find(n, ".kt-offcanvas-panel__head"),
                        e =
                            (KTUtil.find(n, ".kt-offcanvas-panel__body"),
                            KTUtil.get("kt_quick_search_offcanvas")),
                        a = KTUtil.find(e, ".kt-quick-search__form"),
                        i = KTUtil.find(e, ".kt-quick-search__wrapper");
                    new KTOffcanvas(n, {
                        overlay: !0,
                        baseClass: "kt-offcanvas-panel",
                    ...
                    KTUtil.scrollInit(i, {
                        ...
                        height: function () {
                            ...
                            return (
                                (e -= parseInt(KTUtil.actualHeight(a))),
                                (e -= parseInt(KTUtil.css(a, "marginBottom"))),
                                t &&
                                    ((e -= parseInt(KTUtil.actualHeight(t))),
                                    (e -= parseInt(
                                        KTUtil.css(t, "marginBottom")
...
var KTQuickSearch = function () {
        var t,
            ...
            h = function () {
                l &&
                    !KTUtil.hasClass(o, "show") &&
                    ($(l).dropdown("toggle"), $(l).dropdown("update"));
            },
            m = function () {
            ...
            v = function () {
                if (d && s === a.value)
                    return (
                        ...
                        KTUtil.addClass(t, f),
                        h(),
                        void KTUtil.scrollUpdate(i)
                    );
                (s = a.value),
                    KTUtil.removeClass(t, f),
                    (u = !0),
                    KTUtil.addClass(r, p),
                    n && KTUtil.hide(n),
                    m(),
        ...
        return {
            init: function (s) {
                (t = s),
                    ...
                    (a = KTUtil.find(t, ".kt-quick-search__input")),
                    (n = KTUtil.find(t, ".kt-quick-search__close")),
                    (i = KTUtil.find(t, ".kt-quick-search__wrapper")),
                    (o = KTUtil.find(t, ".dropdown-menu")),
                    (l = KTUtil.find(t, '[data-toggle="dropdown"]')),
                    (r = KTUtil.find(t, ".input-group")),
                    KTUtil.addEvent(a, "keyup", k),
                    KTUtil.addEvent(a, "focus", k),
...
KTUtil.ready(function () {
    KTUtil.get("kt_quick_search_dropdown") &&
