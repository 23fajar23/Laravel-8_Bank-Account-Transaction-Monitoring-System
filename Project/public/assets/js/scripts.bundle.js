...
var KTApp = (function () {
    ...
    return {
        ...
        progress: function (target, options) {
            ...
            var size =
                options && options.size ? " kt-spinner--" + options.size : "";
            var classes =
                "kt-spinner " +
                "kt-spinner--" +
                skin +
    ...
    var Plugin = {
        ...
        getSubmenuMode: function (el) {
            if (KTUtil.isInResponsiveRange("desktop")) {
                if (
                    el &&
                    KTUtil.hasAttr(el, "data-ktmenu-submenu-toggle") &&
                    KTUtil.attr(el, "data-ktmenu-submenu-toggle") == "hover"
                ) {
                    return "dropdown";
                }
        ...
        handleSubmenuDropdownClose: function (e, el) {
            ...
            var shown = element.querySelectorAll(
                ".kt-menu__item.kt-menu__item--submenu.kt-menu__item--hover:not(.kt-menu__item--tabs)"
            );

            // check if currently clicked link's parent item ha
            if (
                shown.length > 0 &&
                KTUtil.hasClass(el, "kt-menu__toggle") === false &&
                el.querySelectorAll(".kt-menu__toggle").length === 0
            ) {
        ...
        handleSubmenuAccordion: function (e, el) {
            ...
            if (
                ...
                (query = item.closest(".kt-menu__item"))
            ) {
                if (
                    query.getAttribute("data-ktmenu-submenu-mode") !=
                    "accordion"
                ) {
                    e.preventDefault();
                    return;
            ...
            var submenu = KTUtil.child(
                li,
                ".kt-menu__submenu, .kt-menu__inner"
            );

            if (
                KTUtil.hasClass(
                    item.closest(".kt-menu__item"),
                    "kt-menu__item--open-always"
                )
            ) {
                return;
            }
            ...
            if (li && submenu) {
                ...
                if (KTUtil.hasClass(li, "kt-menu__item--open") === false) {
                    ...
                    if (the.options.accordion.expandAll === false) {
                        var subnav = item.closest(
                            ".kt-menu__nav, .kt-menu__subnav"
                        );
        ...
        scrollToItem: function (item) {
            ...
            if (
                ...
                element.getAttribute("data-ktmenu-scroll") !== "1"
            ) {
        ...
        hideSubmenuDropdown: function (item, classAlso) {
            ...
            if (item.getAttribute("data-ktmenu-dropdown-toggle-class")) {
                KTUtil.removeClass(
                    body,
                    item.getAttribute("data-ktmenu-dropdown-toggle-class")
                );
            }
        ...
        showSubmenuDropdown: function (item) {
            ...
            var list = element.querySelectorAll(
                ".kt-menu__item--submenu.kt-menu__item--hover, .kt-menu__item--submenu.kt-menu__item--active-tab"
            );
        ...
        createSubmenuDropdownClickDropoff: function (el) {
            var query;
            var zIndex =
                (query = KTUtil.child(el, ".kt-menu__submenu")
        ...
        getBreadcrumbs: function (item) {
            ...
            breadcrumbs.push({
                text: (query = KTUtil.child(link, ".kt-menu__link-text")
                    ? query.innerHTML
                    : ""),
        ...
        getPageTitle: function (item) {
            ...
            return (query = KTUtil.child(item, ".kt-menu__link-text")
                ? query.innerHTML
                : "");
        },
        ...
        data: function (element) {
            ...
            return {
                ...
                has: function (name) {
                    ...
                    return window.KTUtilElementDataStore[
                        element.customDataTag
                    ] &&
                        window.KTUtilElementDataStore[element.customDataTag][
                            name
                        ]
                ...
                remove: function (name) {
                    if (element && this.has(name)) {
                        delete window.KTUtilElementDataStore[
                            element.customDataTag
                        ][name];
                    }
                },
            ...
            function init() {
                ...
                if (ps) {
                    ...
                    ps = new PerfectScrollbar(element, {
                        ...
                        swipeEasing: true,
                        wheelPropagation:
                            options.windowScroll === false ? false : true,
                        minScrollbarLength: 40,
                        maxScrollbarLength: 300,
                        suppressScrollX:
                            KTUtil.attr(element, "data-scroll-x") != "true"
                                ? true
                                : false,
                    });
        ...
        var Plugin = {
                ...
                if (
                    ...
                    if (
                        ...
                        datatable.dataSet = datatable.originalDataSet =
                            Plugin.dataMapCallback(options.data.source);
                    }
                    Plugin.dataRender();
                }
            ...
            dropdownFix: function () {
                ...
                $("body")
                    .on(
                        "show.bs.dropdown",
                        "." + pfx + "datatable ." + pfx + "datatable__body",
                        function (e) {
                            dropdownMenu = $(e.target).find(".dropdown-menu");
                            $("body").append(dropdownMenu.detach());
                            dropdownMenu.css("display", "block");
                ...
                var lock = {
                    ...
                    enable: function () {
                        var enableLock = function (tablePart) {
                            ...
                            if (
                                $(tablePart).find("." + pfx + "datatable__lock")
                                    .length > 0
                            ) {
                                Plugin.log(
                            ...
                            if (
                                $(tablePart).find("." + pfx + "datatable__row")
                                    .length === 0
                            ) {
            ...
            setupTemplateCell: function (tablePart) {
                ...
                $(tablePart)
                    ...
                    .each(function (tri, tr) {
                        ...
                        var afterTemplate =
                            Plugin.getOption("rows.afterTemplate");
                ...
                var scroll = {
                    ...
                    init: function () {
                        ...
                        if (options.layout.scroll) {
                            ...
                            if (
                                $(scrollable).find("." + pfx + "datatable__row")
                                    .length > 0 &&
                                $(scrollable).length > 0
                            ) {
            ...
            getData: function () {
                ...
                return $.ajax(ajaxParams)
                    .done(function (response, textStatus, jqXHR) {
                        ...
                        datatable.dataSet = datatable.originalDataSet =
                            Plugin.dataMapCallback(response);
                        Plugin.setAutoColumns();
                ...
                var pg = {
                    ...
                    populate: function () {
                        ...
                        var pageSizeSelect = $("<select/>")
                            .addClass(
                                "selectpicker " + pfx + "datatable__pager-size"
                            )
                            .attr(
                                "title",
                                Plugin.getOption(
                    ...
                    gotoPage: function (e) {
                        ...
                        if (
                            $(this).hasClass(
                                pfx + "datatable__pager-link--active"
                            )
                        )
                            return;
                    ...
                    paginationUpdate: function () {
                        ...
                        if (pg.meta.page === 1) {
                            $(pagerFirst)
                                .attr("disabled", true)
                                .addClass(
                                    pfx + "datatable__pager-link--disabled"
                                );
                            $(pagerPrev)
                                .attr("disabled", true)
                                .addClass(
            ...
            setupSubDatatable: function () {
                ...
                if (
                    $(datatable.table).find("." + pfx + "datatable__subtable")
                        .length > 0
                )
                    return;
                ...
                var toggleSubTable = function (e) {
                    ...
                    if ($(subTableRow).length === 0) {
                        ...
                        if (
                            $(parentRow).hasClass(pfx + "datatable__row--even")
                        ) {
                            $(subTableRow).addClass(
                                pfx + "datatable__row-subtable--even"
                            );
                        }
                    }
                    ...
                    if (
                        $(parentRow).hasClass(
                            pfx + "datatable__row--subtable-expanded"
                        )
                    ) {
                        $(icon).addClass(
                                ...
                                .each(function (i) {
                                    var cell = $(this)
                                        .find(
                                            "." +
                                                pfx +
                                                "datatable__cell:not(:hidden):not([data-autohide-disabled])"
                                        )
                                        .last();
                                    $(cell).hide();
                                    hiddenExist = true;
                                    ...
                                    $(datatable.tableHead)
                                        ...
                                        .prepend(
                                            '<th class="' +
                                                ...
                                                "datatable__cell " +
                                                pfx +
                                                'datatable__toggle-detail"><span></span></th>'
                                        );
                                    $(datatable.tableFoot)
                                        .find("." + pfx + "datatable__row")
                                        .first()
            ...
            stateKeep: function (key, value) {
                ...
                if (
                    Plugin.getOption("data.saveState.webstorage") &&
                    localStorage
                ) {
                        ...
                        if (id == $(cell).text()) {
                            var rowNumber =
                                $(cell)
                                    .closest("." + pfx + "datatable__row")
                                    .index() + 1;
                            datatable.API.record = datatable.API.value =
                                Plugin.getOneRow(
                                    datatable.tableBody,
                                    rowNumber
                                );
            ...
            setActiveAll: function (active) {
                var checkboxes = $(datatable.table)
                    ...
                    .not("." + pfx + "datatable__row-subtable")
                    .find(
                        "." + pfx + 'datatable__cell--check [type="checkbox"]'
                    );
                if (active) {
...
var KTChat = (function () {
    var initChat = function (parentEl) {
        ...
        KTUtil.scrollInit(messageListEl, {
            ...
            height: function () {
                ...
                if (KTUtil.isInResponsiveRange("tablet-and-mobile")) {
                    return KTUtil.hasAttr(messageListEl, "data-mobile-height")
                        ? parseInt(
                              KTUtil.attr(messageListEl, "data-mobile-height")
                          )
                        : 300;
                }
                ...
                if (
                    KTUtil.isInResponsiveRange("desktop") &&
                    KTUtil.hasAttr(messageListEl, "data-height")
                ) {
                    return parseInt(KTUtil.attr(messageListEl, "data-height"));
                }

                var chatEl = KTUtil.find(parentEl, ".kt-chat");
                var portletHeadEl = KTUtil.find(
                    parentEl,
                    ".kt-portlet > .kt-portlet__head"
                );
                var portletBodyEl = KTUtil.find(
                    parentEl,
                    ".kt-portlet > .kt-portlet__body"
                );
                var portletFootEl = KTUtil.find(
                    parentEl,
                ...
                if (portletHeadEl) {
                    height =
                        height - parseInt(KTUtil.css(portletHeadEl, "height"));
                    height =
                        height -
                ...
                if (portletFootEl) {
                    height =
                        height - parseInt(KTUtil.css(portletFootEl, "height"));
                    height =
                        height -
        ...
        var handleMessaging = function () {
            ...
            KTUtil.addClass(
                node,
                "kt-chat__message kt-chat__message--brand kt-chat__message--right"
            );
        ...
        KTUtil.scrollInit(body, {
            ...
            height: function () {
                ...
                if (head) {
                    ...
                    height =
                        height - parseInt(KTUtil.css(head, "marginBottom"));
                }

                height = height - parseInt(KTUtil.css(demoPanel, "paddingTop"));
                height =
                    height - parseInt(KTUtil.css(demoPanel, "paddingBottom"));
...
var KTLayout = (function () {
    ...
    var initHeader = function () {
        ...
        if (
            (tmp = KTUtil.attr(
                headerEl,
                "data-ktheader-minimize-mobile-offset"
            ))
        ) {
    ...
    var initAside = function () {
        ...
        var asideOffcanvasClass = KTUtil.hasClass(
            aside,
            "kt-aside--offcanvas-default"
        )
            ? "kt-aside--offcanvas-default"
            : "kt-aside";
        ...
        if (KTUtil.hasClass(body, "kt-aside--fixed")) {
            ...
            KTUtil.addEvent(aside, "mouseenter", function (e) {
                ...
                insideTm = setTimeout(function () {
                    if (
                        KTUtil.hasClass(body, "kt-aside--minimize") &&
                        KTUtil.isInResponsiveRange("desktop")
                    ) {
            ...
            KTUtil.addEvent(aside, "mouseleave", function (e) {
                ...
                outsideTm = setTimeout(function () {
                    if (
                        KTUtil.hasClass(body, "kt-aside--minimize-hover") &&
                        KTUtil.isInResponsiveRange("desktop")
                    ) {
    ...
    var initAsideMenu = function () {
        ...
        var menuDesktopMode =
            KTUtil.attr(menu, "data-ktmenu-dropdown") === "1"
                ? "dropdown"
                : "accordion";
                ...
                height: function () {
                    ...
                    if (KTUtil.isInResponsiveRange("desktop")) {
                        height =
                            ...
                            parseInt(
                                KTUtil.getByID("kt_aside_footer")
                                    ? KTUtil.actualHeight("kt_aside_footer")
                                    : 0
                            );
                    } else {
                        height =
                    ...
                    height =
                        height -
                        (parseInt(KTUtil.css(menu, "marginBottom")) +
                            parseInt(KTUtil.css(menu, "marginTop")));
    ...
    var initAsideToggler = function () {
        ...
        asideToggler.on("beforeToggle", function (toggle) {
            var body = KTUtil.get("body");
            if (
                KTUtil.hasClass(body, "kt-aside--minimize") === false &&
                KTUtil.hasClass(body, "kt-aside--minimize-hover")
            ) {
                KTUtil.removeClass(body, "kt-aside--minimize-hover");
            }
                ...
                position: {
                    top: function () {
                        ...
                        if (KTUtil.isInResponsiveRange("desktop")) {
                            ...
                            if (
                                KTUtil.hasClass(body, "kt-subheader--fixed") &&
                                KTUtil.get("kt_subheader")
                            ) {
                                pos =
                                    pos +
                                    parseInt(
                            ...
                            if (
                                KTUtil.hasClass(body, "kt-header-mobile--fixed")
                            ) {
                                pos =
                                    pos +
                                    parseInt(
                                        KTUtil.css(
                                            KTUtil.get("kt_header_mobile"),
                                            "height"
                                        )
                                    );
                            }
                    ...
                    right: function (portlet) {
                        ...
                        var portletWidth = parseInt(
                            KTUtil.css(porletEl, "width")
                        );
                        var bodyWidth = parseInt(
                            KTUtil.css(KTUtil.get("body"), "width")
                        );
    ...
    return {
        init: function () {
            ...
            $("#kt_aside_menu, #kt_header_menu").on(
                "click",
                '.kt-menu__link[href="#"]',
                function (e) {
                    swal.fire(
                        "",
                        "You have clicked on a non-functional dummy link!"
                    );
...
var KTOffcanvasPanel = (function () {
    ...
    var initNotifications = function () {
        ...
        KTUtil.scrollInit(body, {
            ...
            height: function () {
                ...
                height =
                    height -
                    parseInt(KTUtil.css(notificationPanel, "paddingTop"));
                height =
                    height -
                    parseInt(KTUtil.css(notificationPanel, "paddingBottom"));
    ...
    var initQucikActions = function () {
        ...
        KTUtil.scrollInit(body, {
            ...
            height: function () {
                ...
                height =
                    height -
                    parseInt(KTUtil.css(quickActionsPanel, "paddingTop"));
                height =
                    height -
                    parseInt(KTUtil.css(quickActionsPanel, "paddingBottom"));
    ...
    var initProfile = function () {
        ...
        KTUtil.scrollInit(body, {
            ...
            height: function () {
                ...
                height =
                    height - parseInt(KTUtil.css(profilePanel, "paddingTop"));
                height =
                    height -
                    parseInt(KTUtil.css(profilePanel, "paddingBottom"));
    ...
    var initSearch = function () {
        ...
        KTUtil.scrollInit(wrapper, {
            ...
            height: function () {
                ...
                height =
                    height - parseInt(KTUtil.css(searchPanel, "paddingTop"));
                height =
                    height - parseInt(KTUtil.css(searchPanel, "paddingBottom"));
    ...
    return {
        init: function () {
            notificationPanel = KTUtil.get(
                "kt_offcanvas_toolbar_notifications"
            );
            quickActionsPanel = KTUtil.get(
                "kt_offcanvas_toolbar_quick_actions"
            );
...
var KTQuickSearch = function () {
    ...
    return {
        init: function (element) {
            ...
            resultDropdownToggle = KTUtil.find(
                target,
