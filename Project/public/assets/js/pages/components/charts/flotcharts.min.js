...
var KTFlotchartsDemo = (function () {
    var t = function () {
        ...
        $.plot(
            ...
            ],
            {
                ...
                xaxis: { ticks: 11, tickDecimals: 0, tickColor: "#eee" },
                yaxis: { ticks: 11, tickDecimals: 0, tickColor: "#eee" },
            }
        );
        var a = null;
        $("#chart_2").bind("plothover", function (t, e, o) {
            if (
                ($("#x").text(e.x.toFixed(2)), $("#y").text(e.y.toFixed(2)), o)
            ) {
                if (a != o.dataIndex) {
                    (a = o.dataIndex), $("#tooltip").remove();
                    var r = o.datapoint[0].toFixed(2),
                        l = o.datapoint[1].toFixed(2);
                    !(function (t, e, o) {
                        $('<div id="tooltip">' + o + "</div>")
                            .css({
                                position: "absolute",
                                display: "none",
                                top: e + 5,
    ...
    return {
        init: function () {
            var e, o;
            !(function () {
                for (var t = [], e = 0; e < 2 * Math.PI; e += 0.25)
                    t.push([e, Math.sin(e)]);
                var o = [];
                for (e = 0; e < 2 * Math.PI; e += 0.25)
                    o.push([e, Math.cos(e)]);
                var a = [];
                for (e = 0; e < 2 * Math.PI; e += 0.1) a.push([e, Math.tan(e)]);
                $.plot(
                    $("#kt_flotcharts_1"),
                    [
                        {
                    ...
                    ],
                    {
                        ...
                        grid: { borderColor: "#eee", borderWidth: 1 },
                    }
                );
            })(),
                t(),
                (function () {
                    for (var t = [], e = [], o = 0; o < 14; o += 0.1)
                        t.push([o, Math.sin(o)]), e.push([o, Math.cos(o)]);
                    var a = $.plot(
                            $("#kt_flotcharts_3"),
                            [
                                {
                ...
                (function () {
                    ...
                    !(function t() {
                        l.setData([o()]), l.draw(), setTimeout(t, r);
                    })();
                })(),
                (function () {
                    for (var t = [], e = 0; e <= 10; e += 1)
                        t.push([e, parseInt(30 * Math.random())]);
                    var o = [];
                    for (e = 0; e <= 10; e += 1)
                        o.push([e, parseInt(30 * Math.random())]);
                    var a = [];
                    for (e = 0; e <= 10; e += 1)
                        a.push([e, parseInt(30 * Math.random())]);
                    var r = 0,
                        l = !0,
                        i = !1,
                        n = !1;
                    ...
                    $(".stackControls input").click(function (t) {
                        ...
                        $(".graphControls input").click(function (t) {
                            t.preventDefault(),
                                ...
                                (i = -1 != $(this).val().indexOf("Lines")),
                                (n = -1 != $(this).val().indexOf("steps")),
                                s();
                        }),
                        s();
                })(),
                (function () {
                    ...
                    $.plot(
                        $("#kt_flotcharts_6"),
                        [{ data: t, lines: { lineWidth: 1 }, shadowSize: 0 }],
                        e
                    );
                })(),
                (e = {
