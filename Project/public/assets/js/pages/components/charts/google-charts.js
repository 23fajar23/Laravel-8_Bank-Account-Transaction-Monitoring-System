...
var KTGoogleChartsDemo = (function () {
    ...
    var demoColumnCharts = function () {
        ...
        var chart = new google.visualization.ColumnChart(
            document.getElementById("kt_gchart_1")
        );
        chart.draw(data, options);

        var chart = new google.visualization.ColumnChart(
            document.getElementById("kt_gchart_2")
        );
        chart.draw(data, options);
    };
    ...
    var demoPieCharts = function () {
        ...
        var chart = new google.visualization.PieChart(
            document.getElementById("kt_gchart_3")
        );
        chart.draw(data, options);
        ...
        var chart = new google.visualization.PieChart(
            document.getElementById("kt_gchart_4")
        );
        chart.draw(data, options);
    };
    ...
    var demoLineCharts = function () {
        ...
        var chart = new google.charts.Line(
            document.getElementById("kt_gchart_5")
        );
        chart.draw(data, options);
    };
