...
var KTamChartsChartsDemo = (function () {
    var e = function () {
        var e = {
            ...
            a = 1995;
        AmCharts.makeChart("kt_amcharts_13", {
            type: "pie",
            theme: "light",
            dataProvider: [],
            valueField: "size",
            ...
            AmCharts.makeChart("kt_amcharts_1", {
                ...
                AmCharts.makeChart("kt_amcharts_4", {
                    ...
                    dataProvider: [
                        ...
                        { country: "India", year2004: 8, year2005: 7.1 },
                ...
                (function () {
                    var e = AmCharts.makeChart("kt_amcharts_6", {
                        type: "serial",
                        theme: "light",
                        marginRight: 40,
                        marginLeft: 40,
                    ...
                    function a() {
                        e.zoomToIndexes(
                            e.dataProvider.length - 40,
                            e.dataProvider.length - 1
                        );
                    }
                    e.addListener("rendered", a), a();
                })(),
                (function () {
                    var e = (function () {
                            var e = [],
                        ...
                        a = AmCharts.makeChart("kt_amcharts_7", {
                            type: "serial",
                            theme: "light",
                            marginRight: 80,
                            autoMarginOffset: 20,
                    ...
                    function t() {
                        a.zoomToIndexes(e.length - 40, e.length - 1);
                    }
                    a.addListener("rendered", t), t();
                })(),
                ...
                AmCharts.makeChart("kt_amcharts_9", {
                    type: "radar",
                    theme: "light",
                    dataProvider: [
                ...
                AmCharts.makeChart("kt_amcharts_11", {
                    type: "radar",
                    theme: "light",
                    dataProvider: [],
