    ...
    init: function () {
        $("[data-switch=true]").bootstrapSwitch(),
            $("#kt_notify_btn").click(function () {
                ...
                $("#kt_notify_title").prop("checked") &&
                    (t.title = "Notification Title"),
                    "" != $("#kt_notify_icon").val() &&
                        (t.icon = "icon " + $("#kt_notify_icon").val()),
                    $("#kt_notify_url").prop("checked") &&
                        ((t.url = "www.keenthemes.com"), (t.target = "_blank"));
                var e = $.notify(t, {
                    ...
                    animate: {
                        enter:
                            "animated " + $("#kt_notify_animate_enter").val(),
                        exit: "animated " + $("#kt_notify_animate_exit").val(),
                    },
                });
                $("#kt_notify_progress").prop("checked") &&
                    (setTimeout(function () {
                        e.update(
                            "message",
                            "<strong>Saving</strong> Page Data."
                        ),
                            e.update("type", "primary"),
                            e.update("progress", 20);
                    }, 1e3),
                    setTimeout(function () {
                        e.update(
                            "message",
                            ...
                            e.update("type", "warning"),
                            e.update("progress", 40);
                    }, 2e3),
                    setTimeout(function () {
                        e.update(
                            "message",
                            ...
                            e.update("type", "danger"),
                            e.update("progress", 65);
                    }, 3e3),
                    setTimeout(function () {
                        e.update(
                            "message",
